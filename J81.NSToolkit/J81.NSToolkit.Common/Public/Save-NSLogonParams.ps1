function Save-NSLogonParams {
    <#
    .SYNOPSIS
        Save the logon parameters to an internal variable
    .DESCRIPTION
        Save the logon parameters to an internal variable
    .PARAMETER NSSession
        Specify a current NSSession object
    .PARAMETER ManagementURL
        Specify the URL of the NetScaler Management Service
    .PARAMETER Credential
        Specify the credentials to use for the connection
    .EXAMPLE
        PS C:\>Save-NSLogonParams -Credential (Get-Credential) -ManagementURL https://netscaler.company.com
        Save the credential and management URL to the internal variable
    .NOTES
    ...
    if ($NSSession.IsConnected -eq $true) {
        Write-Verbose "Saving NSSession to internal variable"
        $nsToolkitCommon.ModuleValues.NSSession = $NSSession
    }
    if ([String]::IsNullOrEmpty($ManagementURL) -eq $false) {
        Write-Verbose "Saving ManagementURL to internal variable"
        $nsToolkitCommon.ModuleValues.ManagementURL = $ManagementURL
    }
    if ($Credential -ne [System.Management.Automation.PSCredential]::Empty) {
        Write-Verbose "Saving Credential to internal variable"
        $nsToolkitCommon.ModuleValues.Credential = $Credential
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBNIoLXhlaG5UpD
# BQSVbMr6zsfrJMCu2VqUIGiZb2YsiqCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgGr9tcEqH1tP6tZuBpOAPcH7gTGhQ3g5oNFAAm1SNN/YwDQYJ
# KoZIhvcNAQEBBQAEggEACAdTXe+drumjwe1zwsqAM5ODsab+toxs7h1fFTiUfjYu
# mqvqvKPZ3LKHADD1EpLdEkcqWTlHRY6pCzwDbe/1q5KrfP9JoahWresGVUZe9sgr
# JRC/xokKzPGB4zom73tMIhKatoO8TTKj9Bn5Oji443hAWyXevsj68dwmbkYwS/yO
# zDYYLp+nO6kqyJslJT48TnwuniH85Hrm65lBxAlgufLIh4rg6PD9zQGG6LVgSbTt
# TeOplwa7nPIbA+LrMiCR61gnK943OT7sCGxTda/vtHH7zqSVCVtiPwnNhtP+fOWm
# 1MMHr7rQkEC1si5s3YFXZDiY28h+4xkpsk6wdBxwSKGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNDAxMzEyMTI4MzZaMD8GCSqG
# SIb3DQEJBDEyBDC2wy796yWGFktzxUb2Xh72ZXnlm43AGASoMlJLpJX9FwDLAIzO
# +lLnywWIWPMEzU0wDQYJKoZIhvcNAQEBBQAEggIAQ4gIUDxFzW48625yD10gAira
# Qu6FScg7wFyLnK4cQkoMU6zOu9J67dl0sJCtzDsxe4CJQ+koWlfBYA+fQn+ICDGM
# JuapOpC+Wzwn/6Wk7NmNBuGP4UNDQuJ3u99UYR/0VQqNKTplHUWVnN2A5byWy9ho
# DFghmzZthIQTjtfcVi7V4G1thMvWZjLRZgMZJA8gaROuRfIXelqipy3vB+5KTcSX
# 1+8z9qt7vlKWhPdhT9eUhdHu7ta7NuP8HrW3ltnqqXeVUYUHEo1BfRkt6DRF29MB
# 8fNEtgFFJyN8Xoc8gE1Q7aNwSlWOKjOz3wX2QxnDDT3jX5KvvSZpF2xf2cz7jMKs
# I9fY2XdNkdvaQkMqru3BVCG6LVvNH9mep0DE4UR8c1WVWASdFvxpnhRPhbp40jQQ
# AmoPzQB9rmsM9r7nd5IR1+ImF+vcpu2ftVRp0T+SW3VB3xkMEGTg8WMH9xCgH3TY
# bPKkT3FEZyuWjxPt/bEAJLRaDlZFoPrdwUOjjlVi9NGXVKeV2JlfrW6zwL7J7HNv
# yz28Gyu6ab8ONrDCaMPF1+jvAM84uESiV/2H6uSx3UkuXAlhhw0Zg0DGvLjxqmhv
# zru7x4mIhq/lAjr3X0EB8d5ousuQEnXD29SFM1OutXS+qsaFJRVtUQTnnBcbO6FS
# 7piHENjXpDW4mHbJREQ=
