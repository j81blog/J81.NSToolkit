function Expand-NSResult {
    <#
    .SYNOPSIS
        Cleans the result from an NS function to return only the values
    .DESCRIPTION
        Cleans the result from an NS function to return only the values
    .PARAMETER Result
        Result from a NS function
    .EXAMPLE
        PS C:\>Invoke-NSGetLBvServer | Expand-NSResult
        Expand the returned results from all NS Cmdlets
    .NOTES
        File Name : Expand-NSResult
        Version   : v2204.1122
    ...
    begin {
        Write-Verbose "Expand-NSResult: Starting"
    }
    Process {
        try {
        ...
        Write-Verbose "Expand-NSResult: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBwGA+1ZaFRxhfQ
# 1hrp92033tQzfxNT9Qb8PW8u4gxmW6CCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgteydYPzT4MjfTeyW51ngw+liQ+hOfJPXogTaZlCjuKswDQYJ
# KoZIhvcNAQEBBQAEggEAkHD7kWEbTf0C7nj70/DIBnQn/YjV18iEuQQzcA/IeMNy
# D05uiX062A5RMhWSWJPBm3rjpeDmw9eCh5KHEqM/vSGgqjh20XjBpIOqoMKiGHL4
# feEvyqWyAHPq9IX0G1sAkzYb3EhjVG5YmBXzydU7z7ShxpVnA/qYCt09HQ7jX4hw
# 9GnRd/5ZN67vSYbmmgZbmo82kxyOx/Ofob+3Ls6wWKuii1vQm37OVQxzT8XSQhar
# 80MHD6CDhYjHTfx7HAbfwHos7lvqRBFl4IxmKRx7I/RjnNKy1Pmhwq79vVXdL9OD
# CqX3CPn+XFSH+a0uMxCrNEEZVWaD8B+UgV3RSv0lG6GCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMTYyMDU4MTNaMD8GCSqG
# SIb3DQEJBDEyBDAfmLpDdn1BuGA1LUJ5zq2FKa5rQAS0SJzpVVaJwElQJJobMTv6
# dc9Ca8X1dafWlDIwDQYJKoZIhvcNAQEBBQAEggIAK7+sh0NBLLoW1u7HZY4y9gZE
# E8CV2ngphWHt+KNEbvtmDsIbTkHGKjzI3nI6a97p7h0fgTizMrV9de7ycgC3aucw
# PiYOvkmn3gzy0J2w3wo6Ql8vX0YbFAZdTpsXRo1Y1y4sFXP7jDVE9IUP10vVuCg8
# fu1iJunMW27T1WCG1YRuljwpcckC86C66uVnlVUDgzeD/2pQG9IzjLtTdvGDCw19
# jnCp+YRp7r4kv73YYQhECN+Vi+q0fWD1GuLytqFae2bT6ssT2SjKRqvWE4yw2ECX
# 9KzE7ITCV6aEIPWIjoS7TrDfD1CJe2NncRzTpp2e+8Xmtf14AejQiSe+TRtYq+Oi
# 3iosHG+7OdP10pd8CzC8owFgllQfQPKySBlbTg8JoM225vrNwcJd88QXGNGMV43X
# X/fccQooJ1MBZmcWF6oNHYhe8X034ReH6qtyKeDMdrwtQgs0jQOr6hJ8tMs/QRjU
# B1LwUDVU8ldUs7weC2VrNXRvSbAFU1gz33SY+8qWDGO+gm0BKR/dK+/hJ1EQWexh
# OU+VQYHmJIowo8kO0ek01Xu4F6qLrBXAcUcRwy/zw7848FB19dSWubZlcyjngY4f
# ierysuFV/LShgt2K/V241Q3EJYO13lLX0Je6w8B+ShHdLyhYr3kHhYDXCNOda0ZK
# Kbmpf1hoQlI9Q3CP5K0=
