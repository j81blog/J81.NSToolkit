function Invoke-NSUpdateIpsecparameter {
    <#
    .SYNOPSIS
        Update IPSEC configuration. config Object.
    .DESCRIPTION
    ...
    .PARAMETER Retransmissiontime 
        ...
        Maximum value = 99
    .EXAMPLE
        PS C:\>Invoke-NSUpdateIpsecparameter 
        An example how to update ipsecparameter config Object(s).
    .NOTES
        File Name : Invoke-NSUpdateIpsecparameter
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/ipsec/ipsecparameter/
    ...
    begin {
        Write-Verbose "Invoke-NSUpdateIpsecparameter: Starting"
    }
    process {
        try {
            $payload = @{ }
            ...
            if ( $PSCmdlet.ShouldProcess("ipsecparameter", "Update IPSEC configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method PUT -NitroPath nitro/v1/config -Type ipsecparameter -Payload $payload -GetWarning
        ...
        Write-Verbose "Invoke-NSUpdateIpsecparameter: Finished"
    }
}

function Invoke-NSUnsetIpsecparameter {
    <#
    .SYNOPSIS
        Unset IPSEC configuration. config Object.
    .DESCRIPTION
        Configuration for IPSEC paramter resource.
    .PARAMETER Ikeversion 
        IKE Protocol Version. 
    ...
    .PARAMETER Retransmissiontime 
        ...
        Maximum value = 99
    .EXAMPLE
        PS C:\>Invoke-NSUnsetIpsecparameter 
        An example how to unset ipsecparameter config Object(s).
    .NOTES
        File Name : Invoke-NSUnsetIpsecparameter
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/ipsec/ipsecparameter
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUnsetIpsecparameter: Starting"
    }
    process {
        try {
            $payload = @{ }
            ...
            if ( $PSBoundParameters.ContainsKey('perfectforwardsecrecy') ) { $payload.Add('perfectforwardsecrecy', $perfectforwardsecrecy) }
            if ( $PSBoundParameters.ContainsKey('retransmissiontime') ) { $payload.Add('retransmissiontime', $retransmissiontime) }
            if ( $PSCmdlet.ShouldProcess("ipsecparameter", "Unset IPSEC configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method POST -Type ipsecparameter -NitroPath nitro/v1/config -Action unset -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
        ...
        Write-Verbose "Invoke-NSUnsetIpsecparameter: Finished"
    }
}

function Invoke-NSGetIpsecparameter {
    <#
    .SYNOPSIS
        Get IPSEC configuration. config object(s).
    .DESCRIPTION
        Configuration for IPSEC paramter resource.
    .PARAMETER GetAll 
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetIpsecparameter
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetIpsecparameter -GetAll 
        Get all ipsecparameter data.
    .EXAMPLE
        PS C:\>Invoke-NSGetIpsecparameter -name <string>
        Get ipsecparameter object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetIpsecparameter -Filter @{ 'name'='<value>' }
        Get ipsecparameter data with a filter.
    .NOTES
        File Name : Invoke-NSGetIpsecparameter
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/ipsec/ipsecparameter/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetIpsecparameter: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ipsecparameter -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ipsecparameter -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ipsecparameter -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetIpsecparameter: Ended"
    }
}

function Invoke-NSAddIpsecprofile {
    <#
    .SYNOPSIS
        Add IPSEC configuration. config Object.
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSAddIpsecprofile -name <string>
        An example how to add ipsecprofile config Object(s).
    .NOTES
        File Name : Invoke-NSAddIpsecprofile
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/ipsec/ipsecprofile/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSAddIpsecprofile: Starting"
    }
    process {
        try {
            $payload = @{ name = $name }
            ...
            if ( $PSBoundParameters.ContainsKey('retransmissiontime') ) { $payload.Add('retransmissiontime', $retransmissiontime) }
            if ( $PSBoundParameters.ContainsKey('perfectforwardsecrecy') ) { $payload.Add('perfectforwardsecrecy', $perfectforwardsecrecy) }
            if ( $PSCmdlet.ShouldProcess("ipsecprofile", "Add IPSEC configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method POST -NitroPath nitro/v1/config -Type ipsecprofile -Payload $payload -GetWarning
                #HTTP Status Code on Success: 201 Created
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                if ( $PSBoundParameters.ContainsKey('PassThru') ) {
                    Write-Output (Invoke-NSGetIpsecprofile -Filter $payload)
                } else {
                    Write-Output $result
                }
            }
        ...
        Write-Verbose "Invoke-NSAddIpsecprofile: Finished"
    }
}

function Invoke-NSDeleteIpsecprofile {
    <#
    .SYNOPSIS
        Delete IPSEC configuration. config Object.
    .DESCRIPTION
        Configuration for IPSEC profile resource.
    .PARAMETER Name 
        The name of the ipsec profile.
    .EXAMPLE
        PS C:\>Invoke-NSDeleteIpsecprofile -Name <string>
        An example how to delete ipsecprofile config Object(s).
    .NOTES
        File Name : Invoke-NSDeleteIpsecprofile
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/ipsec/ipsecprofile/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSDeleteIpsecprofile: Starting"
    }
    process {
        try {
            $arguments = @{ }

            if ( $PSCmdlet.ShouldProcess("$name", "Delete IPSEC configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method DELETE -Type ipsecprofile -NitroPath nitro/v1/config -Resource $name -Arguments $arguments
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSDeleteIpsecprofile: Finished"
    }
}

function Invoke-NSGetIpsecprofile {
    <#
    .SYNOPSIS
        Get IPSEC configuration. config object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetIpsecprofile
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetIpsecprofile -GetAll 
        Get all ipsecprofile data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetIpsecprofile -Count 
        Get the number of ipsecprofile objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetIpsecprofile -name <string>
        Get ipsecprofile object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetIpsecprofile -Filter @{ 'name'='<value>' }
        Get ipsecprofile data with a filter.
    .NOTES
        File Name : Invoke-NSGetIpsecprofile
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/ipsec/ipsecprofile/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetIpsecprofile: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ipsecprofile -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ipsecprofile -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving ipsecprofile configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ipsecprofile -NitroPath nitro/v1/config -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving ipsecprofile configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ipsecprofile -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetIpsecprofile: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB2/FRBh/qij4JY
# zsWwGmS0zK94Pi2MGndsmwhO8O2dd6CCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgsmy7XkGa0g32hOAJzP/9FRWLWByZ29SBVrOblbkw8fAwDQYJ
# KoZIhvcNAQEBBQAEggEAG5lt2QsN7n6LWvVhY7ivchGLO6uMBvT3UozKC89sSoU1
# j0UJy4LqyNgR2cUOYAUeZ2XXsrPKKiygh1DUAq0X7fgTqQdYASeCKBRQoS+ifpG8
# IkhkOemPgld24QsuiozbURCUU1psXqhR8ILSW24RUJlQgrU0C9YUZfUvIOHH+ekz
# aCszRsgQTqJ9LDbuCZ/fgE6vQrlFof3pSMfRSc/5JVOQFQ4aAy3PmGrKkjeRyn2e
# CZh7lXILItM6YdcbnVBDLysSCqB0Ocu4K3gBpHyvGCj/44G7rlHE450RcsgNNiUJ
# ZpSTfSE8y310jMidxuSgeKZFkhRUD10pRvfl9SRTXaGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQyMzdaMD8GCSqG
# SIb3DQEJBDEyBDC3ImCWfcih52vmzLBWqZ1MH8ZNKk2wJm/VvCR+6GWdXGjT1Dsw
# DV7eJcfEOMEfBoIwDQYJKoZIhvcNAQEBBQAEggIAmIqMEv/4gcMnIjJrmq3ty6Pp
# ELNevk8TSVZhUxVU6912LulegHh7gQxji0PMbm3gHGzENPXC/YscUT2i1gvIhVJ9
# MJ3Upeg4k/qrvmTpHpjbTF/pA+Shg3zH8KQbztmZe76wraoNsOA06XooEML1Ezux
# Qd5vWxyqKz7RMNaGhNx8h6pcN3yaVpQfz5x/RlTTGXpbQbgQxZT1xBTWQ7kNhYze
# TrdTnQqqFiYrh4j7jgoHWFWW+tHsbirFkHIfhR7PnFcWPvBQIwKp4j3Nv74Ob195
# rSegPDHn3TqhGA1gqGg7YEsELtn/4eGI+QtjjxNPeLleTF3CQxX6aaQGvv+VaOTC
# nSXgTMzI7PUn+GpxlzBd7MeE5QiugN8vq1Zgdy8JyvNk5nmOcZuanX9ctsBXrYWQ
# 73HSqrveBory+Y2vUat5aTxy1EYCkqCPHmVkqt9HXzitoTrCEr5kYoCywVB6dxLP
# f6ixGGNr/HnANzbtGFJDNW+KS2g23+Ka3dokPDBnH3f8VKnE9oW6FBXWR7EueYym
# DhXUbhi6fc1+eqvpkizlKQc84mdt8mqT7RLWu1lVlFo67zBrg9vRTI+vpAQMELZR
# q8yQznbVS3u0oS5pl1cQT5kKXXJoeu7wYVYkmC3ehKIsGgXZur3KQexRQJXhDMrH
# 4jYgGO0r2eaeOAxSUgM=
