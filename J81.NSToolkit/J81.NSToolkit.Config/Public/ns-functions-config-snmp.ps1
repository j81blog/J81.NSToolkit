function Invoke-NSUpdateSnmpalarm {
    <#
    .SYNOPSIS
        Update SNMP(Simple Network Management Protocol) configuration. config Object.
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSUpdateSnmpalarm -trapname <string>
        An example how to update snmpalarm config Object(s).
    .NOTES
        File Name : Invoke-NSUpdateSnmpalarm
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpalarm/
    ...
    begin {
        Write-Verbose "Invoke-NSUpdateSnmpalarm: Starting"
    }
    process {
        try {
            ...
            if ( $PSCmdlet.ShouldProcess("snmpalarm", "Update SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method PUT -NitroPath nitro/v1/config -Type snmpalarm -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                if ( $PSBoundParameters.ContainsKey('PassThru') ) {
                    Write-Output (Invoke-NSGetSnmpalarm -Filter $payload)
                } else {
                    Write-Output $result
                }
            }
        ...
        Write-Verbose "Invoke-NSUpdateSnmpalarm: Finished"
    }
}
...
function Invoke-NSUnsetSnmpalarm {
    <#
    .SYNOPSIS
        Unset SNMP(Simple Network Management Protocol) configuration. config Object.
    .DESCRIPTION
        Configuration for alarm resource.
    .PARAMETER Trapname 
        Name of the SNMP alarm. This parameter is required for identifying the SNMP alarm and cannot be modified. 
    ...
    .PARAMETER Logging 
        ...
        Possible values = ENABLED, DISABLED
    .EXAMPLE
        PS C:\>Invoke-NSUnsetSnmpalarm -trapname <string>
        An example how to unset snmpalarm config Object(s).
    .NOTES
        File Name : Invoke-NSUnsetSnmpalarm
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpalarm
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUnsetSnmpalarm: Starting"
    }
    process {
        try {
            $payload = @{ trapname = $trapname }
            ...
            if ( $PSBoundParameters.ContainsKey('severity') ) { $payload.Add('severity', $severity) }
            if ( $PSBoundParameters.ContainsKey('logging') ) { $payload.Add('logging', $logging) }
            if ( $PSCmdlet.ShouldProcess("$trapname", "Unset SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method POST -Type snmpalarm -NitroPath nitro/v1/config -Action unset -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
        ...
        Write-Verbose "Invoke-NSUnsetSnmpalarm: Finished"
    }
}
...
function Invoke-NSEnableSnmpalarm {
    <#
    .SYNOPSIS
        Enable SNMP(Simple Network Management Protocol) configuration. config Object.
    .DESCRIPTION
        Configuration for alarm resource.
    .PARAMETER Trapname 
        Name of the SNMP alarm. This parameter is required for identifying the SNMP alarm and cannot be modified. 
        Possible values = CPU-USAGE, AVERAGE-CPU, MEMORY, MGMT-CPU-USAGE, SYNFLOOD, TCP-SYNFLOOD, VSERVER-REQRATE, SERVICE-REQRATE, ENTITY-RXRATE, ENTITY-TXRATE, ENTITY-SYNFLOOD, SERVICE-MAXCLIENTS, HA-STATE-CHANGE, ENTITY-STATE, CONFIG-CHANGE, CONFIG-SAVE, SERVICEGROUP-MEMBER-REQRATE, SERVICEGROUP-MEMBER-MAXCLIENTS, MONITOR-RTO-THRESHOLD, LOGIN-FAILURE, SSL-CERT-EXPIRY, FAN-SPEED-LOW, VOLTAGE-LOW, VOLTAGE-HIGH, TEMPERATURE-HIGH, CPU-TEMPERATURE-HIGH, POWER-SUPPLY-FAILURE, DISK-USAGE-HIGH, INTERFACE-THROUGHPUT-LOW, MON_PROBE_FAILED, HA-VERSION-MISMATCH, HA-SYNC-FAILURE, HA-NO-HEARTBEATS, HA-BAD-SECONDARY-STATE, INTERFACE-BW-USAGE, RATE-LIMIT-THRESHOLD-EXCEEDED, ENTITY-NAME-CHANGE, HA-PROP-FAILURE, IP-CONFLICT, PF-RL-RATE-THRESHOLD, PF-RL-PPS-THRESHOLD, PF-RL-RATE-PKTS-DROPPED, PF-RL-PPS-PKTS-DROPPED, APPFW-START-URL, APPFW-DENY-URL, APPFW-VIOLATIONS-TYPE, APPFW-REFERER-HEADER, APPFW-CSRF-TAG, APPFW-COOKIE, APPFW-FIELD-CONSISTENCY, APPFW-BUFFER-OVERFLOW, APPFW-FIELD-FORMAT, APPFW-FILE-UPLOAD-TYPE, APPFW-GRPC, APPFW-GRPC-WEB-JSON, APPFW-GRPC-WEB-TEXT, APPFW-JSON-DOS, APPFW-JSON-SQL, APPFW-JSON-XSS, APPFW-SAFE-COMMERCE, APPFW-SAFE-OBJECT, APPFW-SESSION-LIMIT, APPFW-SIGNATURE-MATCH, APPFW-POLICY-HIT, APPFW-XSS, APPFW-XML-XSS, APPFW-SQL, APPFW-XML-SQL, APPFW-XML-ATTACHMENT, APPFW-XML-DOS, APPFW-XML-VALIDATION, APPFW-XML-WSI, APPFW-XML-SCHEMA-COMPILE, APPFW-XML-SOAP-FAULT, APPFW-NEW-SIGNATURE-ADDED, APPFW-DEPLOY-RELAXATION-DP, APPFW-LEARNED-RULE-APPLIED-DYN-PROF, APPFW-CMD, APPFW-REST-VALIDATION, APPFW-GRPC-VALIDATION, APPFW-POSTBODYLIMIT, APPFW-JSON-CMD, APPFW-SQL-GRAM, APPFW-JSON-SQL-GRAM, APPFW-CMD-GRAM, APPFW-JSON-CMD-GRAM, APPFW-BLOCK-KEYWORD, APPFW-JSON-BLOCKKEYWORD, APPFW-BYPASS-LIST, APPFW-DENY-LIST, DNSKEY-EXPIRY, HA-LICENSE-MISMATCH, SSL-CARD-FAILED, SSL-CARD-NORMAL, WARM-RESTART-EVENT, HARD-DISK-DRIVE-ERRORS, COMPACT-FLASH-ERRORS, CALLHOME-UPLOAD-EVENT, 1024KEY-EXCHANGE-RATE, 2048KEY-EXCHANGE-RATE, 4096KEY-EXCHANGE-RATE, SSL-CUR-SESSION-INUSE, CLUSTER-NODE-HEALTH, CLUSTER-NODE-QUORUM, CLUSTER-VERSION-MISMATCH, CLUSTER-CCO-CHANGE, CLUSTER-OVS-CHANGE, CLUSTER-SYNC-FAILURE, CLUSTER-SYNC-PARTIAL-SUCCESS, CLUSTER-PROP-FAILURE, CLUSTER-PROP-EXEC-FAILURE, HA-STICKY-PRIMARY, INBAND-PROTOCOL-VERSION-MISMATCH, SSL-CHIP-REINIT, VRID-STATE-CHANGE, PORT-ALLOC-FAILED, LLDP-REMOTE-CHANGE, DUPLICATE-IPV6, PARTITION-CONFIG-EVENT, PARTITION-SWITCHED, LSN-PORTALLOC-FAILED, LSN-PORTQUOTA-EXCEED, LSN-SESSIONQUOTA-EXCEED, LSN-MEM-RECOVERY-KICKEDIN, VSERVER-SPILLOVER, INCONSISTENT-CONFIGURATION-IN-PPES, PARTITION-RATE-LIMIT, POOLED-LICENSE-ONGRACE, POOLED-LICENSE-PARTIAL, CLUSTER-BACKPLANE-HB-MISSING, GSLB-SITE-MEP-FLAP, DNS-MAXNEGCACHE-USAGE, DNS-MAXCACHE-USAGE, NS-LICENSE-EXPIRY, PKT-RATELIMITING-ATTACK, GSLB-SYNC-STATUS-FLIP, URLFILT-DB-UPDATE-STATUS, URLFILT-INIT-SDK, POOLED-LICENSE-CHECKOUT-FAILURE, MIGRATION-STARTED, MIGRATION-COMPLETE, ECDHE-EXCHANGE-RATE, BOT-SIGNATURE-UPDATE, APPFW-XMLPAYLOAD-CONTENT-TYPE-MISMATCH, PORT-ALLOC-EXCEED, KEK_UPDATE_SUCCESS, KEK_UPDATE_FAILURE, ADC-ANOMALY, SYSLOG-CONNECTION-DROPPED, NSROOT_PASSWORD_EXPIRY_WARNING
    .EXAMPLE
        PS C:\>Invoke-NSEnableSnmpalarm -trapname <string>
        An example how to enable snmpalarm config Object(s).
    .NOTES
        File Name : Invoke-NSEnableSnmpalarm
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpalarm/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSEnableSnmpalarm: Starting"
    }
    process {
        try {
            $payload = @{ trapname = $trapname }

            if ( $PSCmdlet.ShouldProcess($Name, "Enable SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method POST -NitroPath nitro/v1/config -Type snmpalarm -Action enable -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSEnableSnmpalarm: Finished"
    }
}
...
function Invoke-NSDisableSnmpalarm {
    <#
    .SYNOPSIS
        Disable SNMP(Simple Network Management Protocol) configuration. config Object.
    .DESCRIPTION
        Configuration for alarm resource.
    .PARAMETER Trapname 
        Name of the SNMP alarm. This parameter is required for identifying the SNMP alarm and cannot be modified. 
        Possible values = CPU-USAGE, AVERAGE-CPU, MEMORY, MGMT-CPU-USAGE, SYNFLOOD, TCP-SYNFLOOD, VSERVER-REQRATE, SERVICE-REQRATE, ENTITY-RXRATE, ENTITY-TXRATE, ENTITY-SYNFLOOD, SERVICE-MAXCLIENTS, HA-STATE-CHANGE, ENTITY-STATE, CONFIG-CHANGE, CONFIG-SAVE, SERVICEGROUP-MEMBER-REQRATE, SERVICEGROUP-MEMBER-MAXCLIENTS, MONITOR-RTO-THRESHOLD, LOGIN-FAILURE, SSL-CERT-EXPIRY, FAN-SPEED-LOW, VOLTAGE-LOW, VOLTAGE-HIGH, TEMPERATURE-HIGH, CPU-TEMPERATURE-HIGH, POWER-SUPPLY-FAILURE, DISK-USAGE-HIGH, INTERFACE-THROUGHPUT-LOW, MON_PROBE_FAILED, HA-VERSION-MISMATCH, HA-SYNC-FAILURE, HA-NO-HEARTBEATS, HA-BAD-SECONDARY-STATE, INTERFACE-BW-USAGE, RATE-LIMIT-THRESHOLD-EXCEEDED, ENTITY-NAME-CHANGE, HA-PROP-FAILURE, IP-CONFLICT, PF-RL-RATE-THRESHOLD, PF-RL-PPS-THRESHOLD, PF-RL-RATE-PKTS-DROPPED, PF-RL-PPS-PKTS-DROPPED, APPFW-START-URL, APPFW-DENY-URL, APPFW-VIOLATIONS-TYPE, APPFW-REFERER-HEADER, APPFW-CSRF-TAG, APPFW-COOKIE, APPFW-FIELD-CONSISTENCY, APPFW-BUFFER-OVERFLOW, APPFW-FIELD-FORMAT, APPFW-FILE-UPLOAD-TYPE, APPFW-GRPC, APPFW-GRPC-WEB-JSON, APPFW-GRPC-WEB-TEXT, APPFW-JSON-DOS, APPFW-JSON-SQL, APPFW-JSON-XSS, APPFW-SAFE-COMMERCE, APPFW-SAFE-OBJECT, APPFW-SESSION-LIMIT, APPFW-SIGNATURE-MATCH, APPFW-POLICY-HIT, APPFW-XSS, APPFW-XML-XSS, APPFW-SQL, APPFW-XML-SQL, APPFW-XML-ATTACHMENT, APPFW-XML-DOS, APPFW-XML-VALIDATION, APPFW-XML-WSI, APPFW-XML-SCHEMA-COMPILE, APPFW-XML-SOAP-FAULT, APPFW-NEW-SIGNATURE-ADDED, APPFW-DEPLOY-RELAXATION-DP, APPFW-LEARNED-RULE-APPLIED-DYN-PROF, APPFW-CMD, APPFW-REST-VALIDATION, APPFW-GRPC-VALIDATION, APPFW-POSTBODYLIMIT, APPFW-JSON-CMD, APPFW-SQL-GRAM, APPFW-JSON-SQL-GRAM, APPFW-CMD-GRAM, APPFW-JSON-CMD-GRAM, APPFW-BLOCK-KEYWORD, APPFW-JSON-BLOCKKEYWORD, APPFW-BYPASS-LIST, APPFW-DENY-LIST, DNSKEY-EXPIRY, HA-LICENSE-MISMATCH, SSL-CARD-FAILED, SSL-CARD-NORMAL, WARM-RESTART-EVENT, HARD-DISK-DRIVE-ERRORS, COMPACT-FLASH-ERRORS, CALLHOME-UPLOAD-EVENT, 1024KEY-EXCHANGE-RATE, 2048KEY-EXCHANGE-RATE, 4096KEY-EXCHANGE-RATE, SSL-CUR-SESSION-INUSE, CLUSTER-NODE-HEALTH, CLUSTER-NODE-QUORUM, CLUSTER-VERSION-MISMATCH, CLUSTER-CCO-CHANGE, CLUSTER-OVS-CHANGE, CLUSTER-SYNC-FAILURE, CLUSTER-SYNC-PARTIAL-SUCCESS, CLUSTER-PROP-FAILURE, CLUSTER-PROP-EXEC-FAILURE, HA-STICKY-PRIMARY, INBAND-PROTOCOL-VERSION-MISMATCH, SSL-CHIP-REINIT, VRID-STATE-CHANGE, PORT-ALLOC-FAILED, LLDP-REMOTE-CHANGE, DUPLICATE-IPV6, PARTITION-CONFIG-EVENT, PARTITION-SWITCHED, LSN-PORTALLOC-FAILED, LSN-PORTQUOTA-EXCEED, LSN-SESSIONQUOTA-EXCEED, LSN-MEM-RECOVERY-KICKEDIN, VSERVER-SPILLOVER, INCONSISTENT-CONFIGURATION-IN-PPES, PARTITION-RATE-LIMIT, POOLED-LICENSE-ONGRACE, POOLED-LICENSE-PARTIAL, CLUSTER-BACKPLANE-HB-MISSING, GSLB-SITE-MEP-FLAP, DNS-MAXNEGCACHE-USAGE, DNS-MAXCACHE-USAGE, NS-LICENSE-EXPIRY, PKT-RATELIMITING-ATTACK, GSLB-SYNC-STATUS-FLIP, URLFILT-DB-UPDATE-STATUS, URLFILT-INIT-SDK, POOLED-LICENSE-CHECKOUT-FAILURE, MIGRATION-STARTED, MIGRATION-COMPLETE, ECDHE-EXCHANGE-RATE, BOT-SIGNATURE-UPDATE, APPFW-XMLPAYLOAD-CONTENT-TYPE-MISMATCH, PORT-ALLOC-EXCEED, KEK_UPDATE_SUCCESS, KEK_UPDATE_FAILURE, ADC-ANOMALY, SYSLOG-CONNECTION-DROPPED, NSROOT_PASSWORD_EXPIRY_WARNING
    .EXAMPLE
        PS C:\>Invoke-NSDisableSnmpalarm -trapname <string>
        An example how to disable snmpalarm config Object(s).
    .NOTES
        File Name : Invoke-NSDisableSnmpalarm
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpalarm/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSDisableSnmpalarm: Starting"
    }
    process {
        try {
            $payload = @{ trapname = $trapname }

            if ( $PSCmdlet.ShouldProcess($Name, "Disable SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method POST -NitroPath nitro/v1/config -Type snmpalarm -Action disable -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSDisableSnmpalarm: Finished"
    }
}
...
function Invoke-NSGetSnmpalarm {
    <#
    .SYNOPSIS
        Get SNMP(Simple Network Management Protocol) configuration. config object(s).
    .DESCRIPTION
        Configuration for alarm resource.
    .PARAMETER Trapname 
        Name of the SNMP alarm. This parameter is required for identifying the SNMP alarm and cannot be modified. 
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpalarm
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpalarm -GetAll 
        Get all snmpalarm data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpalarm -Count 
        Get the number of snmpalarm objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpalarm -name <string>
        Get snmpalarm object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpalarm -Filter @{ 'name'='<value>' }
        Get snmpalarm data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmpalarm
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpalarm/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmpalarm: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpalarm -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpalarm -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving snmpalarm configuration for property 'trapname'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpalarm -NitroPath nitro/v1/config -Resource $trapname -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving snmpalarm configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpalarm -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmpalarm: Ended"
    }
}
...
function Invoke-NSAddSnmpcommunity {
    <#
    .SYNOPSIS
        Add SNMP(Simple Network Management Protocol) configuration. config Object.
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSAddSnmpcommunity -communityname <string> -permissions <string>
        An example how to add snmpcommunity config Object(s).
    .NOTES
        File Name : Invoke-NSAddSnmpcommunity
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpcommunity/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSAddSnmpcommunity: Starting"
    }
    process {
        try {
            ...
            if ( $PSCmdlet.ShouldProcess("snmpcommunity", "Add SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method POST -NitroPath nitro/v1/config -Type snmpcommunity -Payload $payload -GetWarning
                #HTTP Status Code on Success: 201 Created
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                if ( $PSBoundParameters.ContainsKey('PassThru') ) {
                    Write-Output (Invoke-NSGetSnmpcommunity -Filter $payload)
                } else {
                    Write-Output $result
                }
            }
        ...
        Write-Verbose "Invoke-NSAddSnmpcommunity: Finished"
    }
}
...
function Invoke-NSDeleteSnmpcommunity {
    <#
    .SYNOPSIS
        Delete SNMP(Simple Network Management Protocol) configuration. config Object.
    .DESCRIPTION
        Configuration for community resource.
    .PARAMETER Communityname 
        The SNMP community string. Can consist of 1 to 31 characters that include uppercase and lowercase letters,numbers and special characters.
    .EXAMPLE
        PS C:\>Invoke-NSDeleteSnmpcommunity -Communityname <string>
        An example how to delete snmpcommunity config Object(s).
    .NOTES
        File Name : Invoke-NSDeleteSnmpcommunity
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpcommunity/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSDeleteSnmpcommunity: Starting"
    }
    process {
        try {
            $arguments = @{ }

            if ( $PSCmdlet.ShouldProcess("$communityname", "Delete SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method DELETE -Type snmpcommunity -NitroPath nitro/v1/config -Resource $communityname -Arguments $arguments
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSDeleteSnmpcommunity: Finished"
    }
}
...
function Invoke-NSGetSnmpcommunity {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpcommunity
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpcommunity -GetAll 
        Get all snmpcommunity data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpcommunity -Count 
        Get the number of snmpcommunity objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpcommunity -name <string>
        Get snmpcommunity object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpcommunity -Filter @{ 'name'='<value>' }
        Get snmpcommunity data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmpcommunity
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpcommunity/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmpcommunity: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpcommunity -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpcommunity -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving snmpcommunity configuration for property 'communityname'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpcommunity -NitroPath nitro/v1/config -Resource $communityname -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving snmpcommunity configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpcommunity -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmpcommunity: Ended"
    }
}
...
function Invoke-NSUpdateSnmpengineid {
    ...
    .EXAMPLE
        PS C:\>Invoke-NSUpdateSnmpengineid -engineid <string>
        An example how to update snmpengineid config Object(s).
    .NOTES
        File Name : Invoke-NSUpdateSnmpengineid
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpengineid/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSUpdateSnmpengineid: Starting"
    }
    process {
        try {
            $payload = @{ engineid = $engineid }
            if ( $PSBoundParameters.ContainsKey('ownernode') ) { $payload.Add('ownernode', $ownernode) }
            if ( $PSCmdlet.ShouldProcess("snmpengineid", "Update SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method PUT -NitroPath nitro/v1/config -Type snmpengineid -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                if ( $PSBoundParameters.ContainsKey('PassThru') ) {
                    Write-Output (Invoke-NSGetSnmpengineid -Filter $payload)
                } else {
                    Write-Output $result
                }
            }
        ...
        Write-Verbose "Invoke-NSUpdateSnmpengineid: Finished"
    }
}

function Invoke-NSUnsetSnmpengineid {
    <#
    .SYNOPSIS
        Unset SNMP(Simple Network Management Protocol) configuration. config Object.
    .DESCRIPTION
    ...
    .PARAMETER Ownernode 
        ...
        Maximum value = 31
    .EXAMPLE
        PS C:\>Invoke-NSUnsetSnmpengineid 
        An example how to unset snmpengineid config Object(s).
    .NOTES
        File Name : Invoke-NSUnsetSnmpengineid
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpengineid
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUnsetSnmpengineid: Starting"
    }
    process {
        try {
            $payload = @{ }
            if ( $PSBoundParameters.ContainsKey('ownernode') ) { $payload.Add('ownernode', $ownernode) }
            if ( $PSCmdlet.ShouldProcess("snmpengineid", "Unset SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method POST -Type snmpengineid -NitroPath nitro/v1/config -Action unset -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSUnsetSnmpengineid: Finished"
    }
}
...
function Invoke-NSGetSnmpengineid {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpengineid
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpengineid -GetAll 
        Get all snmpengineid data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpengineid -Count 
        Get the number of snmpengineid objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpengineid -name <string>
        Get snmpengineid object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpengineid -Filter @{ 'name'='<value>' }
        Get snmpengineid data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmpengineid
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpengineid/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmpengineid: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpengineid -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpengineid -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving snmpengineid configuration for property 'ownernode'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpengineid -NitroPath nitro/v1/config -Resource $ownernode -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving snmpengineid configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpengineid -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmpengineid: Ended"
    }
}
...
function Invoke-NSAddSnmpgroup {
    ...
    .EXAMPLE
        PS C:\>Invoke-NSAddSnmpgroup -name <string> -securitylevel <string> -readviewname <string>
        An example how to add snmpgroup config Object(s).
    .NOTES
        File Name : Invoke-NSAddSnmpgroup
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpgroup/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSAddSnmpgroup: Starting"
    }
    process {
        try {
            $payload = @{ name = $name
            ...
            if ( $PSCmdlet.ShouldProcess("snmpgroup", "Add SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method POST -NitroPath nitro/v1/config -Type snmpgroup -Payload $payload -GetWarning
                #HTTP Status Code on Success: 201 Created
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSAddSnmpgroup: Finished"
    }
}
...
function Invoke-NSDeleteSnmpgroup {
    ...
    .PARAMETER Securitylevel 
        ...
        Possible values = noAuthNoPriv, authNoPriv, authPriv
    .EXAMPLE
        PS C:\>Invoke-NSDeleteSnmpgroup -Name <string>
        An example how to delete snmpgroup config Object(s).
    .NOTES
        File Name : Invoke-NSDeleteSnmpgroup
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpgroup/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSDeleteSnmpgroup: Starting"
    }
    process {
        try {
            $arguments = @{ }
            if ( $PSBoundParameters.ContainsKey('Securitylevel') ) { $arguments.Add('securitylevel', $Securitylevel) }
            if ( $PSCmdlet.ShouldProcess("$name", "Delete SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method DELETE -Type snmpgroup -NitroPath nitro/v1/config -Resource $name -Arguments $arguments
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSDeleteSnmpgroup: Finished"
    }
}
...
function Invoke-NSUpdateSnmpgroup {
    ...
    .PARAMETER Readviewname 
        Name of the configured SNMPv3 view that you want to bind to this SNMPv3 group. An SNMPv3 user bound to this group can access the subtrees that are bound to this SNMPv3 view as type INCLUDED, but cannot access the ones that are type EXCLUDED. If the Citrix ADC has multiple SNMPv3 view entries with the same name, all such entries are associated with the SNMPv3 group.
    .EXAMPLE
        PS C:\>Invoke-NSUpdateSnmpgroup -name <string> -securitylevel <string> -readviewname <string>
        An example how to update snmpgroup config Object(s).
    .NOTES
        File Name : Invoke-NSUpdateSnmpgroup
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpgroup/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUpdateSnmpgroup: Starting"
    }
    process {
        try {
            $payload = @{ name = $name
            ...
            if ( $PSCmdlet.ShouldProcess("snmpgroup", "Update SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method PUT -NitroPath nitro/v1/config -Type snmpgroup -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSUpdateSnmpgroup: Finished"
    }
}
...
function Invoke-NSGetSnmpgroup {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpgroup
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpgroup -GetAll 
        Get all snmpgroup data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpgroup -Count 
        Get the number of snmpgroup objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpgroup -name <string>
        Get snmpgroup object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpgroup -Filter @{ 'name'='<value>' }
        Get snmpgroup data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmpgroup
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpgroup/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmpgroup: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpgroup -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpgroup -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving snmpgroup configuration for property ''"

            } else {
                Write-Verbose "Retrieving snmpgroup configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpgroup -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmpgroup: Ended"
    }
}
...
function Invoke-NSAddSnmpmanager {
    ...
    .PARAMETER Domainresolveretry 
        ...
        Maximum value = 20939
    .EXAMPLE
        PS C:\>Invoke-NSAddSnmpmanager -ipaddress <string>
        An example how to add snmpmanager config Object(s).
    .NOTES
        File Name : Invoke-NSAddSnmpmanager
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpmanager/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSAddSnmpmanager: Starting"
    }
    process {
        try {
            ...
            if ( $PSCmdlet.ShouldProcess("snmpmanager", "Add SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method POST -NitroPath nitro/v1/config -Type snmpmanager -Payload $payload -GetWarning
                #HTTP Status Code on Success: 201 Created
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSAddSnmpmanager: Finished"
    }
}
...
function Invoke-NSDeleteSnmpmanager {
    ...
    .PARAMETER Netmask 
        Subnet mask associated with an IPv4 network address. If the IP address specifies the address or host name of a specific host, accept the default value of 255.255.255.255.
    .EXAMPLE
        PS C:\>Invoke-NSDeleteSnmpmanager -Ipaddress <string>
        An example how to delete snmpmanager config Object(s).
    .NOTES
        File Name : Invoke-NSDeleteSnmpmanager
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpmanager/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSDeleteSnmpmanager: Starting"
    }
    process {
        try {
            $arguments = @{ }
            if ( $PSBoundParameters.ContainsKey('Netmask') ) { $arguments.Add('netmask', $Netmask) }
            if ( $PSCmdlet.ShouldProcess("$ipaddress", "Delete SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method DELETE -Type snmpmanager -NitroPath nitro/v1/config -Resource $ipaddress -Arguments $arguments
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSDeleteSnmpmanager: Finished"
    }
}
...
function Invoke-NSUpdateSnmpmanager {
    ...
    .PARAMETER Domainresolveretry 
        ...
        Maximum value = 20939
    .EXAMPLE
        PS C:\>Invoke-NSUpdateSnmpmanager -ipaddress <string>
        An example how to update snmpmanager config Object(s).
    .NOTES
        File Name : Invoke-NSUpdateSnmpmanager
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpmanager/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUpdateSnmpmanager: Starting"
    }
    process {
        try {
            $payload = @{ ipaddress = $ipaddress }
            if ( $PSBoundParameters.ContainsKey('netmask') ) { $payload.Add('netmask', $netmask) }
            if ( $PSBoundParameters.ContainsKey('domainresolveretry') ) { $payload.Add('domainresolveretry', $domainresolveretry) }
            if ( $PSCmdlet.ShouldProcess("snmpmanager", "Update SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method PUT -NitroPath nitro/v1/config -Type snmpmanager -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSUpdateSnmpmanager: Finished"
    }
}
...
function Invoke-NSUnsetSnmpmanager {
    ...
    .PARAMETER Domainresolveretry 
        ...
        Maximum value = 20939
    .EXAMPLE
        PS C:\>Invoke-NSUnsetSnmpmanager -ipaddress <string>
        An example how to unset snmpmanager config Object(s).
    .NOTES
        File Name : Invoke-NSUnsetSnmpmanager
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpmanager
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUnsetSnmpmanager: Starting"
    }
    process {
        try {
            $payload = @{ ipaddress = $ipaddress }
            if ( $PSBoundParameters.ContainsKey('netmask') ) { $payload.Add('netmask', $netmask) }
            if ( $PSBoundParameters.ContainsKey('domainresolveretry') ) { $payload.Add('domainresolveretry', $domainresolveretry) }
            if ( $PSCmdlet.ShouldProcess("$ipaddress", "Unset SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method POST -Type snmpmanager -NitroPath nitro/v1/config -Action unset -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSUnsetSnmpmanager: Finished"
    }
}
...
function Invoke-NSGetSnmpmanager {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpmanager
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpmanager -GetAll 
        Get all snmpmanager data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpmanager -Count 
        Get the number of snmpmanager objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpmanager -name <string>
        Get snmpmanager object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpmanager -Filter @{ 'name'='<value>' }
        Get snmpmanager data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmpmanager
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpmanager/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmpmanager: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpmanager -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpmanager -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpmanager -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmpmanager: Ended"
    }
}
...
function Invoke-NSUpdateSnmpmib {
    ...
    .EXAMPLE
        PS C:\>Invoke-NSUpdateSnmpmib 
        An example how to update snmpmib config Object(s).
    .NOTES
        File Name : Invoke-NSUpdateSnmpmib
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpmib/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSUpdateSnmpmib: Starting"
    }
    process {
        try {
            $payload = @{ }
            ...
            if ( $PSBoundParameters.ContainsKey('ownernode') ) { $payload.Add('ownernode', $ownernode) }
            if ( $PSCmdlet.ShouldProcess("snmpmib", "Update SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method PUT -NitroPath nitro/v1/config -Type snmpmib -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                if ( $PSBoundParameters.ContainsKey('PassThru') ) {
                    Write-Output (Invoke-NSGetSnmpmib -Filter $payload)
                } else {
                    Write-Output $result
                }
            }
        ...
        Write-Verbose "Invoke-NSUpdateSnmpmib: Finished"
    }
}
...
function Invoke-NSUnsetSnmpmib {
    ...
    .PARAMETER Ownernode 
        ...
        Maximum value = 31
    .EXAMPLE
        PS C:\>Invoke-NSUnsetSnmpmib 
        An example how to unset snmpmib config Object(s).
    .NOTES
        File Name : Invoke-NSUnsetSnmpmib
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpmib
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUnsetSnmpmib: Starting"
    }
    process {
        try {
            $payload = @{ }
            ...
            if ( $PSBoundParameters.ContainsKey('customid') ) { $payload.Add('customid', $customid) }
            if ( $PSBoundParameters.ContainsKey('ownernode') ) { $payload.Add('ownernode', $ownernode) }
            if ( $PSCmdlet.ShouldProcess("snmpmib", "Unset SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method POST -Type snmpmib -NitroPath nitro/v1/config -Action unset -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSUnsetSnmpmib: Finished"
    }
}
...
function Invoke-NSGetSnmpmib {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpmib
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpmib -GetAll 
        Get all snmpmib data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpmib -Count 
        Get the number of snmpmib objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpmib -name <string>
        Get snmpmib object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpmib -Filter @{ 'name'='<value>' }
        Get snmpmib data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmpmib
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpmib/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmpmib: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpmib -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpmib -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving snmpmib configuration for property 'ownernode'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpmib -NitroPath nitro/v1/config -Resource $ownernode -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving snmpmib configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpmib -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmpmib: Ended"
    }
}
...
function Invoke-NSGetSnmpoid {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpoid
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpoid -GetAll 
        Get all snmpoid data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpoid -Count 
        Get the number of snmpoid objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpoid -name <string>
        Get snmpoid object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpoid -Filter @{ 'name'='<value>' }
        Get snmpoid data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmpoid
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpoid/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmpoid: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpoid -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpoid -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving snmpoid configuration for property ''"

            } else {
                Write-Verbose "Retrieving snmpoid configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpoid -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmpoid: Ended"
    }
}
...
function Invoke-NSUpdateSnmpoption {
    ...
    .PARAMETER Severityinfointrap 
        ...
        Possible values = ENABLED, DISABLED
    .EXAMPLE
        PS C:\>Invoke-NSUpdateSnmpoption 
        An example how to update snmpoption config Object(s).
    .NOTES
        File Name : Invoke-NSUpdateSnmpoption
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpoption/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSUpdateSnmpoption: Starting"
    }
    process {
        try {
            $payload = @{ }
            ...
            if ( $PSBoundParameters.ContainsKey('severityinfointrap') ) { $payload.Add('severityinfointrap', $severityinfointrap) }
            if ( $PSCmdlet.ShouldProcess("snmpoption", "Update SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method PUT -NitroPath nitro/v1/config -Type snmpoption -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSUpdateSnmpoption: Finished"
    }
}
...
function Invoke-NSUnsetSnmpoption {
    ...
    .PARAMETER Severityinfointrap 
        ...
        Possible values = ENABLED, DISABLED
    .EXAMPLE
        PS C:\>Invoke-NSUnsetSnmpoption 
        An example how to unset snmpoption config Object(s).
    .NOTES
        File Name : Invoke-NSUnsetSnmpoption
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpoption
        Requires  : PowerShell v5.1 and up
    ...
    param(
        ...
        [Boolean]$severityinfointrap 
    )
    begin {
        Write-Verbose "Invoke-NSUnsetSnmpoption: Starting"
    }
    process {
        try {
            $payload = @{ }
            ...
            if ( $PSBoundParameters.ContainsKey('snmptraplogginglevel') ) { $payload.Add('snmptraplogginglevel', $snmptraplogginglevel) }
            if ( $PSBoundParameters.ContainsKey('severityinfointrap') ) { $payload.Add('severityinfointrap', $severityinfointrap) }
            if ( $PSCmdlet.ShouldProcess("snmpoption", "Unset SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method POST -Type snmpoption -NitroPath nitro/v1/config -Action unset -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSUnsetSnmpoption: Finished"
    }
}
...
function Invoke-NSGetSnmpoption {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpoption
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpoption -GetAll 
        Get all snmpoption data.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpoption -name <string>
        Get snmpoption object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpoption -Filter @{ 'name'='<value>' }
        Get snmpoption data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmpoption
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpoption/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmpoption: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpoption -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpoption -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving snmpoption configuration for property ''"

            } else {
                Write-Verbose "Retrieving snmpoption configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpoption -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmpoption: Ended"
    }
}
...
function Invoke-NSAddSnmptrap {
    ...
    .PARAMETER Allpartitions 
        ...
        Possible values = ENABLED, DISABLED
    .EXAMPLE
        PS C:\>Invoke-NSAddSnmptrap -trapclass <string> -trapdestination <string>
        An example how to add snmptrap config Object(s).
    .NOTES
        File Name : Invoke-NSAddSnmptrap
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmptrap/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSAddSnmptrap: Starting"
    }
    process {
        try {
            ...
            if ( $PSCmdlet.ShouldProcess("snmptrap", "Add SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method POST -NitroPath nitro/v1/config -Type snmptrap -Payload $payload -GetWarning
                #HTTP Status Code on Success: 201 Created
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSAddSnmptrap: Finished"
    }
}
...
function Invoke-NSDeleteSnmptrap {
    ...
    .PARAMETER Td 
        ...
        Maximum value = 4094
    .EXAMPLE
        PS C:\>Invoke-NSDeleteSnmptrap -Trapclass <string>
        An example how to delete snmptrap config Object(s).
    .NOTES
        File Name : Invoke-NSDeleteSnmptrap
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmptrap/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSDeleteSnmptrap: Starting"
    }
    process {
        try {
            $arguments = @{ }
            ...
            if ( $PSCmdlet.ShouldProcess("$trapclass", "Delete SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method DELETE -Type snmptrap -NitroPath nitro/v1/config -Resource $trapclass -Arguments $arguments
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSDeleteSnmptrap: Finished"
    }
}
...
function Invoke-NSUpdateSnmptrap {
    ...
    .PARAMETER Allpartitions 
        ...
        Possible values = ENABLED, DISABLED
    .EXAMPLE
        PS C:\>Invoke-NSUpdateSnmptrap -trapclass <string> -trapdestination <string>
        An example how to update snmptrap config Object(s).
    .NOTES
        File Name : Invoke-NSUpdateSnmptrap
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmptrap/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUpdateSnmptrap: Starting"
    }
    process {
        try {
            $payload = @{ trapclass = $trapclass
            ...
            if ( $PSBoundParameters.ContainsKey('severity') ) { $payload.Add('severity', $severity) }
            if ( $PSBoundParameters.ContainsKey('allpartitions') ) { $payload.Add('allpartitions', $allpartitions) }
            if ( $PSCmdlet.ShouldProcess("snmptrap", "Update SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method PUT -NitroPath nitro/v1/config -Type snmptrap -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSUpdateSnmptrap: Finished"
    }
}
...
function Invoke-NSUnsetSnmptrap {
    ...
    .PARAMETER Allpartitions 
        ...
        Possible values = ENABLED, DISABLED
    .EXAMPLE
        PS C:\>Invoke-NSUnsetSnmptrap -trapclass <string> -trapdestination <string>
        An example how to unset snmptrap config Object(s).
    .NOTES
        File Name : Invoke-NSUnsetSnmptrap
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmptrap
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUnsetSnmptrap: Starting"
    }
    process {
        try {
            $payload = @{ trapclass = $trapclass
            ...
            if ( $PSBoundParameters.ContainsKey('severity') ) { $payload.Add('severity', $severity) }
            if ( $PSBoundParameters.ContainsKey('allpartitions') ) { $payload.Add('allpartitions', $allpartitions) }
            if ( $PSCmdlet.ShouldProcess("$trapclass trapdestination", "Unset SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method POST -Type snmptrap -NitroPath nitro/v1/config -Action unset -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSUnsetSnmptrap: Finished"
    }
}
...
function Invoke-NSGetSnmptrap {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmptrap
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmptrap -GetAll 
        Get all snmptrap data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmptrap -Count 
        Get the number of snmptrap objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmptrap -name <string>
        Get snmptrap object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmptrap -Filter @{ 'name'='<value>' }
        Get snmptrap data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmptrap
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmptrap/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmptrap: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmptrap -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmptrap -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving snmptrap configuration for property ''"

            } else {
                Write-Verbose "Retrieving snmptrap configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmptrap -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmptrap: Ended"
    }
}
...
function Invoke-NSGetSnmptrapBinding {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmptrapBinding
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmptrapBinding -GetAll 
        Get all snmptrap_binding data.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmptrapBinding -name <string>
        Get snmptrap_binding object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmptrapBinding -Filter @{ 'name'='<value>' }
        Get snmptrap_binding data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmptrapBinding
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmptrap_binding/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmptrapBinding: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmptrap_binding -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmptrap_binding -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmptrap_binding -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmptrapBinding: Ended"
    }
}
...
function Invoke-NSAddSnmptrapSnmpuserBinding {
    ...
    .EXAMPLE
        PS C:\>Invoke-NSAddSnmptrapSnmpuserBinding -trapclass <string> -trapdestination <string> -username <string>
        An example how to add snmptrap_snmpuser_binding config Object(s).
    .NOTES
        File Name : Invoke-NSAddSnmptrapSnmpuserBinding
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmptrap_snmpuser_binding/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSAddSnmptrapSnmpuserBinding: Starting"
    }
    process {
        try {
            $payload = @{ trapclass = $trapclass
            ...
            if ( $PSCmdlet.ShouldProcess("snmptrap_snmpuser_binding", "Add SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method PUT -NitroPath nitro/v1/config -Type snmptrap_snmpuser_binding -Payload $payload -GetWarning
                #HTTP Status Code on Success: 201 Created
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                if ( $PSBoundParameters.ContainsKey('PassThru') ) {
                    Write-Output (Invoke-NSGetSnmptrapSnmpuserBinding -Filter $payload)
                } else {
                    Write-Output $result
                }
            }
        ...
        Write-Verbose "Invoke-NSAddSnmptrapSnmpuserBinding: Finished"
    }
}
...
function Invoke-NSDeleteSnmptrapSnmpuserBinding {
    ...
    .PARAMETER Username 
        Name of the SNMP user that will send the SNMPv3 traps.
    .EXAMPLE
        PS C:\>Invoke-NSDeleteSnmptrapSnmpuserBinding -Trapclass <string>
        An example how to delete snmptrap_snmpuser_binding config Object(s).
    .NOTES
        File Name : Invoke-NSDeleteSnmptrapSnmpuserBinding
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmptrap_snmpuser_binding/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSDeleteSnmptrapSnmpuserBinding: Starting"
    }
    process {
        try {
            $arguments = @{ }
            ...
            if ( $PSCmdlet.ShouldProcess("$trapclass", "Delete SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method DELETE -Type snmptrap_snmpuser_binding -NitroPath nitro/v1/config -Resource $trapclass -Arguments $arguments
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSDeleteSnmptrapSnmpuserBinding: Finished"
    }
}
...
function Invoke-NSGetSnmptrapSnmpuserBinding {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmptrapSnmpuserBinding
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmptrapSnmpuserBinding -GetAll 
        Get all snmptrap_snmpuser_binding data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmptrapSnmpuserBinding -Count 
        Get the number of snmptrap_snmpuser_binding objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmptrapSnmpuserBinding -name <string>
        Get snmptrap_snmpuser_binding object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmptrapSnmpuserBinding -Filter @{ 'name'='<value>' }
        Get snmptrap_snmpuser_binding data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmptrapSnmpuserBinding
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmptrap_snmpuser_binding/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmptrapSnmpuserBinding: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmptrap_snmpuser_binding -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                if ( $PSBoundParameters.ContainsKey('td') ) { $arguments.Add('td', $td) } 
                if ( $PSBoundParameters.ContainsKey('trapclass') ) { $arguments.Add('trapclass', $trapclass) }
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmptrap_snmpuser_binding -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmptrap_snmpuser_binding -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmptrapSnmpuserBinding: Ended"
    }
}
...
function Invoke-NSAddSnmpuser {
    ...
    .EXAMPLE
        PS C:\>Invoke-NSAddSnmpuser -name <string> -group <string>
        An example how to add snmpuser config Object(s).
    .NOTES
        File Name : Invoke-NSAddSnmpuser
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpuser/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSAddSnmpuser: Starting"
    }
    process {
        try {
            $payload = @{ name = $name
            ...
            if ( $PSCmdlet.ShouldProcess("snmpuser", "Add SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method POST -NitroPath nitro/v1/config -Type snmpuser -Payload $payload -GetWarning
                #HTTP Status Code on Success: 201 Created
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                if ( $PSBoundParameters.ContainsKey('PassThru') ) {
                    Write-Output (Invoke-NSGetSnmpuser -Filter $payload)
                } else {
                    Write-Output $result
                }
            }
        ...
        Write-Verbose "Invoke-NSAddSnmpuser: Finished"
    }
}
...
function Invoke-NSDeleteSnmpuser {
    ...
    .PARAMETER Name 
        Name for the SNMPv3 user. Can consist of 1 to 31 characters that include uppercase and lowercase letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at sign (@), equals (=), colon (:), and underscore (_) characters.
    .EXAMPLE
        PS C:\>Invoke-NSDeleteSnmpuser -Name <string>
        An example how to delete snmpuser config Object(s).
    .NOTES
        File Name : Invoke-NSDeleteSnmpuser
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpuser/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSDeleteSnmpuser: Starting"
    }
    process {
        try {
            $arguments = @{ }
            ...
            if ( $PSCmdlet.ShouldProcess("$name", "Delete SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method DELETE -Type snmpuser -NitroPath nitro/v1/config -Resource $name -Arguments $arguments
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSDeleteSnmpuser: Finished"
    }
}
...
function Invoke-NSUpdateSnmpuser {
    ...
    .PARAMETER PassThru 
        Return details about the created snmpuser item.
    .EXAMPLE
        PS C:\>Invoke-NSUpdateSnmpuser -name <string>
        An example how to update snmpuser config Object(s).
    .NOTES
        File Name : Invoke-NSUpdateSnmpuser
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpuser/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUpdateSnmpuser: Starting"
    }
    process {
        try {
            $payload = @{ name = $name }
            ...
            if ( $PSBoundParameters.ContainsKey('privtype') ) { $payload.Add('privtype', $privtype) }
            if ( $PSBoundParameters.ContainsKey('privpasswd') ) { $payload.Add('privpasswd', $privpasswd) }
            if ( $PSCmdlet.ShouldProcess("snmpuser", "Update SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method PUT -NitroPath nitro/v1/config -Type snmpuser -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                if ( $PSBoundParameters.ContainsKey('PassThru') ) {
                    Write-Output (Invoke-NSGetSnmpuser -Filter $payload)
        ...
        Write-Verbose "Invoke-NSUpdateSnmpuser: Finished"
    }
}
...
function Invoke-NSUnsetSnmpuser {
    ...
    .PARAMETER Privpasswd 
        Encryption key to be used by the encryption algorithm specified by the privType (Encryption Type) parameter. Can consist of 1 to 31 characters that include uppercase and lowercase letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at sign (@), equals (=), colon (:), and underscore (_) characters.
    .EXAMPLE
        PS C:\>Invoke-NSUnsetSnmpuser -name <string>
        An example how to unset snmpuser config Object(s).
    .NOTES
        File Name : Invoke-NSUnsetSnmpuser
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpuser
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUnsetSnmpuser: Starting"
    }
    process {
        try {
            $payload = @{ name = $name }
            ...
            if ( $PSBoundParameters.ContainsKey('authpasswd') ) { $payload.Add('authpasswd', $authpasswd) }
            if ( $PSBoundParameters.ContainsKey('privpasswd') ) { $payload.Add('privpasswd', $privpasswd) }
            if ( $PSCmdlet.ShouldProcess("$name", "Unset SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method POST -Type snmpuser -NitroPath nitro/v1/config -Action unset -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSUnsetSnmpuser: Finished"
    }
}
...
function Invoke-NSGetSnmpuser {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpuser
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpuser -GetAll 
        Get all snmpuser data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpuser -Count 
        Get the number of snmpuser objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpuser -name <string>
        Get snmpuser object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpuser -Filter @{ 'name'='<value>' }
        Get snmpuser data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmpuser
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpuser/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmpuser: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpuser -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpuser -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving snmpuser configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpuser -NitroPath nitro/v1/config -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving snmpuser configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpuser -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmpuser: Ended"
    }
}
...
function Invoke-NSAddSnmpview {
    ...
    .EXAMPLE
        PS C:\>Invoke-NSAddSnmpview -name <string> -subtree <string> -type <string>
        An example how to add snmpview config Object(s).
    .NOTES
        File Name : Invoke-NSAddSnmpview
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpview/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSAddSnmpview: Starting"
    }
    process {
        try {
            $payload = @{ name = $name
            ...
            if ( $PSCmdlet.ShouldProcess("snmpview", "Add SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method POST -NitroPath nitro/v1/config -Type snmpview -Payload $payload -GetWarning
                #HTTP Status Code on Success: 201 Created
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSAddSnmpview: Finished"
    }
}
...
function Invoke-NSDeleteSnmpview {
    ...
    .PARAMETER Subtree 
        A particular branch (subtree) of the MIB tree that you want to associate with this SNMPv3 view. You must specify the subtree as an SNMP OID.
    .EXAMPLE
        PS C:\>Invoke-NSDeleteSnmpview -Name <string>
        An example how to delete snmpview config Object(s).
    .NOTES
        File Name : Invoke-NSDeleteSnmpview
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpview/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSDeleteSnmpview: Starting"
    }
    process {
        try {
            $arguments = @{ }
            ...
            if ( $PSCmdlet.ShouldProcess("$name", "Delete SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method DELETE -Type snmpview -NitroPath nitro/v1/config -Resource $name -Arguments $arguments
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $response
            }
        ...
        Write-Verbose "Invoke-NSDeleteSnmpview: Finished"
    }
}
...
function Invoke-NSUpdateSnmpview {
    ...
    .PARAMETER Type 
        ...
        Possible values = included, excluded
    .EXAMPLE
        PS C:\>Invoke-NSUpdateSnmpview -name <string> -subtree <string> -type <string>
        An example how to update snmpview config Object(s).
    .NOTES
        File Name : Invoke-NSUpdateSnmpview
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpview/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSUpdateSnmpview: Starting"
    }
    process {
        try {
            $payload = @{ name = $name
            ...
            if ( $PSCmdlet.ShouldProcess("snmpview", "Update SNMP(Simple Network Management Protocol) configuration. config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method PUT -NitroPath nitro/v1/config -Type snmpview -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSUpdateSnmpview: Finished"
    }
}
...
function Invoke-NSGetSnmpview {
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpview
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpview -GetAll 
        Get all snmpview data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpview -Count 
        Get the number of snmpview objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpview -name <string>
        Get snmpview object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpview -Filter @{ 'name'='<value>' }
        Get snmpview data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmpview
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/snmp/snmpview/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmpview: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpview -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpview -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving snmpview configuration for property ''"

            } else {
                Write-Verbose "Retrieving snmpview configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmpview -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSnmpview: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA3thpxath6Qi3C
# T1EwUY3SWKdJyf8BicSG29MilGPWxKCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQg509L3fQp3C1HKnXJ1BpjOQ9RWg4eOIpuRvw8epN3jJ0wDQYJ
# KoZIhvcNAQEBBQAEggEAou5GwnJZjK60OC3I6gzar2J16W6QPXDynM9yJ8hhuFcZ
# Lym9WlLyOvZg1tcoghj7Z6/2fBW3KvVkVmp2EftsB9Li6W9UwFIMPqiCuJ+kiwpt
# vvnunxozYHTlIGx0pEfDJEFWbu2aHucuqQqWUuCodfw0muPUIxZAIrA8dPK7vo0g
# ay93D4Gb3xQvZEA6jlD04HBwMz/1rsVwuIizz0bFD1SYLlfLm6Mf3SJ6B6Brr9mq
# ABof5Ks0kNWP42Qez6NuUMaJwCLCiXmWphiNuu3lgrzvojH7cwpTw665cZDsUESV
# 8QaONjZV2R6z7wmRfHjVlP79e0KSYurJ4ijCr8Bj6KGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQzMzRaMD8GCSqG
# SIb3DQEJBDEyBDBqJPNf1/LBLDqBhdJ14388TyA8T0fc7gEb8GyGyfjd1w0yhGCK
# 8Ztgp6JPSiVnzAswDQYJKoZIhvcNAQEBBQAEggIAC2GRu/yVQSsoTNTgkIE3wUsM
# HEJcXJKkA98tk8DUnZKIgVKwglpRFyrqFOHRLughZQRnRvtqIXAY+WvmNcHUvdpa
# gpIOBeWJx9SvmyS/TLhqkQfKI2wjq3aSufjYmEWR8HtywVQ73bs1nmpzbRoRzIYs
# ZkXzEJAD3V3qd7eQqy31P1jyTPuTEwdNPSP5FFwYGSdRF4/FVHylpj2uE3rAYJay
# xaHURdXjrwgDu5szHbzto0+b9Ni/tD+gEavirx5qmGubR7hyFN5Qu3fAFet9wFEK
# D/GhZVLjgSG14MeAcjZIE4nmMrKTQOR4Fkhwc841YuymFeiSnE2EkkL2Nx3uVwgV
# +mHYLnQQRgoRWzPzW7zu4YDYwUouE2LHGrvpcPHVvE97g1O0ksUdwjAqNuwyqsG1
# P/bhEQo1ie3Y8pjmmJ8wIeoDmw10wO0v4PtKTYGQxTWDs459oO5JuCxmKdK+Y9/5
# wjWyNW08YiOww9V+ZCNYJ89BqcO4LUlSoAtxGmM1ZxtgP+5kJeD5BuRIqPjVMFAd
# qMEBJUlwZDG9UuRnQEZ9FjnsrHng4K+OD1MoorcRwwPuflAkEuiMfpyhv2QdLNbc
# xUyUkHL5hoZdBv/is4i0odY9ZGVy2ZAjoHnOtj6+TgFvpBlv5rhvpKhXh2q1niZM
# nEYLN4XgDiEkHraQdPs=
