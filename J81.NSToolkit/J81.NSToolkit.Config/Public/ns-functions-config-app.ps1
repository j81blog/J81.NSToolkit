function Invoke-NSImportApplication {
    <#
    .SYNOPSIS
        Import Application config Object.
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSImportApplication -apptemplatefilename <string>
        An example how to import application config Object(s).
    .NOTES
        File Name : Invoke-NSImportApplication
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/app/application/
    ...
    begin {
        Write-Verbose "Invoke-NSImportApplication: Starting"
    }
    process {
        try {
            ...
            if ( $PSCmdlet.ShouldProcess($Name, "Import Application config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method POST -NitroPath nitro/v1/config -Type application -Action import -Payload $payload -GetWarning
        ...
        Write-Verbose "Invoke-NSImportApplication: Finished"
    }
}

function Invoke-NSExportApplication {
    <#
    .SYNOPSIS
        Export Application config Object.
    .DESCRIPTION
        Configuration for application resource.
    .PARAMETER Appname 
        Name to assign to the application on the Citrix ADC. If you do not provide a name, the appliance assigns the application the name of the template file. 
    ...
    .PARAMETER Deploymentfilename 
        Name of the deployment file.
    .EXAMPLE
        PS C:\>Invoke-NSExportApplication -appname <string>
        An example how to export application config Object(s).
    .NOTES
        File Name : Invoke-NSExportApplication
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/app/application/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSExportApplication: Starting"
    }
    process {
        try {
            ...
            if ( $PSBoundParameters.ContainsKey('deploymentfilename') ) { $payload.Add('deploymentfilename', $deploymentfilename) }
            if ( $PSCmdlet.ShouldProcess($Name, "Export Application config Object") ) {
                $result = Invoke-NSNitroApi -NSSession $NSSession -Method POST -NitroPath nitro/v1/config -Type application -Action export -Payload $payload -GetWarning
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
                Write-Output $result
            }
        ...
        Write-Verbose "Invoke-NSExportApplication: Finished"
    }
}

function Invoke-NSDeleteApplication {
    <#
    .SYNOPSIS
        Delete Application config Object.
    .DESCRIPTION
        Configuration for application resource.
    .PARAMETER Appname 
        Name to assign to the application on the Citrix ADC. If you do not provide a name, the appliance assigns the application the name of the template file.
    .EXAMPLE
        PS C:\>Invoke-NSDeleteApplication 
        An example how to delete application config Object(s).
    .NOTES
        File Name : Invoke-NSDeleteApplication
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/app/application/
        Requires  : PowerShell v5.1 and up
    ...
    begin {
        Write-Verbose "Invoke-NSDeleteApplication: Starting"
    }
    process {
        try {
            $arguments = @{ }
            if ( $PSBoundParameters.ContainsKey('Appname') ) { $arguments.Add('appname', $Appname) }
            if ( $PSCmdlet.ShouldProcess("application", "Delete Application config Object") ) {
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method DELETE -Type application -NitroPath nitro/v1/config -Resource $ -Arguments $arguments
                #HTTP Status Code on Success: 200 OK
                #HTTP Status Code on Failure: 4xx <string> (for general HTTP errors) or 5xx <string> (for NetScaler-specific errors). The response payload provides details of the error
        ...
        Write-Verbose "Invoke-NSDeleteApplication: Finished"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABC