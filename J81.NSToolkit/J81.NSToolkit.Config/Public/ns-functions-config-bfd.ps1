function Invoke-NSGetBfdsession {
    <#
    .SYNOPSIS
        Get Bidirectional Forwarding Detection config object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetBfdsession
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetBfdsession -GetAll 
        Get all bfdsession data. 
    .EXAMPLE 
        PS C:\>Invoke-NSGetBfdsession -Count 
        Get the number of bfdsession objects.
    .EXAMPLE
        PS C:\>Invoke-NSGetBfdsession -name <string>
        Get bfdsession object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetBfdsession -Filter @{ 'name'='<value>' }
        Get bfdsession data with a filter.
    .NOTES
        File Name : Invoke-NSGetBfdsession
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/configuration/bfd/bfdsession/
    ...
    begin {
        Write-Verbose "Invoke-NSGetBfdsession: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type bfdsession -NitroPath nitro/v1/config -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type bfdsession -NitroPath nitro/v1/config -Arguments $arguments -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type bfdsession -NitroPath nitro/v1/config -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetBfdsession: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDGdnejntSXF60G
# LGSdjWX6k4yvRcFFPzH9mt7cgqumw6CCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgT0I8RRzLUqk9FzXAf3xU8urY60+Ubsmngxfgyv0WapkwDQYJ
# KoZIhvcNAQEBBQAEggEAkNg8Ee0+do4ILg+HhaFB7OtddUSEBkNSX8yMG3UpSKRS
# 77OU/V6WZQ4c81V6VoRzJKwN4uhfscxYoXHo4Pr1yytI7iKiPx5Nlc+ZMwHZ2L45
# kShdEPlgJcK85ZGvwoZFlg1RZo+iw8CkFANdFJlzxYe4IhQ+fczwUi0flYT4aasF
# aUhCoFLea2FEA89ryJP+mnl9q8+1/iPINJfJKrrUegnxqc2YYfL5wvOsKaS1eoDA
# p3/iOPfOKu0I/7LwqYYOreQJdBp0RVBvTmuygzin1+lMwhzwraz5KXI8CvYQTRMF
# NW37tEbm000RQRcgS0zk8oo9TNYhiSPwQ+9qnGuEJaGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQxNDZaMD8GCSqG
# SIb3DQEJBDEyBDComQZ0CzLMefmwEzn2abVUEGfUwDG+sDzbQkwyNGhKFK7agBX/
# X7cj8yxSj6r5qM8wDQYJKoZIhvcNAQEBBQAEggIARr3yhrmCFOF8SJuthwEruKx4
# 6ec8liiGotg6BcQKA6pVoG6JeYBWnAFYfcePGlS0uQRC6PdRTfSRsyzYZR14N+fO
# k1oJGUTZtwIhtDXUXmROTZpmIoDG0WQQO3NL1neqdnC7HHeXTK4/8DUeT6evJV9U
# FiafL801QXWwl+GT9Mzflm8q9Esft6QHhtOx41hOOoELp1LJX7uvsjW8Hbz+BPoj
# tvf07eXo82xyB/QXFDCzRkREdfDj3Pz1QrZD19UGtTRRsVONSqRA3wvevLl1habF
# C8XDARf0MB6Be7yYUSQBvaIuRLYmdbUcBcXKK8t319G9dwT1YWGv/z/pAYISXY5E
# H3VekBWokdWyODCXd3UgOZiyeONt3PaD1co+s4+gRkbcuAUBaflFG7mIBJViWppe
# HEPQ/f21XuZE4cm180niDYDkp4uKTNcXTFIg429SkmEntbKvSodxXo8jVwp66TrG
# HzD7K3uzMjHtCTkZylg3jpppTKhotJO14syzBdknsaEviUGlLq2w7YIUB50Jl9Vv
# /s3NRDaoonymH+D9yaOfi1jftN8LN/sAWjuUhz9Vth9ZUow3rQWNbXTZj8Hmjmax
# 1DTaLvxPLGHXoplzI/ks2s1fapy8ETdS+vVxJFHInRrkUsn1O/+o5qyekWz2PYIQ
# u/wbTx/u5ixNVMKMe/s=
