function Write-NSText {
    ...
    .PARAMETER Result
        Pass the result from any NS function to write the result to the console
    .PARAMETER PassThru
        Return the input object as output
    .EXAMPLE
        $lbvserver = Invoke-NSGetLBvServer | Write-NSText -PassThru
    .NOTES
        File Name : Write-NSText
        Version   : v2101.0322
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCiKZ5NEhM+Bcf4
# sYD8FEzBKlOqcRyAAZYHoegCT1CFvKCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQg7FfZ0uXjnWLb200dzUuozt8AA4LH1J5Yom/vMqIKSx0wDQYJ
# KoZIhvcNAQEBBQAEggEAlp8Gs+kd0pO/ErPAj8ZV/z98z7IcDKW5gJsNcspwJx8S
# dXt0gHtJdYYpYMMTOQkanSTcZH75/r1hflopgH+JueG6WeqHG1MzaGZMVeg+pfvm
# j+vkWkc27izyKl/kcLDa37zPOnbnYaNS8UL4+3R3ZLtCm4AJ4mw7hyk1X58Q7ITh
# gDLrB/LFwKPopaGXsU4RB98ltz44L5ZywVdmAkHgMakbL8Pz3b3Adjlxl6MKC5ME
# ki2u5S5rhenRZWDQPtepfT7J/3PXgP0UMkPLxUpMyneol7/PKU4jW6T7D9lvfeoW
# JBBF73vrL1F8aSJTnr2H6Q32Qpp8+BV4s+T9RRDzBKGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMTYyMDU4NDNaMD8GCSqG
# SIb3DQEJBDEyBDAe3L5/7SEjiMq9SqtqGdou+rFCXVz2AaJnSDgb00GFuQKjIihm
# 8LSlX6TTy/gzOBgwDQYJKoZIhvcNAQEBBQAEggIAijuqbatQ8PvtRZw8gAb5pXd4
# JSP9AGSKChGwJE7sNZ40j3hx/5kvE1zlmT24QaaiXngCTUBwUHJUoQS5MSnG4trW
# 0jRptZPUBNqc3Cv2rDLzr3uA1QLz5ZZ+zuy4sbmZpYlYltBWElOjXaOAhq56LdHt
# /MAbmtYRPEFzrOHxGKXwFhgiZCXfxZYMDsSbSHMK3BdqzmoZ/gb3ltpWEW0Y+i+8
# t/nr89/mOadKMCKbWKFohu2yxUvA/cEImf0w0wW0znvHKb4lrN6VOXE6ddrRDGs+
# Azpn1LwgjhubjaqBnZQbjRcPW3LAftDSGPglWvJlM+s+oqR23Kl6Ja0K7euxRmwy
# Bf4fzv2XBDCxRRdglo0dmoLTy1VRozLbrTybS1iyniu2COT6CyTnCYXtK64Gto3J
# BsqaQQGNMKo8XzcrXIc7KgM1gaydtBGQsTkqeQmO3Rb4iKYRUUIuoEOu0brSd/Fp
# LM3qzKaCPY/BBJeiJeOB/Sv7W2Z344RA9ax5gXgulfqO+6fPGazJ58iMulrIfIFo
# PoBAhj78otQig/5NGBf86h45aonSowvOFkbbe5I7OcXfe834WrpnazvlriBLvCVz
# xWUblHaztzXw9t4nj3pCrWETvWq5si0IUEc+vh600DWVzc7/TonD2sxvO7InoQpW
# DErauRm1AvUF5YKuEqQ=
