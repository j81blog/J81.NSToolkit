function Invoke-NSGetCrvserverStats {
    <#
    .SYNOPSIS
        Get Cache redirection statistics. The cache redirection feature can transparently redirect cacheable HTTP requests to a cache and send non-cacheable or dynamic HTTP requests to the origin server. A cache stores or caches frequently requested web content and serves such web content to a client on behalf of the origin servers, alleviating the load on the origin server farm. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetCrvserverStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetCrvserverStats -GetAll 
        Get all crvserver data.
    .EXAMPLE
        PS C:\>Invoke-NSGetCrvserverStats -name <string>
        Get crvserver object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetCrvserverStats -Filter @{ 'name'='<value>' }
        Get crvserver data with a filter.
    .NOTES
        File Name : Invoke-NSGetCrvserverStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/cr/crvserver/
    ...
    begin {
        Write-Verbose "Invoke-NSGetCrvserverStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type crvserver -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type crvserver -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving crvserver configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type crvserver -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving crvserver configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type crvserver -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetCrvserverStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDxmm4hiSh9TWsF
# qm9PpNrgTfBKT1ZupJhvqbgfTkLl0KCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgKeUIKvqaD181o55d+scn6JzMxF7u03IxPGlogVNuDRowDQYJ
# KoZIhvcNAQEBBQAEggEAmYwQYXibzbBY1r+iKVDvbD9iLXIz/9JrHZvAj9t07ERP
# GfrUCGTOf5mFzgk7TzQItC00m6Zjp84BjpcDJ4lAs+P5j+jS1vBWxS3S2+n8D6jg
# wi85ah6fzJKB0cBDma0xBj0V/xO79K/mr6i2gWqLFpfy4q1JJU89+MeXBxNBxe9p
# FFZKG/p5VMj+b8haXSzPRdeAz+cOO2awh+FtBC0N8npElnUccy0pKaQcOdbmQxKd
# Zbrykwx4frEQNQ0TFvVt0PIw4FUKHq7iqcCPrf8Bo9e14dBvxJy9d3vokl8J06wz
# AIMiu869Ut7L9zM8ODOpovcDWtXG2DCszgMXGS68FqGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ1MDhaMD8GCSqG
# SIb3DQEJBDEyBDBj1g4J6en44x7w/t+ZipiO5MI9WOcjZT7vlonCzF4Pz55U/1yK
# JCR3HPqcO6b2L50wDQYJKoZIhvcNAQEBBQAEggIANkR/2Y49nKNrkuwHBqMMwKN4
# cwUlr8jTvhi5k2+vunKzwy81aIGV1iw2zCyCMczrLhyTPoeafsu8BctsL9wPdIDT
# eIzR58UvIE1J4wxSkcZrFNdpjCKW3AeMwQmDwGF3ATk5Jj1khNr2zMZpGvwTNhMS
# fyFJImIW/hIPNdns/iQY0tk8IfNuZ+j+k3YJewU1o3f6M2cUAlM9Xiqy3oWsn8gy
# 7qBeDaXSNEHRzM71217dIEKbSOt7IM0T3+Mcvf6Rcm+EnV/a2L1ra8Wt5+fkZHTO
# WYydt2ABSeDbUQqSQTs8NP9QR1zVnYEFPm527arPWcWTby0vnzIdlVdOdZzUt7i/
# tP9HS7LiTgUTRK1O73CQ7Q67iukgvYdqjnBEy9Gid4+/kmNGJAPviASDrLVG4Wlt
# iET7I8lcz+x1elxyE2r4+KsNJSB3nMP4R9x9TGT5u94TTPZoQ1lTnDswLN1zBSX2
# DVdBRgyDz80kvMpq3uVBO/rIrq200k+nr+ZaA9FbaM+hpKc/MMsWwrkfPtmHoKn0
# 4ePKGkmliDUY1rgaTR9ia2e81ynkDa7XKe5pnMOTxI1S5d/CqZCtbrHwxY0UFQUl
# sDe9d+CmrfuLmdiWLUu5M6RlD3JzAKpS++3+MbcJ+pxOQAfxwiQVnPQSGiYmgdsp
# 2D8FWsSVlgAjEHOyZX4=
