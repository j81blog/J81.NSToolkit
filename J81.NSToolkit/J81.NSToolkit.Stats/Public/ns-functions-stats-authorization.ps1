function Invoke-NSGetAuthorizationpolicylabelStats {
    <#
    .SYNOPSIS
        Get Authorization statistics. Authorization services check which resources users are authorized to access, and grant permissions accordingly. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetAuthorizationpolicylabelStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetAuthorizationpolicylabelStats -GetAll 
        Get all authorizationpolicylabel data.
    .EXAMPLE
        PS C:\>Invoke-NSGetAuthorizationpolicylabelStats -name <string>
        Get authorizationpolicylabel object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetAuthorizationpolicylabelStats -Filter @{ 'name'='<value>' }
        Get authorizationpolicylabel data with a filter.
    .NOTES
        File Name : Invoke-NSGetAuthorizationpolicylabelStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/authorization/authorizationpolicylabel/
    ...
    begin {
        Write-Verbose "Invoke-NSGetAuthorizationpolicylabelStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type authorizationpolicylabel -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type authorizationpolicylabel -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving authorizationpolicylabel configuration for property 'labelname'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type authorizationpolicylabel -NitroPath nitro/v1/stat -Resource $labelname -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving authorizationpolicylabel configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type authorizationpolicylabel -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetAuthorizationpolicylabelStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCzonWLCqh1nlSm
# +XA1XJLXWuKLZzDUlAvp75nrXaAFRKCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgzVepY5US7OH4uGxX2FqB6PGT+SVRqEsx3qQjdLgzpSUwDQYJ
# KoZIhvcNAQEBBQAEggEAiNL9PNaY3ulixECYeHl/GXYr5nqyGpztXI/TYVFhHONM
# eEZ5ztBEfQRBnECRxMHlYl4zK06EAFr5rSVkRF+AT62CY+qHXKE1NJdCjcsno84k
# wKZIim1kyBNYkhngc9Cz6V4JgDkFj7Z7grHE0fIypupP0Uj10EsRQMndvVpuvMu0
# w0L6V8FJ/OVvvo5LreCBuDiZsmKM33gB1Nyng2EO9PIsdk4TWzu01FsUyx7Q3Dx+
# UXmXkrwslYWDeuo3/HmZ0ghOtGJ2islL/n5U4BwJZPr0OT6pzVx67/YF6Sa+i2i9
# iNdtVTDqK1zxr15yulJBRYHHZtwCtyOgDMIaVLUSOqGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ0NDBaMD8GCSqG
# SIb3DQEJBDEyBDC+1yWga8fmMqfFRsRTu1z+bOjRmVITKBPXngXhzTRate7xAbEL
# k2HDwuM/37TJndMwDQYJKoZIhvcNAQEBBQAEggIAQUYPMmSY9l4Poh/hf+NVxVX3
# IyJw1BHzJmTYC1rCNvmE9nu1HFIxIvwOz5eMQPxLa+hsMVHob6kWH2PYpw6PltCF
# fowqam8qLbxaVNaNsVoQVRU2IdLlUOyTpfCf8G4OnTEj89yXWzTOs3B0RUpWbLkZ
# CC69NajhhdlCc09WyOg2lBf7RDWL4xZ9SanjnZjWNAa2/WFJl+hzPgiJQO0V9m+8
# 7EEf+jGm6VNmoe3+5DmKobWGFyT+lQWC5wvowDbSRcPOggILzHVDBRVoN86IfGK9
# SnLzonkgnn0KNCAXNtLUwYX6NkawJfIhdoXxLphe8PDJvdAVr9UdxHjbok5RiPlC
# C0BuvCkKu46jgiKDLNOjLq5LkTJdq4LYEmTo9/wkX0NwdgMQ8ljx6C56P+fSmCmp
# QxyYNaiY6UgelwDmZfA0MJxzAMmF2ofTWJ+XykQ9taZB6P1gHPo8tZVNceLZwHak
# Ehydumi2RCLHh8a7WzZUAXrkw6/FYOj8XOUlJwFLUED5IZHW4DgQQjkFX6um1usq
# toSlya7WvyTR+iVkPa78chgLGfMZX4Gzp7HQn73Ks6W4wZOtrSzlf5lS5NkQPwnn
# wd4cx9ajgF1rALaIiSu7vEeyJ7qP3D0lM1pQ1zcH7gNJV9+9zE0SMWwtqZFvzp33
# jhFw87pdbTEEi4erlZA=
