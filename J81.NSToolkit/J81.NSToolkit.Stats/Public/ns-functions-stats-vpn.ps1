function Invoke-NSGetVpnStats {
    <#
    .SYNOPSIS
        Get Virtual Private Network statistics. stats object(s).
    .DESCRIPTION
        Statistics for vpn.
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetVpnStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetVpnStats -GetAll 
        Get all vpn data.
    .EXAMPLE
        PS C:\>Invoke-NSGetVpnStats -name <string>
        Get vpn object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetVpnStats -Filter @{ 'name'='<value>' }
        Get vpn data with a filter.
    .NOTES
        File Name : Invoke-NSGetVpnStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/vpn/vpn/
    ...
    begin {
        Write-Verbose "Invoke-NSGetVpnStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type vpn -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type vpn -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving vpn configuration for property ''"

            } else {
                Write-Verbose "Retrieving vpn configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type vpn -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetVpnStats: Ended"
    }
}

function Invoke-NSGetVpnurlpolicyStats {
    <#
    .SYNOPSIS
        Get Virtual Private Network statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetVpnurlpolicyStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetVpnurlpolicyStats -GetAll 
        Get all vpnurlpolicy data.
    .EXAMPLE
        PS C:\>Invoke-NSGetVpnurlpolicyStats -name <string>
        Get vpnurlpolicy object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetVpnurlpolicyStats -Filter @{ 'name'='<value>' }
        Get vpnurlpolicy data with a filter.
    .NOTES
        File Name : Invoke-NSGetVpnurlpolicyStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/vpn/vpnurlpolicy/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetVpnurlpolicyStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type vpnurlpolicy -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type vpnurlpolicy -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving vpnurlpolicy configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type vpnurlpolicy -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving vpnurlpolicy configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type vpnurlpolicy -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetVpnurlpolicyStats: Ended"
    }
}

function Invoke-NSGetVpnvserverStats {
    <#
    .SYNOPSIS
        Get Virtual Private Network statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetVpnvserverStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetVpnvserverStats -GetAll 
        Get all vpnvserver data.
    .EXAMPLE
        PS C:\>Invoke-NSGetVpnvserverStats -name <string>
        Get vpnvserver object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetVpnvserverStats -Filter @{ 'name'='<value>' }
        Get vpnvserver data with a filter.
    .NOTES
        File Name : Invoke-NSGetVpnvserverStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/vpn/vpnvserver/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetVpnvserverStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type vpnvserver -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type vpnvserver -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving vpnvserver configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type vpnvserver -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving vpnvserver configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type vpnvserver -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetVpnvserverStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDWdw/x5iBRVfyK
# PTW832Fn5e/IJ9VorhMnMOCmtCJ/kqCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQ