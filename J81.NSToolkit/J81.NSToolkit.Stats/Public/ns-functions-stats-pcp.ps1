function Invoke-NSGetPcpserverStats {
    <#
    .SYNOPSIS
        Get Port Control Protocol statistics. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetPcpserverStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetPcpserverStats -GetAll 
        Get all pcpserver data.
    .EXAMPLE
        PS C:\>Invoke-NSGetPcpserverStats -name <string>
        Get pcpserver object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetPcpserverStats -Filter @{ 'name'='<value>' }
        Get pcpserver data with a filter.
    .NOTES
        File Name : Invoke-NSGetPcpserverStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/pcp/pcpserver/
    ...
    begin {
        Write-Verbose "Invoke-NSGetPcpserverStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type pcpserver -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type pcpserver -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving pcpserver configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type pcpserver -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving pcpserver configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type pcpserver -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetPcpserverStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCXMMnE5mmAHWew
# p5LOegoXNC73CIBXPXIPiH4Ww6T2w6CCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgGd8VOAkcv1eFDCu7r5Qo13rhUeA7bqNZ5qxgVMDoOUwwDQYJ
# KoZIhvcNAQEBBQAEggEAfKSxSZ/nQqk271tQF7qSTmh03DsxS6Jxaztk21mv5o5t
# nNKEVoU20s9+n/TIb3ADSFAM/AFOvIpcfEsbTE9KUvn8N5kKf1S5TB8fWcgbO0dT
# 7zp0mus9m50HRQxYA/Pv90I0wOJurra+PIYUJLhq7sHbE3dc8UxWE1nrrN6E14Kh
# DmscjYmAVXXXzC4O4tQ14WmrUF7Pvz73sdyE2YAQKEkqJJ/rp/0PAxov16VVdIgI
# Gw1yyRVSy8snX5F0yjDDxqFxtnhO2A5XoGByLpdjSAJOYH6C2AEScteuhDZL8zBd
# AuiFBXhKO6OHI/i9//RaWC9XEqVUri0d57BbCtKjbaGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ1NDlaMD8GCSqG
# SIb3DQEJBDEyBDAdIdjsExS2WMZXOItmMJR4fTHY8lYe2VlArvEQiuRds4iIc344
# r/H9SzAdYCUgOqcwDQYJKoZIhvcNAQEBBQAEggIAF22IQd9dXfWbgnZxNe1J3W52
# bH8vQC6hAyCub4iTC0WtY0H2pCvho4bRXCHFE7w+kVROxQm6ApcvoUufIdAMjqZS
# WdXLSWZYI95YNM1YcTPBjKJ9zkrQXVB3yOuALZaSGi0c5nQBz3YWTeEuxx4uPZtf
# LFAXdMKyE/ML1F1WvfT7ujwjhZ3doB+EwHbLAusk6A2bJ+/c3vRA2Ls/G92cCAcs
# vqVY0yk4JmQyxRrF+UpVQo3e550Ro4V/aZvSPdPSetRIGBHvhVV+hHOcpKR5E/Nu
# PNCJyekJG4K/8kISCJduICNj/77VPbQf8VFxvU+Hg/PkG7Rk6eu973n2RGQLQiDR
# iKL3Uf9dqBngx7y/pf9lKhDh8FDNPnHQG5eUK7T79G2oXlNkIap2+zAA2ygNPhIF
# nxetgWo6l/JhFkrioKC+G880XlVparwReP4UQXs9OjGadl0SbWknGdkrXfzmy0U5
# cWcvMiD606keNzXA1SeD6lxDk587M9TPauGVv++bekmj7GkGfwNCYlepdAbeqNTK
# k6dgP47WbQmOviyzxUO3DDMKFSZzuY5QIxAtwogiFkz24DOEaNfNHHfkg/Oklc4p
# NN0YL0GUr8XDxnDE5e5gnGw8eD1v+fVQD0CEULXU6ChxuzlWyHCX7yzsr8CBOc/R
# 5IWJgv5Va9iq6EQ/zV4=
