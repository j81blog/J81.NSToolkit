function Invoke-NSGetAuditStats {
    <#
    .SYNOPSIS
        Get Audit statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER GetAll 
        Retrieve all audit object(s).
    .PARAMETER Count
        If specified, the count of the audit object(s) will be returned.
    .PARAMETER Filter
        Specify a filter.
        -Filter @{ 'name'='<value>' }
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetAuditStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetAuditStats -GetAll 
        Get all audit data.
    .EXAMPLE
        PS C:\>Invoke-NSGetAuditStats -name <string>
        Get audit object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetAuditStats -Filter @{ 'name'='<value>' }
        Get audit data with a filter.
    .NOTES
        File Name : Invoke-NSGetAuditStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/audit/audit/
    ...
    begin {
        Write-Verbose "Invoke-NSGetAuditStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                $query = @{ }
                Write-Verbose "Retrieving all audit objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type audit -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                Write-Verbose "Retrieving total count for audit objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type audit -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByArgument' ) {
                Write-Verbose "Retrieving audit objects by arguments"
                $arguments = @{ } 
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type audit -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving audit configuration for property ''"

            } else {
                Write-Verbose "Retrieving audit configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type audit -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetAuditStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB7ab+4KAscafxE
# aJxndc4BFYIQ52XV0cUZwS8dDThVHqCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQg/qdEYuneCk7p+81V2Lb/D8K0t9aJxD1w+Ds0tIWG+wUwDQYJ
# KoZIhvcNAQEBBQAEggEAeNLnxHttfOhfJoDChf0z86JhTq2lF8Mxi+KyCYWvmCVZ
# u2CaYCOb6x4u0H3ir4yT9cX7wUrDFxYlCID+hB7iMnI9SQjEZzbMY2wcDCIDYbZd
# r1gr2jGPwP9PDPUdPcq/um3zB2fVJG3ESPD4VB65eoY6d/bbHC/hOqTPW+/foZqj
# odmU4XjuZoZxp7vGDtwdgEGDeQ4pQ/3l8g59qUr8EAO+1Fq4GGK9p4k5MyeFvRVv
# aMjfM667jc36oTukq5JtKOOSIYS8nZxu5aAoyJx8FUVfB9SuBzQkPALsmy6j4CPQ
# hSXtMHo7nocKlh1edy5FZVlZJldEG6fv6OhCC37D1qGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ0MzRaMD8GCSqG
# SIb3DQEJBDEyBDCiXT0vtCMZLJP5f4vrPIDCg86xWKiC8VhWn7TuaO2DAoW+mhQN
# AUZZC9edV6t4PrIwDQYJKoZIhvcNAQEBBQAEggIAktqfG+W/IGCkA2w86UUMlI4Z
# LAOXFbSTzZChBUdQgzEQEm1H9pO2x+HGIY6omNk60Ml1b4W/OnyD69WH7zb7Hv1q
# bf3BYG3XrymiKGw84YPnOINXGt0unReTS1xEOI5iC9AqUoiuTaEPSmlN1ireENfG
# WaxOwhlaacATbskWtv+5sNoYL4kUdQ+iRp63ETfl2lqxUPzXszOk9ei7xHAAHGYo
# iLHUihAFRX6RhPqoArQEn+oCD7oUG2ReEGdcu4ujEktHliOjuOFeN8sagW1A1zDq
# s049QV5DKaC7ph0VKBk6RfQwb0Y2bSPNkFNz58tM4RYczSHeAe6ohufdzdPyzQKs
# G/urw6/B0DT60NgTpGsGlexcmFFjrYsxEEJUpJnK0K+2zMMQhnD6IRl6qnrFD0U/
# R2CyZ9hihBce1e5aPUzOwAuTnzkchpO2dRYHuyqo+gzx431EI+gB62808xh+KpbZ
# KFHzVIis0hJbbXrCgObTrVk2bz0hQis3NZu0WqCR+dFw5iCVKcWVyotOoAu8kWHm
# jgOElYw+m+RiRBF7vJe1j6LdnQ41vjpSuafoFoCY2AY13J0tCj4ZgoX33BADCGzo
# +NxjIenZ8OkVlwrQ1N5A/FhP2KvFvCHJxU4Wf0uuaNGCZhuGlJjYTW/S4xykQILT
# K//K7ksXPRdLm7Z2fE4=
