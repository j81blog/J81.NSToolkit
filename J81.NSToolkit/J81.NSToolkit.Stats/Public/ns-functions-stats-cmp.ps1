function Invoke-NSGetCmpStats {
    <#
    .SYNOPSIS
        Get Compression statistics. The system's feature for compressing HTTP responses to compression-aware browsers. stats object(s).
    .DESCRIPTION
        Statistics for cmp.
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetCmpStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetCmpStats -GetAll 
        Get all cmp data.
    .EXAMPLE
        PS C:\>Invoke-NSGetCmpStats -name <string>
        Get cmp object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetCmpStats -Filter @{ 'name'='<value>' }
        Get cmp data with a filter.
    .NOTES
        File Name : Invoke-NSGetCmpStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/cmp/cmp/
    ...
    begin {
        Write-Verbose "Invoke-NSGetCmpStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type cmp -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type cmp -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving cmp configuration for property ''"

            } else {
                Write-Verbose "Retrieving cmp configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type cmp -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetCmpStats: Ended"
    }
}

function Invoke-NSGetCmppolicyStats {
    <#
    .SYNOPSIS
        Get Compression statistics. The system's feature for compressing HTTP responses to compression-aware browsers. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetCmppolicyStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetCmppolicyStats -GetAll 
        Get all cmppolicy data.
    .EXAMPLE
        PS C:\>Invoke-NSGetCmppolicyStats -name <string>
        Get cmppolicy object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetCmppolicyStats -Filter @{ 'name'='<value>' }
        Get cmppolicy data with a filter.
    .NOTES
        File Name : Invoke-NSGetCmppolicyStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/cmp/cmppolicy/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetCmppolicyStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type cmppolicy -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type cmppolicy -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving cmppolicy configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type cmppolicy -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving cmppolicy configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type cmppolicy -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetCmppolicyStats: Ended"
    }
}

function Invoke-NSGetCmppolicylabelStats {
    <#
    .SYNOPSIS
        Get Compression statistics. The system's feature for compressing HTTP responses to compression-aware browsers. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetCmppolicylabelStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetCmppolicylabelStats -GetAll 
        Get all cmppolicylabel data.
    .EXAMPLE
        PS C:\>Invoke-NSGetCmppolicylabelStats -name <string>
        Get cmppolicylabel object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetCmppolicylabelStats -Filter @{ 'name'='<value>' }
        Get cmppolicylabel data with a filter.
    .NOTES
        File Name : Invoke-NSGetCmppolicylabelStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/cmp/cmppolicylabel/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetCmppolicylabelStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type cmppolicylabel -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type cmppolicylabel -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving cmppolicylabel configuration for property 'labelname'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type cmppolicylabel -NitroPath nitro/v1/stat -Resource $labelname -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving cmppolicylabel configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type cmppolicylabel -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetCmppolicylabelStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD/6DbHQ2M6eJBi
# Olv793hdTa8H6QvgTryMeyQyb6brHKCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIg