function Invoke-NSGetLldpStats {
    <#
    .SYNOPSIS
        Get Link Layer Discovery Protocol. stats object(s).
    .DESCRIPTION
        Statistics for lldp.
    .PARAMETER Ifnum 
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetLldpStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetLldpStats -GetAll 
        Get all lldp data.
    .EXAMPLE
        PS C:\>Invoke-NSGetLldpStats -name <string>
        Get lldp object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetLldpStats -Filter @{ 'name'='<value>' }
        Get lldp data with a filter.
    .NOTES
        File Name : Invoke-NSGetLldpStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/lldp/lldp/
    ...
    begin {
        Write-Verbose "Invoke-NSGetLldpStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type lldp -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type lldp -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving lldp configuration for property 'ifnum'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type lldp -NitroPath nitro/v1/stat -Resource $ifnum -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving lldp configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type lldp -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetLldpStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBYGh5sdFFOEn39
# OofffPEzhB56y60aAen1zPCKOgDrO6CCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgjGBMMj1WWd8XXdK9OrUaGsloRyG5Jm9oRCE8B6de5M0wDQYJ
# KoZIhvcNAQEBBQAEggEAgRH4YkTgC/TQrlkFMqxJbriLsA2OydXOG8hzrV1KzJ1O
# 92iujfpAom9/oCoTArQtWDX46Y5eKfSxk/+tmfiIMSJCAO4rFEdmWQ+PJhTm5D3+
# GNsW3Fnl2T56mvI6dK0671hpGkbgtyStxEm72fcWEW1CQ1cacN7Oan2uXjhqt41s
# XHrUaXCajOVWngFgJkD6hlPdQvgbEIL4Zb5AH5w+vGLM7aXLbdz0yULyKPFntW+b
# vrDRTe6+qgC51ktuvx80RzhErAd/A1s7QeHpcriYyMf9/kZ+fR4SRTNJ+3BSWhVx
# 2zISGczIpKFqK2L9r1OoMXduVIlLAEq4Al5KW1vm46GCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ1MzdaMD8GCSqG
# SIb3DQEJBDEyBDA6gEch1nF5I5cy3wAfxYaFVI5JC1ioOqLXpuxpQJ67MbGqrdRX
# hXmBMG7ZoxPW9bUwDQYJKoZIhvcNAQEBBQAEggIAhEgO2p89Cil/jbXTQ88icyel
# 3yOFmTAV6MSZolZHlQFVb0d5+VxG2cz9gP0jVojl4PeZMmrmrt6Tz4sjrQQSkyap
# ShJD9PLIFrhmBn31Eoe8h6nx+XiN8FelCbl6Ww7ZwgfXSAb/iCFingC6xAvrHgeo
# Bby921FtR+fhxeej1nSVnoB872ENe9UbDQSjf6N9DKYec3wuMZULEBM8aTkESE5s
# E8dqLkXCXq8f70/jKd9N+MxJIOI0gRxbXUYH4VWshIlg3bHk8PetjwZU7oopa183
# +dLiV9HG6xmTm7761Grrj0uimb7eJ62px6t6K4ThFaWqjeOzzdGvImc/puFcnzrK
# vDBGTvh45zMn6rQgASMhnd4T5QfXd9I3pusHEBIKkHN7bIsHQ2oRkKeGTGr6JKD3
# Wikr3AWWtK0wlvCC+KxfMVmNowwjBf3sYKQve4q+amgaD0Mmf4tF1vzTZTKiuYCr
# tJg+WYj6jOio1wgNvSB9dzwyAuDdkzzHEXJWxFcHpl0e34TCn5oZFYbPDswojacQ
# eUYA0Hm4ourutHPP0guPcC9fhuaOE6PyDVw2Oen9ZRmR08pV+WylfZDyXjtY1GSJ
# fRxDOfRe+Qe1MzVv1X3ovLt46tPpnNR8lH5nz5Q3d9uURABga10CPXRVRI1T2NGO
# 4MVgm0aMtP1PBu3Z9rM=
