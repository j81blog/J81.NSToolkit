function Invoke-NSGetProtocolhttpStats {
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetProtocolhttpStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetProtocolhttpStats -GetAll 
        Get all protocolhttp data.
    .EXAMPLE
        PS C:\>Invoke-NSGetProtocolhttpStats -name <string>
        Get protocolhttp object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetProtocolhttpStats -Filter @{ 'name'='<value>' }
        Get protocolhttp data with a filter.
    .NOTES
        File Name : Invoke-NSGetProtocolhttpStats
        Version   : v2311.2021
    ...
    begin {
        Write-Verbose "Invoke-NSGetProtocolhttpStats: Beginning"
    }
    process {
        try {
        ...
        Write-Verbose "Invoke-NSGetProtocolhttpStats: Ended"
    }
}
...
function Invoke-NSGetProtocolhttp2Stats {
    ...
    begin {
        Write-Verbose "Invoke-NSGetProtocolhttp2Stats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetProtocolhttp2Stats: Ended"
    }
}
...
function Invoke-NSGetProtocolhttp3Stats {
    ...
    begin {
        Write-Verbose "Invoke-NSGetProtocolhttp3Stats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetProtocolhttp3Stats: Ended"
    }
}
...
function Invoke-NSGetProtocolicmpStats {
    ...
    begin {
        Write-Verbose "Invoke-NSGetProtocolicmpStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetProtocolicmpStats: Ended"
    }
}
...
function Invoke-NSGetProtocolicmpv6Stats {
    ...
    begin {
        Write-Verbose "Invoke-NSGetProtocolicmpv6Stats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetProtocolicmpv6Stats: Ended"
    }
}
...
function Invoke-NSGetProtocolipStats {
    ...
    begin {
        Write-Verbose "Invoke-NSGetProtocolipStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetProtocolipStats: Ended"
    }
}
...
function Invoke-NSGetProtocolipv6Stats {
    ...
    begin {
        Write-Verbose "Invoke-NSGetProtocolipv6Stats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetProtocolipv6Stats: Ended"
    }
}
...
function Invoke-NSGetProtocolmptcpStats {
    ...
    begin {
        Write-Verbose "Invoke-NSGetProtocolmptcpStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetProtocolmptcpStats: Ended"
    }
}
...
function Invoke-NSGetProtocolquicStats {
    ...
    begin {
        Write-Verbose "Invoke-NSGetProtocolquicStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetProtocolquicStats: Ended"
    }
}
...
function Invoke-NSGetProtocoltcpStats {
    ...
    begin {
        Write-Verbose "Invoke-NSGetProtocoltcpStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetProtocoltcpStats: Ended"
    }
}
