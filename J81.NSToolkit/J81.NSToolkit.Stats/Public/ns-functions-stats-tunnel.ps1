function Invoke-NSGetTunneltrafficpolicyStats {
    <#
    .SYNOPSIS
        Get SSL VPN Tunnel statistics. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetTunneltrafficpolicyStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetTunneltrafficpolicyStats -GetAll 
        Get all tunneltrafficpolicy data.
    .EXAMPLE
        PS C:\>Invoke-NSGetTunneltrafficpolicyStats -name <string>
        Get tunneltrafficpolicy object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetTunneltrafficpolicyStats -Filter @{ 'name'='<value>' }
        Get tunneltrafficpolicy data with a filter.
    .NOTES
        File Name : Invoke-NSGetTunneltrafficpolicyStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/tunnel/tunneltrafficpolicy/
    ...
    begin {
        Write-Verbose "Invoke-NSGetTunneltrafficpolicyStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tunneltrafficpolicy -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tunneltrafficpolicy -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving tunneltrafficpolicy configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tunneltrafficpolicy -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving tunneltrafficpolicy configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tunneltrafficpolicy -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetTunneltrafficpolicyStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBVqdyF9qWh8rbs
# tvFkAl+VGD1D0WyMAC7M9K4efN/YVqCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQg3C1rNGbrjKi7VhEWXflXDQvyPhtskD3LAaVpI/xewoQwDQYJ
# KoZIhvcNAQEBBQAEggEALcEV/RqT4Rvxog0eNtVngM/sEZTi9ntU/Zn+LNT31kwV
# Xr6u0ImQfxJAs2IRC4tEC0eQQR0Ktm5QsuplpSvEfwJxWKxT38+cfwDN2/d+QROD
# Js/v7bYR+5zBP9PpHqHiZaeiUrTYy5WyHyjRscb6R19AFp+R5C+OTLEngLPKt+rE
# /veAS8fIPyrx1DI11RA9qX2aLB9I0XtspikvADwOIcqWqhSgJTHtzqcsfPEJT03U
# gji/IqQDIYR2rLJZ+8dJtPXbW0e1mnrto4PAE470qoiFiu+gnOQ+5wdHI166pVWp
# HbzRBTaOnkNWXvZBnytQKBsFjbC9KFfP6oc9bss/jqGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ2MjVaMD8GCSqG
# SIb3DQEJBDEyBDBjDpJeUKngbMttlWYPTKC+GZeR4qLTBwdNf7Ru8JSG62OnQYZU
# lrvmYwYeZo8M1FYwDQYJKoZIhvcNAQEBBQAEggIAd1nk47sJ8uEXgzh1wU2QNVZx
# cwiVxFPyqEhjytax5+K/zads6fADJ4XOM3oufJGrT8mZvAgtEo+S8LdHFBIFFb0C
# jAeH4QmPi/7SX+fjUjs1BL4NtfQD8U3DVWd0g7XhUu4/udk1VokJqI/rNWOSIevn
# MTKHjahDk1i7uu01HssSbvEOW2U0m51ACr4LoZ9xHndxsI0zar7cUJxdSEySmqP/
# zEpHd0YdkW0p3gB5Wxqncph/0r7WuGJmwmuBu/YWMh1NyRKy1n0EPn6Pu4ej0wC3
# mKCwRPR3dx+p1XmeftIe5jcwx15M1m61m42bVnclke/vcagztSBdixJ+yX5KvIGC
# NcHcreXUKK5PUxdTt1/lDRUSQrKXAlYXqK+v7G6cB2SpQ4xtx8gpnC+OjQy5mQhG
# jDsJ1ixNF8khXlM5YYh70ASIiwzKTRvQvRQt7gp2K6IIIF6b0Jkx7j4BzIvHIfh+
# 03TitCVWhAuSQW0iyaH+VNBsZUavCUyY5MnWcy0eXAA4ngJpPBY2ifuwYqYIEAdy
# 44FfXe7WoEZzYlaJlJhblOxraUSDeFb5H1hFjgG+K5lyMAyojhuyZnPsF23WXW3T
# QG7WD9nwOV3kR8XrEKSV478jBcuuWC4WpwYWQBdGM2aFpq9bt/HviUbJR94zpNL/
# E82pJSYCzmH1itmttQc=
