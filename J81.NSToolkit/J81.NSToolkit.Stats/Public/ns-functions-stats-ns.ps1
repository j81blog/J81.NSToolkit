function Invoke-NSGetNsStats {
    <#
    .SYNOPSIS
        Get System/Global level statistics. stats object(s).
    .DESCRIPTION
        Statistics for ns.
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetNsStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetNsStats -GetAll 
        Get all ns data.
    .EXAMPLE
        PS C:\>Invoke-NSGetNsStats -name <string>
        Get ns object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetNsStats -Filter @{ 'name'='<value>' }
        Get ns data with a filter.
    .NOTES
        File Name : Invoke-NSGetNsStats
        Version   : v2311.2021
    ...
    begin {
        Write-Verbose "Invoke-NSGetNsStats: Beginning"
    }
    process {
        try {
        ...
        Write-Verbose "Invoke-NSGetNsStats: Ended"
    }
}

function Invoke-NSGetNsaclStats {
    <#
    .SYNOPSIS
        Get System/Global level statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetNsaclStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetNsaclStats -GetAll 
        Get all nsacl data.
    .EXAMPLE
        PS C:\>Invoke-NSGetNsaclStats -name <string>
        Get nsacl object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetNsaclStats -Filter @{ 'name'='<value>' }
        Get nsacl data with a filter.
    .NOTES
        File Name : Invoke-NSGetNsaclStats
        Version   : v2311.2021
        Author    : John Billekens
    ...
    begin {
        Write-Verbose "Invoke-NSGetNsaclStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetNsaclStats: Ended"
    }
}

function Invoke-NSGetNsacl6Stats {
    <#
    .SYNOPSIS
        Get System/Global level statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetNsacl6Stats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetNsacl6Stats -GetAll 
        Get all nsacl6 data.
    .EXAMPLE
        PS C:\>Invoke-NSGetNsacl6Stats -name <string>
        Get nsacl6 object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetNsacl6Stats -Filter @{ 'name'='<value>' }
        Get nsacl6 data with a filter.
    .NOTES
        File Name : Invoke-NSGetNsacl6Stats
        Version   : v2311.2021
        Author    : John Billekens
    ...
    begin {
        Write-Verbose "Invoke-NSGetNsacl6Stats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetNsacl6Stats: Ended"
    }
}

function Invoke-NSGetNslimitidentifierStats {
    <#
    .SYNOPSIS
        Get System/Global level statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetNslimitidentifierStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetNslimitidentifierStats -GetAll 
        Get all nslimitidentifier data.
    .EXAMPLE
        PS C:\>Invoke-NSGetNslimitidentifierStats -name <string>
        Get nslimitidentifier object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetNslimitidentifierStats -Filter @{ 'name'='<value>' }
        Get nslimitidentifier data with a filter.
    .NOTES
        File Name : Invoke-NSGetNslimitidentifierStats
        Version   : v2311.2021
        Author    : John Billekens
    ...
    begin {
        Write-Verbose "Invoke-NSGetNslimitidentifierStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetNslimitidentifierStats: Ended"
    }
}

function Invoke-NSGetNsmemoryStats {
    <#
    .SYNOPSIS
        Get System/Global level statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetNsmemoryStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetNsmemoryStats -GetAll 
        Get all nsmemory data.
    .EXAMPLE
        PS C:\>Invoke-NSGetNsmemoryStats -name <string>
        Get nsmemory object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetNsmemoryStats -Filter @{ 'name'='<value>' }
        Get nsmemory data with a filter.
    .NOTES
        File Name : Invoke-NSGetNsmemoryStats
        Version   : v2311.2021
        Author    : John Billekens
    ...
    begin {
        Write-Verbose "Invoke-NSGetNsmemoryStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetNsmemoryStats: Ended"
    }
}

function Invoke-NSGetNspartitionStats {
    <#
    .SYNOPSIS
        Get System/Global level statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetNspartitionStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetNspartitionStats -GetAll 
        Get all nspartition data.
    .EXAMPLE
        PS C:\>Invoke-NSGetNspartitionStats -name <string>
        Get nspartition object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetNspartitionStats -Filter @{ 'name'='<value>' }
        Get nspartition data with a filter.
    .NOTES
        File Name : Invoke-NSGetNspartitionStats
        Version   : v2311.2021
        Author    : John Billekens
    ...
    begin {
        Write-Verbose "Invoke-NSGetNspartitionStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetNspartitionStats: Ended"
    }
}

function Invoke-NSGetNspbrStats {
    <#
    .SYNOPSIS
        Get System/Global level statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetNspbrStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetNspbrStats -GetAll 
        Get all nspbr data.
    .EXAMPLE
        PS C:\>Invoke-NSGetNspbrStats -name <string>
        Get nspbr object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetNspbrStats -Filter @{ 'name'='<value>' }
        Get nspbr data with a filter.
    .NOTES
        File Name : Invoke-NSGetNspbrStats
        Version   : v2311.2021
        Author    : John Billekens
    ...
    begin {
        Write-Verbose "Invoke-NSGetNspbrStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetNspbrStats: Ended"
    }
}

function Invoke-NSGetNspbr6Stats {
    <#
    .SYNOPSIS
        Get System/Global level statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetNspbr6Stats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetNspbr6Stats -GetAll 
        Get all nspbr6 data.
    .EXAMPLE
        PS C:\>Invoke-NSGetNspbr6Stats -name <string>
        Get nspbr6 object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetNspbr6Stats -Filter @{ 'name'='<value>' }
        Get nspbr6 data with a filter.
    .NOTES
        File Name : Invoke-NSGetNspbr6Stats
        Version   : v2311.2021
        Author    : John Billekens
    ...
    begin {
        Write-Verbose "Invoke-NSGetNspbr6Stats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetNspbr6Stats: Ended"
    }
}

function Invoke-NSGetNssimpleaclStats {
    <#
    .SYNOPSIS
        Get System/Global level statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetNssimpleaclStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetNssimpleaclStats -GetAll 
        Get all nssimpleacl data.
    .EXAMPLE
        PS C:\>Invoke-NSGetNssimpleaclStats -name <string>
        Get nssimpleacl object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetNssimpleaclStats -Filter @{ 'name'='<value>' }
        Get nssimpleacl data with a filter.
    .NOTES
        File Name : Invoke-NSGetNssimpleaclStats
        Version   : v2311.2021
        Author    : John Billekens
    ...
    begin {
        Write-Verbose "Invoke-NSGetNssimpleaclStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetNssimpleaclStats: Ended"
    }
}

function Invoke-NSGetNssimpleacl6Stats {
    <#
    .SYNOPSIS
        Get System/Global level statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetNssimpleacl6Stats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetNssimpleacl6Stats -GetAll 
        Get all nssimpleacl6 data.
    .EXAMPLE
        PS C:\>Invoke-NSGetNssimpleacl6Stats -name <string>
        Get nssimpleacl6 object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetNssimpleacl6Stats -Filter @{ 'name'='<value>' }
        Get nssimpleacl6 data with a filter.
    .NOTES
        File Name : Invoke-NSGetNssimpleacl6Stats
        Version   : v2311.2021
        Author    : John Billekens
    ...
    begin {
        Write-Verbose "Invoke-NSGetNssimpleacl6Stats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetNssimpleacl6Stats: Ended"
    }
}

function Invoke-NSGetNstrafficdomainStats {
    <#
    .SYNOPSIS
        Get System/Global level statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetNstrafficdomainStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetNstrafficdomainStats -GetAll 
        Get all nstrafficdomain data.
    .EXAMPLE
        PS C:\>Invoke-NSGetNstrafficdomainStats -name <string>
        Get nstrafficdomain object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetNstrafficdomainStats -Filter @{ 'name'='<value>' }
        Get nstrafficdomain data with a filter.
    .NOTES
        File Name : Invoke-NSGetNstrafficdomainStats
        Version   : v2311.2021
        Author    : John Billekens
    ...
    begin {
        Write-Verbose "Invoke-NSGetNstrafficdomainStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
        ...
        Write-Verbose "Invoke-NSGetNstrafficdomainStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDw4oVkhd/Atf69
# PZZCXfFlFEHyU36CRw7YY1uPihVsGaCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgM5wf3h9jN/4M3lodNDBu6clfRi/ciJDgJh+67ggLXvswDQYJ
# KoZIhvcNAQEBBQAEggEAFVw98ja97hbYdPXdlh9bNpwceAcBgl3S6whK078Q6zls
# 3CI+l3OwSWDkRKktg4Y4Em6Fa4hmGXMZzk1DeECg2lGKrT6NrIbUbLAUeYtiw4Nl
# 7TNbsxGkFE28GmO4IPvix4muLLymRvzv6XGg3kd5l1RcU94HOFqQPCaExAP2sycl
# Rg6DC7lyuflDiHVMt/yLGSdJBMIILrWIA1bOTxjBwvPjlucxBWTBNo0qEcDBukzD
# XZmgbVk7m95Eaaf5MG/7VywEnK6yYPo1YH1tFFy98kGMM3cipCEBV0j+2mg6L3BF
# zEuH97krfcxbE68+iDCXPAguHxuTfbEEknAqEoyCPqGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ1NDZaMD8GCSqG
# SIb3DQEJBDEyBDDQMJNnxP33Pswi8PdJxPqhA9zbKV64SXjEqwPsRPM81oS6Ncs8
# orKdW1lj0KZaUSkwDQYJKoZIhvcNAQEBBQAEggIAAZCb2D6srqvv2D+gaOZ24zFd
# wRiMcipichqQ5Ww5tV91ygKkCF/KTUo2JrnNvmnfTzRuax8qvG2u0bLBHhtNqs49
# f1K+LwzPaGOwdFKmPRRuv/Y8yHI/RU7baEehJxW6oCd6JInMfQOqsPHEjB7jY1dO
# /PzzrgfoT1D6RamUYTuX2cGWOPR4jJBrCS5b6GtdLpfg/SHi8lhQgjtgULWZ6JPq
# HcnwppAeLlkt4azELvlJCWjPB+78JbY6bX/iIjkbsrS3Lgj9Qz8o1sDM2CGhcgFR
# a9ovyAioeq++dqANMY/D9J3jE1Zg1VEuuYRXCLlcyGJJbipqmF5P46Bb7esQ8kj2
# 4gvUbhN2Dh8Z6a14Hazohy9zmnkCKgzRqcxy3NkNLsCEzDNMMhN3k+NXtYO/V1nF
# in8JNvYgOCT6iNPW6sfJmgXav8vQJg04L+/Y5/LuskSO2kAb0WEuAaeWs89JuwU8
# W1L3or/ANNHSro7ync7LGktGqfnPKVJ8ZCoNbHSbpMIhdgjDKu+Y4Pie1o3t+kyl
# ZR4DJFM8zWihmpn7KrUdj2gKHby6PmeYCs4RAlPYPnEaDdTy0k0iKOrpTYhJR+/y
# tNbU2p0tNaHAHiJuqpUNfXnw5G5re0BHcv0FZjxTAf1vpMzhm5o/ZbkH1gXP4nKz
# OcSQS0elwCD0VIZ4WqU=
