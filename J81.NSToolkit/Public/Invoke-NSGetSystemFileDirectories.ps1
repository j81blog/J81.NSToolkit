function Invoke-NSGetSystemFileDirectories {
    <#
    .SYNOPSIS
    ...
    .DESCRIPTION
        Return all (unique) directories within a given directory
    .PARAMETER NSSession
        Result from Connect-NSNode
    .PARAMETER FileLocation
        Directory path
        Example: "/nsconfig/ssl"
    .EXAMPLE
        PS C:\>Invoke-NSGetSystemFileDirectories -FileLocation "/nsconfig/ssl"
        Get the systemfile directories
    .NOTES
        File Name : Invoke-NSGetSystemFileDirectories
        Version   : v2204.1122
    ...
    begin {
        Write-Verbose "Invoke-NSGetSystemFileDirectories: Starting"
    }
    process {
        Write-Output "$FileLocation"
        try {
            Write-Verbose "Checking `"$FileLocation`" for sub directories."
            $dirs = Invoke-NSGetSystemfile -filelocation $FileLocation -NSSession $NSSession | Expand-NSResult | Where-Object { $_.filemode -eq "DIRECTORY" } | ForEach-Object { "$($_.filelocation)/$($_.filename)" }
        } catch { 
            $dirs = $null 
        }
        if ($dirs.count -gt 0) {
            Write-Output ($dirs | ForEach-Object { Invoke-NSGetSystemFileDirectories -FileLocation $_ -NSSession $NSSession })
        }
    }
    end {
        Write-Verbose "Invoke-NSGetSystemFileDirectories: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCXoHAG7uPJAUBX
# LCSwRyjBxfBSnABrmRsJVAZZmTmItqCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgn+5kESL2QjHSf9CBDelw6m+BPtVKrgsVZcPv/4kGFSswDQYJ
# KoZIhvcNAQEBBQAEggEAi0xYhx/ooCGozd2BeWDXfNYhBdjv0AqDASZtY3eaiKdO
# eD2PC30NxEJ8N2m9OltwpzhFSaBWmOVwAX8sD7E5dqc7rFpCO0XQmaNukqij0NmM
# +hcrcxmI/vcQ0Ysi18kBeMGPkfBvwN0t6jCKUzi3gS8HR0jU+GtjRDczXvNAXkO7
# 3XETSwc2t01XQ41vFMTpVotutiPMoJ4e0GHaqH6F/LgXEG0qxTf/QXN+Gn9q3260
# 0l4B211HUBfPdtc1UZ8p3exQ+Z4oa6EfhApQyxctNIa0hC0DI3l9aroGXvNhUr38
# qSsK+91FUdUNS2s1Qd9H7g/n0qdMZC1/bqXEhTD+paGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMTYyMDU4MjJaMD8GCSqG
# SIb3DQEJBDEyBDB0ishafRBuzY4R0Yl9daE8wd1kjF1d5CCtxvhpwS6AzY0zGXAQ
# T38KegTGHbmtEMIwDQYJKoZIhvcNAQEBBQAEggIAg35G2nijgKL5sTq1ZSqOE80D
# 7/jwIQFDv1prYVn+bYb7p4I0BZq9PFnOpCkyuriCxtWPDio01UqkHoyd3Ev6Y8eq
# 3+XwYxart0R3LryZPX87aLAnXDv35yH6/IxwpUDAl4dDrIwgYSa3xc1zQuZ/ojw3
# q8jUOTd9nKnFNvftQmSmJAJLQaC/6tdRfeBfIHNFqpVdmZKLy/ywyV2uZIkrSMNg
# HWEGLgQFx0yZeoQSlZVh6aY02QuzTr0lKDn32RoClmW2bR2cGZod8YNHfRWNatou
# BiO0o1E8vaR2GvXzu0AP7Jo+1ivkv8v8bt4yubly7pyJS5qvRH9MGTD+nbNou7Ml
# lnOlvjU8Xv4dtyKsYYT/0SCV1aMh1y4ICLZaAmeCSdXOvJdaJoGivTsDo+bk5jBv
# h4/bRSi9sD+FbF39MUIXpAEpiS0HckH4wtktB7U6fZODOR8v4mgsl1ZuaPS0FLTn
# p9x+KXvx4EjXNO8T3DJ81a6X698oHYrPIAXOkWtf6xbTfqsJbuZB6FabXE6RwGK5
# 1EIY5/EjgVVcOOPuddWlfKwsiYHHStFaXA4Utv2XTaF1BBNI7nCunRbxvBi3F+jI
# FzaE1cOsCfMtSKywV+S2qqsUkRBzYJZOSOgxB7YJreHhsBy3WDRY43Brz2E3F2h5
# DOIpbfEEhs+QeBqnbPU=
