function Invoke-NSGetVideooptimization {
    <#
    .SYNOPSIS
        Get Video optimization feature is used to show (i) the stats of different media types that are being served by the Citrix ADC and (ii) the details of optimization applied on ABR videos stat object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetVideooptimization
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetVideooptimization -GetAll 
        Get all videooptimization data.
    .EXAMPLE
        PS C:\>Invoke-NSGetVideooptimization -name <string>
        Get videooptimization object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetVideooptimization -Filter @{ 'name'='<value>' }
        Get videooptimization data with a filter.
    .NOTES
        File Name : Invoke-NSGetVideooptimization
        Version   : v2311.1622
    ...
    begin {
        Write-Verbose "Invoke-NSGetVideooptimization: Beginning"
    }
    process {
        try {
        ...
        Write-Verbose "Invoke-NSGetVideooptimization: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCXi60OeQFHF+Pm
# moRsq2BY4LzT8gHvJo6fJBXu7OtHKqCCEHUwggTzMIID26ADAgECAhAsJ03zZBC0
...
# IgQg40prx+8liopL7W34zOW1+NjK3u2gjywBLYoG0qeAwdcwDQYJKoZIhvcNAQEB
# BQAEggEAFk58uPZMLgDincYiSc1y6EZPYkV1MayrrtLt4rHgzSfUb0XOz1ptQhzF
# X6OkLtIDgYHb+zihU3vIez5ro1y55EnAt+xMMHY6etE7okuaXA1aYfvKg4TkEW/h
# Ai5TnQOpv1T+gBDLcCUUW2jigJ/oL/ttlU4sPfo5GjKMdSF6Yhu4Uibu4bUg2Jeb
# roWOeZCdnstREsHREUEuWEVnU5rXXB+AteWlhTEoBStNIb+GPMgEUlnQHEZMT1gx
# bWC+Vv+pLIqIrbRwsZGzqONEt9o22DTLNXxBDwYGC729C98hdXpO2NaIopZs9KzH
# 8wRyVJhfe5X1Rdd50UtUmdb4t6bu3w==
