function Invoke-NSGetContentinspection {
    <#
    .SYNOPSIS
        Get Content Inspection stat object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetContentinspection
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetContentinspection -GetAll 
        Get all contentinspection data.
    .EXAMPLE
        PS C:\>Invoke-NSGetContentinspection -name <string>
        Get contentinspection object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetContentinspection -Filter @{ 'name'='<value>' }
        Get contentinspection data with a filter.
    .NOTES
        File Name : Invoke-NSGetContentinspection
        Version   : v2311.1622
    ...
    begin {
        Write-Verbose "Invoke-NSGetContentinspection: Beginning"
    }
    process {
        try {
        ...
        Write-Verbose "Invoke-NSGetContentinspection: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBgKNeVg8lcWuwx
# hVgATHcl1ty6xkebvEieZkM4iiPDV6CCEHUwggTzMIID26ADAgECAhAsJ03zZBC0
...
# IgQg67t62WWlThCBNdVTeYqhFjXPfucfqluWqpqNRp4oRK0wDQYJKoZIhvcNAQEB
# BQAEggEAAuqEccUn1YMwQfA3BBjoLl3HNbRWO7/paipNrWUNj+h9dOrWzB2JsSpy
# 3iaWZjC787SRHtJCjCf9VENc3d4Q9FdjTJ6JS21a2bGq/dK0uq+CqJ2KZWk6rv/X
# DEwbHk4Dk5HTXRrfmpW75we8cX6sQCVFgmPdy3EF0U8UgugJb0F0VSb9erD1k63m
# dQ76wnGSLxNqqhZf8R51SRrZ+j+Jh7qDIduTfj7vW5iWEEWKTUvvlTQav6XX60n2
# 5njiqNc0bQAq8YcKYiMrLHaKBNradXxwB2VjSYFUR7AneDYaiwoLhihBS34KaHY1
# z3rWm2elQ0szu72PF1jLlOsBYLuzgA==
