function Invoke-NSGetAuthenticationloginschemapolicy {
    <#
    .SYNOPSIS
        Get Authentication statistics. stat object(s).
    .DESCRIPTION
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBwiBpI3NJYeVOS
# Zq/qVodeRq/Ms4kAgGjQI6i0q1+nEqCCEHUwggTzMIID26ADAgECAhAsJ03zZBC0
...
# IgQgG+es5WYhxqLKOESoV/VUklkeBrdXP1kpWt2BDgzlzQcwDQYJKoZIhvcNAQEB
# BQAEggEAMYF0SoxLMgSiBoi8dG6M5TYRfrHIMfefz7nvfArHcKABY04j5QGiADro
# aKVJSRSeFtokN3ck7lndecLBEMAo1Xt1+OIT+t4dyDA1/drVdlGQVMuCEQxd3aOs
# 3BhZQTvgIBy2+6Vgl+Lh34rJ9cXhxQYAz/mZheYlka+8xM2LLf2xPV8p64YMXT5l
# 0tNtMS2KvsrmnbGIJjAm5tWrS3mEEIUWy4dGCT7K3/IzXB2HEDmtFIi60sS28as8
# OmI8vwCyhRdKVIp+afADylBO9PXFOavIDjGEaJVtO833pAfZafdy4Eg663xppwPu
# O6RHKmfKLZnm6ev6y2lp0EJmR9xM3w==
