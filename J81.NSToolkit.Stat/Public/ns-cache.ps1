function Invoke-NSGetCache {
    <#
    .SYNOPSIS
        Get Integrated Caching statistics. The Integrated Caching feature is used to cache static and dynamic web application data. stat object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetCache
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetCache -GetAll 
        Get all cache data.
    .EXAMPLE
        PS C:\>Invoke-NSGetCache -name <string>
        Get cache object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetCache -Filter @{ 'name'='<value>' }
        Get cache data with a filter.
    .NOTES
        File Name : Invoke-NSGetCache
        Version   : v2311.1622
    ...
    begin {
        Write-Verbose "Invoke-NSGetCache: Beginning"
    }
    process {
        try {
        ...
        Write-Verbose "Invoke-NSGetCache: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAURfpkNvrqiFxd
# RC2yiwmc4L7QlBkbrEL4DoMivVFrfqCCEHUwggTzMIID26ADAgECAhAsJ03zZBC0
...
# IgQgF2hEhHjEWQYwbIMRc7ej9sdnt5FqJlukPQwO7Xs2edswDQYJKoZIhvcNAQEB
# BQAEggEAio2q4L+VHawv0NgLRKcn0Zf50/8X/n4ynPBRy1aZTeXjZS0Nc54rn7Db
# mXSEE/CWYYcWZlI9yeO9Ie4QHEUtArRGJeMoRgn3MQx0gCcI3hf/ZL/Nmn5k0Rpz
# ubWp5EL+mPf+gGQZm+6VZm1wxFscL/i7FRWrYKiWuPuMRh9k3RbOHsjf2+i71q45
# T4g08nWp/jTS66jps3CpWw9q846w9SxzL9J+1z2b0vIxZc6nG1hjFVx8eDK7nYDQ
# RPPhW7mpOF+wQcKBqYvrWXPkLDvi3YMajijJ8bpAp8BDkk184k34IBpQUb068uAL
# CB0/QgVg/zh0+GvM8cPKT60nC1+Tnw==
