function Invoke-NSGetAppfw {
    <#
    .SYNOPSIS
        Get Application Firewall statistics. stat object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetAppfw
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetAppfw -GetAll 
        Get all appfw data.
    .EXAMPLE
        PS C:\>Invoke-NSGetAppfw -name <string>
        Get appfw object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetAppfw -Filter @{ 'name'='<value>' }
        Get appfw data with a filter.
    .NOTES
        File Name : Invoke-NSGetAppfw
        Version   : v2311.1622
    ...
    begin {
        Write-Verbose "Invoke-NSGetAppfw: Beginning"
    }
    process {
        try {
        ...
        Write-Verbose "Invoke-NSGetAppfw: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCRBSqo+kr6UqCn
# qBciQqZsIjfF/mimHaoZx29P41ct76CCEHUwggTzMIID26ADAgECAhAsJ03zZBC0
...
# IgQgSS3R4AM1M1x+vNis4nJh+0q11xTX0euhDjA96XTZx10wDQYJKoZIhvcNAQEB
# BQAEggEAQ0OKJeuNVAjg3fTn5V7LmYgDYGKxOXJu4NdMURH0CCwkXmSuGa8rqSx/
# mOyOn7LHRO61aBRDwEXrIO7DlQHYufboxzVH11MbjAIH7bOz0UAwI93cfzquvuhJ
# nSaNSnWF8drnM8ug/CFlTxueY/1TY+PCN4JdnXYL2dyN3UFxrVRmkKHgKdKN1jQ6
# psKXZthCBs3UFNsvWzGsxWVVZMeZhkuX8Uh1d27R+RWafcatpy0YlO3aWFfb5/M3
# Mxf89juAotu71e0MYYrkJcvkP7Hy78EKegQei0Ni/i+f9d9HSZM7lFj+tiP4x79T
# EK2Y2fOEAakZd1mdGu8fPgEmtXzQiQ==
