function Invoke-NSGetIpseccounters {
    <#
    .SYNOPSIS
        Get IPSEC statistics. stat object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetIpseccounters
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetIpseccounters -GetAll 
        Get all ipseccounters data.
    .EXAMPLE
        PS C:\>Invoke-NSGetIpseccounters -name <string>
        Get ipseccounters object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetIpseccounters -Filter @{ 'name'='<value>' }
        Get ipseccounters data with a filter.
    .NOTES
        File Name : Invoke-NSGetIpseccounters
        Version   : v2311.1622
    ...
    begin {
        Write-Verbose "Invoke-NSGetIpseccounters: Beginning"
    }
    process {
        try {
        ...
        Write-Verbose "Invoke-NSGetIpseccounters: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAjO745rk++j8Bg
# yaWfpcr5vRH05cwWG/tRZSOw0bz3N6CCEHUwggTzMIID26ADAgECAhAsJ03zZBC0
...
# IgQgNnrb25XPn5nOJiWrlICMSJVwjdrf9J0+SI2KjS596dEwDQYJKoZIhvcNAQEB
# BQAEggEAnT53Y2yBNWAhKCG2OmdgLH+hF5Zgr/aTYO8rP1UGyT1U3+045oXgUboX
# hIH6AKfDOsAU4zIzJxGT/IqOE6k8ZUdv1aaSzdkmglaZzpRIuH0NhwKdvcxDcTre
# TL0udR2rr8KjUnC6xzhWzSvJd5aHK/rj1cKPA0/XU0C/k5V0ZYoI69oO6pi2qTMS
# bIhGuMa8EgmaMGsQywYgLTXbf8oTrSyg9/rhDFh2CxvhKj9ONeLAT1UWlkezOFP4
# fU74LqQu5g9b0sfomy3JV1nxieuS5hFVZVLHLQTFo0AOFvnHcutJhCyK9wEq0rlr
# YR3CZB7HAzNbrnFFD17SzCylcF7k9w==
