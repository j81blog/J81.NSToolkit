function ConvertFrom-NSVersion {
    <#
    .SYNOPSIS
        Extract and convert version info from Connect-NSNode result
    .DESCRIPTION
        Extract and convert version info from Connect-NSNode result
    .PARAMETER ADCSession
        Result from Connect-NSNode
    .EXAMPLE
        $NSSession = Connect-NSNode -ManagementURL https://netscaler.domain.local -Credential (Get-Credential)
        $version = $NSSession | ConvertFrom-NSVersion
    .NOTES
        File Name : ConvertFrom-NSVersion
        Version   : v2204.1122
    ...
    begin {
        Write-Verbose "ConvertFrom-NSVersion: Starting"
    }
    Process {
        try {
            if (-Not ($NSSession.Version -is [Version])) {
                $RawVersion = Select-String -InputObject $NSSession.Version -Pattern '[0-9]+\.[0-9]+' -AllMatches
                Write-Output ([Version]"$($RawVersion.Matches[0].Value).$($RawVersion.Matches[1].Value)")
            } else {
                Write-Output ($NSSession.Version)
            }
        } catch {
        ...
        Write-Verbose "ConvertFrom-NSVersion: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDPrPjYDIiA+j5a
# eckN6Cy20IsnuIT1z/+qAC+op0qFVKCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQghkOTly56wHvCQ3ccskNaADlTC3nxV4w/hvPTzV8MwdEwDQYJ
# KoZIhvcNAQEBBQAEggEAPG9Uj66x3kWpUlgyDeQK174ffhiBsv4EHsxACA8fCFp3
# CmUf6Z9OwbFYqa0noqpOKcSC9+xUACJJK08otXxYn0QE/Cd1H6IRL24hDTl/7vvs
# oFUDuycgYyDYk+sjex2aVX+OYgIMpspqz1SMTqKpFuYmFl6FlGgwD+ZrcXsU7soo
# SgoYea6zKD0v1KhRn3QNcHNMgW52C/ZOc+rVAUipECI5lpyx6V1D0XZVni5ttusr
# ypywgPJBVL/XkcuDsP5Hz1CGS9x67AanX8quHOs9UTnm2GXkTa6+a76auvIyK8YM
# tBORLaW5PtvIPVLjQ32SIWX+euBYdrZPmEO3Dc/J5KGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMTYyMDU4MzRaMD8GCSqG
# SIb3DQEJBDEyBDCljenvOO3mBQ1o3tJugTFn1QPlq4Nsa4Fa9CPNMd1HZE1UpZk2
# 2wwHpfXySzc0/vowDQYJKoZIhvcNAQEBBQAEggIAMqv6hPy4SG2cmm+9ooyxl1Ca
# s7rJ/Ah83a8XXconCoLDYFw5Xn7bjIDZriQZVOntS97cfwozFGuy3kT8KmJg1Yv7
# PMzq2E/Tgvl3o1CsIEXbaA7zrYvLFI+R9n63CCGbEExr+SLr8giCGgIkQN8+z15j
# FJqWs4hcTiKInePLtPQuZnXyQTxLaP2A66wV6+5GavgP8xie7Qh3/v5WTWSIJJ/l
# GQnaGPMS0E0b5fZWt2Gwf9GlPqTJgG7ImUyBEmkSktxt8ZyWsdNuP1pJjrixCoFp
# v+V841jqvIbGE4/IuAYZIs/OZP5/web9Dn2Ba9Lkq2MGabQg0aLa6GKGO9S3zKtu
# DzI9iu3oqs0bO2dh7qpgM7V43V/Nr0hx4jcK3+9hv6vA6kbUrNaU3fVDHhVg707D
# u4f0QRGeij060Bnk+awtizAw6cQl7BqNpmRjmwx3UD+Gql47wMpUVubgYWZRK8cp
# zX7p5YFSnf3UNpOIcZvtD+BM1Mh0lBwLmT+EfIXGkMlRyXPhCgR8IuV77PBrhb2x
# 9yfA+IXqc/Tq1AhlLmiJXHRlGCc529EiA7Fq8UOlKA7a7A5amqUDaIH6q+pH4Iqj
# 36RL0vYgxYf8LI6NpVbQ4mzvGkwnSlXSS+K7MFLUki2gSMUyh/GNK02ujsAyUbK0
# rVPi7KAVwQ/FmWRu5tc=
