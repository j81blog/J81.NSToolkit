function Invoke-NSGetFeoStats {
    <#
    .SYNOPSIS
        Get Front end optimization statistics. The system's feature to optimize Web content for performance. stats object(s).
    .DESCRIPTION
        Statistics for feo.
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetFeoStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetFeoStats -GetAll 
        Get all feo data.
    .EXAMPLE
        PS C:\>Invoke-NSGetFeoStats -name <string>
        Get feo object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetFeoStats -Filter @{ 'name'='<value>' }
        Get feo data with a filter.
    .NOTES
        File Name : Invoke-NSGetFeoStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/feo/feo/
    ...
    begin {
        Write-Verbose "Invoke-NSGetFeoStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type feo -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type feo -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving feo configuration for property ''"

            } else {
                Write-Verbose "Retrieving feo configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type feo -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetFeoStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCEJZG/AZliHYzR
# nM6TWCvk9v/vu81QV3wLoCtf5NuSEqCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgGOQ3+5EiO2Vw3kv9H1j9VBnieAz+cv2fs+TtdVWMryAwDQYJ
# KoZIhvcNAQEBBQAEggEAKQCWPGs9oH3Kn84QMLUYmk10oZ4hKzZYwsX8pDzyxrI1
# 2ZDMcPQCRQe5mRqaj9NA6JhLoSUIoyxAB8j91R3Nm0YIZu+/fOdy95jZbczVqHnL
# 71Ljtge6GyE04OIeCGnhZq6p2fMOuuUvtceDrFtjxfrJUZIKLT0XXx/77xowDRVg
# HT/D8fVxvPYpe4upABWlRNzpR94hvHDYRTGVGD3rLHro3j+a4OmAZwOZ/ZL3nhnG
# kmCSsiUR1IwRfiy1qY4ymR0A4Rp5ToL51jJhEpQW0QvF7GgShG6LEhBi4MgD551Z
# wncd/EolzSY8gofDnOpVJj3qWeK4ubpnOedEBaA1IKGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ1MTZaMD8GCSqG
# SIb3DQEJBDEyBDCleOuoj67Vx2tG5cdAL03GQ+y798Fs0ff6/r/m6p8xl3coN536
# 03hBkuhzaNsVxjQwDQYJKoZIhvcNAQEBBQAEggIAXr5VQBus6tm0uLyCcV54bb9q
# qpKo8smB8Wsr2kOrziGBbBNHNx74e/QkGxAYPIGLOFu2NAg7M6tvashNwMjnLUxX
# lhrW7do3MMYg12+4ALuNKd+kweJEjhMMViXm+81oU6O01s8wQMHv8Ddj5+SnTLRY
# ZyTTnjMXXf1YU9JEUvMg1t1tZolms8jhuVOLNwEneQnYTFFoQ/sXH3kCuaLalVTc
# ZJO75XEKcn0XgTl3JIebsQ4VbsKfxdqC2jZhY5ObA7oBFtEeratPzZNH2mYXehK9
# 2gr6DZaiBZVdHYyHMlJhKYSkeWIJYaGd+HhAiJRSead8b7yu+r2BA69YEv7Z07Z/
# of+HzzmtxzZ1fWflwUEp/nYeZBX/mOX+CktRqdPWVBTUcGYdHvA+8Zm9hwW5G5YA
# 8XgbOK1UkaC6LOQ2zutAqZez4YYAIC53TxpPpNx8jJpvG/vbQILx1eiASqP12zIG
# BLQ7+UmawBl3Nz/24+2bUWWDZcfc2yQo2gBezApIfzRoTfZOca9ul10eA+olQZUT
# i36EmpYrnV1Htqi77ZDSzSYVqLvDZX3jJh0B14N9+mk/aqJlmZOLEmXk5ZGzFthB
# IQWBup2AWqPVrgc3x1yZ4pBl/l1fjVrFQT4wg81zC8rhnMhLR9sKlsHqqXuh8BqQ
# a3HXojoNAHRVY2UF3hk=
