function Invoke-NSGetClusterinstanceStats {
    <#
    .SYNOPSIS
        Get Cluster commands. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetClusterinstanceStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetClusterinstanceStats -GetAll 
        Get all clusterinstance data.
    .EXAMPLE
        PS C:\>Invoke-NSGetClusterinstanceStats -name <string>
        Get clusterinstance object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetClusterinstanceStats -Filter @{ 'name'='<value>' }
        Get clusterinstance data with a filter.
    .NOTES
        File Name : Invoke-NSGetClusterinstanceStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/cluster/clusterinstance/
    ...
    begin {
        Write-Verbose "Invoke-NSGetClusterinstanceStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type clusterinstance -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type clusterinstance -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving clusterinstance configuration for property 'clid'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type clusterinstance -NitroPath nitro/v1/stat -Resource $clid -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving clusterinstance configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type clusterinstance -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetClusterinstanceStats: Ended"
    }
}

function Invoke-NSGetClusternodeStats {
    <#
    .SYNOPSIS
        Get Cluster commands. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetClusternodeStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetClusternodeStats -GetAll 
        Get all clusternode data.
    .EXAMPLE
        PS C:\>Invoke-NSGetClusternodeStats -name <string>
        Get clusternode object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetClusternodeStats -Filter @{ 'name'='<value>' }
        Get clusternode data with a filter.
    .NOTES
        File Name : Invoke-NSGetClusternodeStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/cluster/clusternode/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetClusternodeStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type clusternode -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type clusternode -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving clusternode configuration for property 'nodeid'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type clusternode -NitroPath nitro/v1/stat -Resource $nodeid -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving clusternode configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type clusternode -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetClusternodeStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAehfQr9rZDqnwO
# o1mmToHXfIdTEY1qBUgDfzZIepZkf6CCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgfhRw0ju/OyzVbd2bEJOGlB+eoNDErJ6x6UncxQGKHQcwDQYJ
# KoZIhvcNAQEBBQAEggEAKX2cBcFi9/z/A0TBAtqQTZ4fYpoXl5LhLXtWbnPIYZVM
# Ww9ybeRadtV6OJVPWLngTlboKEcgcaK8zHCrM4eMVKU2zilmQ6eQRM7bcbd6El9X
# 8sFzd4AVhaKpgmrMibZGtgw96A/I7GSJgfx2hwAGee4qZzUhkTL8sVIE+1JEx3y4
# 97dkE76ynqv5iSI7M0dijv04XeE653+ML9N735tiEzSeL5zojBpd7AvM15tLFXvs
# mjoP/5DQb+3Olzl130S1JUcweCvmmi/nCvHrb0Pugu1aZ2KzR2FcJ/PM1LqKR9I5
# ZfiEZLP3QHGBDOvnZPrR7xLqwpDyF9yNu8ZGoMcZbaGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ0NThaMD8GCSqG
# SIb3DQEJBDEyBDAdcJ9XT3uvUQTzZkvX4wSjQZBEy8StGl5KWH5TvVamzrXuZQXC
# ngy1wDVhVfa8E1swDQYJKoZIhvcNAQEBBQAEggIAdcQVlYBVGAYdtpelw5NG0b66
# y3nqNil2JYPyxmzmVEOeZxpJnrrDipKkMtyvHXwJDgVnUmUO0Libiz9VNm48Wl4u
# pw2EdSyWX+KlLICt8M8CBeTDDXu+nGQLp6hQoHCrLCJgseHWbovrMIQFdVVGtcXF
# IK7hoKIc7mbJ37QynI2wzMMf98CF8Hgza8Mvnd6hVRCdSLBLwVKfwVEf4+TrCUUj
# YbiPQi//LaOngb3e+ZQ4yCnLD/8Hp+GVmpKb4i723IZ4DY/PH1NzVzOYm1XwM7mj
# 7oFXowncQG8tDWsKrnvu5CeIrgRp5mUdaZk0DwLPEh/28PC89YoyDbEi9F7ncH/6
# SDQ94/+b8da0imctW9E1Y+F3ESnUiCfq4Ilbg26W536OyuHP+0psVLZkxfz3n+KD
# PQN1b7ucTosczNuuzTFhxcDs21EyPycxmVPEXXBOlhio8HIRSQ7jiVeCnlGPKEXH
# 3wNKNPwur2oVTMTisCRmZme+PgmLOvk2kpmAvztnHJviHNYnBjI1YUpd1aR6aCLn
# by6WCujFWsIi6cNU0cuNNOtQ4TOLbGbSEwA3WmM4Ixd6eOW6W5QwVAjInu4oGVop
# NERpw84Znz51PVxsZWzDPR3C6Hi4bkMWY7JBJ6aaryIrY5JTjOD9zMz55HRGFqyh
# VAfud5g2AA1vXoX701s=
