function Invoke-NSGetTmsessionpolicyStats {
    <#
    .SYNOPSIS
        Get TM session/policy statistics. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetTmsessionpolicyStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetTmsessionpolicyStats -GetAll 
        Get all tmsessionpolicy data.
    .EXAMPLE
        PS C:\>Invoke-NSGetTmsessionpolicyStats -name <string>
        Get tmsessionpolicy object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetTmsessionpolicyStats -Filter @{ 'name'='<value>' }
        Get tmsessionpolicy data with a filter.
    .NOTES
        File Name : Invoke-NSGetTmsessionpolicyStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/tm/tmsessionpolicy/
    ...
    begin {
        Write-Verbose "Invoke-NSGetTmsessionpolicyStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tmsessionpolicy -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tmsessionpolicy -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving tmsessionpolicy configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tmsessionpolicy -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving tmsessionpolicy configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tmsessionpolicy -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetTmsessionpolicyStats: Ended"
    }
}

function Invoke-NSGetTmtrafficpolicyStats {
    <#
    .SYNOPSIS
        Get TM session/policy statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetTmtrafficpolicyStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetTmtrafficpolicyStats -GetAll 
        Get all tmtrafficpolicy data.
    .EXAMPLE
        PS C:\>Invoke-NSGetTmtrafficpolicyStats -name <string>
        Get tmtrafficpolicy object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetTmtrafficpolicyStats -Filter @{ 'name'='<value>' }
        Get tmtrafficpolicy data with a filter.
    .NOTES
        File Name : Invoke-NSGetTmtrafficpolicyStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/tm/tmtrafficpolicy/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetTmtrafficpolicyStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tmtrafficpolicy -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tmtrafficpolicy -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving tmtrafficpolicy configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tmtrafficpolicy -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving tmtrafficpolicy configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type tmtrafficpolicy -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetTmtrafficpolicyStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBEwbI1HHObRv/M
# 7u4vQhxudbEI/ZBiH9C6/+Q1Xf/r1aCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgGzwe+MsAo4Iw0yick+iyimkqpifklvit0x68C7/h2eUwDQYJ
# KoZIhvcNAQEBBQAEggEADeb8Yj7Jh+D1OIMVUMv0XB1QK8reXkBw2GWEj0MnZskU
# NxwamUYwhsk4ofF6JWFYWLFIa4MszkfxD+P0BHkjLwzizmD+fl3+ZEYCzwHDmrvp
# AjkZt5U9ewGEzR4xUlnI6VbZtz7jle/O0Og4hPFEUFbH3PSM4JfSyhbxkUsgynSh
# yN7uHOE353vSIPTzwmeWI1yTf+AoEBs2qlKIyOh3kr/5C2ynlZcIo0cQGT8DgoTd
# ZBXuxSD2j0iWWUTzV+YWBIiKvkbqH5XI5tJezIw8K9AVjzKiTNPEQyF29WEmd3fS
# TZX4fB2P53geVxAQMxwbPidIEAhOYsgGXFZdSrb9R6GCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ2MTlaMD8GCSqG
# SIb3DQEJBDEyBDB22uH498+CjiHv9C12+oZQlmmjuWbvBJswPeLJsYycAnh7NPlx
# goab74LxcmcfHIcwDQYJKoZIhvcNAQEBBQAEggIAWJGZcT6PiQZXAkxdBDAjiy1u
# iCtyg/PJPH7E+pSpfyDsRYL+vT7NlQAk2S4ih8yQCrK1j8WO9mVKfJnnTTBCAIPA
# b5NqL3wtFIVQKUhLT3/cvmIjeoUIMf/6uX4yPr1rkWnbZ+wF83GcBWNWIaJorLRN
# n7ZaI4rzMuOrZKPT/SwIbTROyfLUnWt7GdU0eYf5hQvIwNVXahi4X3GT2D9SwnGx
# iVOdot+C/TzjM/Cnl+kdMqyd7uspXOYaglGCytolnUNplVNQCjy6JixV5kRzEQKi
# CZ7qd0taFgQ6llEwMQwR6fPuyAFruvcvVqbdmr6o+EHv6HRaLl5YSCgCIACsUZ/m
# isD50nQkjmoyeBC5ahcuwFhDl9BRAeENRbGzKkN+Iik+dltaFRqzxAymwM9F2OL7
# Bxp+9TyH6Z//7IvPnWOG5K1lMSDctWPPHqJ4FDmV9LrxZ0WJ4DgewBD3WizyQsTr
# R66jhDdvLQdS7Od43xIByAR7rQvgXqZI8CPABZYKw4zJKPqCwO9ZxqoTVIWKHuld
# Ab/DFCgzvx0ae2dhUXuw5zODVOyad7y6hXEyNIWT80i+I/guuiwYvDy1FJBfHEMr
# af440Te7XeTSbIJuhac4kbitXMq05L7hIwyc9neWaeREdFoIgcT+k2FM0q4melFz
# XFybgR3/F2xRiJ/6FgQ=
