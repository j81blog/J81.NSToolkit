function Invoke-NSGetIcapolicyStats {
    <#
    .SYNOPSIS
        Get ICA statistics. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetIcapolicyStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetIcapolicyStats -GetAll 
        Get all icapolicy data.
    .EXAMPLE
        PS C:\>Invoke-NSGetIcapolicyStats -name <string>
        Get icapolicy object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetIcapolicyStats -Filter @{ 'name'='<value>' }
        Get icapolicy data with a filter.
    .NOTES
        File Name : Invoke-NSGetIcapolicyStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/ica/icapolicy/
    ...
    begin {
        Write-Verbose "Invoke-NSGetIcapolicyStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type icapolicy -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type icapolicy -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving icapolicy configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type icapolicy -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving icapolicy configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type icapolicy -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetIcapolicyStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDefMe3uXdJACB7
# pjsWH1x2d59sAWLep6rrmV65n3ABWaCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgiB5q9or4bEcgbnDxxUoCEh65zKYV7FwvhMH7/IZbq4gwDQYJ
# KoZIhvcNAQEBBQAEggEAZXQp4LJM4jLawjkqNn58nYlgbr5j/Ay9BMPzE4AxxpYN
# j/NME3KjPmuCpEwTh6P+BIhOx94twvSUqjYH/6HlDXb3wAVZaQSa/PHBy6nBMFGs
# IkdjRrXQ4glETXzvxvi74Pn0UhmgDRFVa7ZUAeL1HXHLUwTSLd+Jq8y/Bxs/+X1u
# gBcV1HaPeoF1BQZSt65ld1yODH+udm9epMjnrBGQ2n94ttT2ba2rEo2k5fog3wFR
# mCHaYIKUWCU53qYjp0Nyg4sOqwi8SzZ/2QCGm/zl00EUVmvr3yHWEAvaoxTE5n+V
# kLrkVKI5JcS6nUdCXa7uAlnqlf4A+lan0XcRLd4L/aGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ1MjVaMD8GCSqG
# SIb3DQEJBDEyBDD7hkrtcCLzmSNmiEERlrDTLGMQDSOSHHm1KaE1wTvHuaWbuKi1
# pJBmI5WFootVhU4wDQYJKoZIhvcNAQEBBQAEggIAK7WPo68KeRLBqf6l0+eBAoFD
# uqU76QDb8JCUvoJLc7csBVcdN9jrgb164/t68547741V36S0DcfoQhhtpQFqYWk4
# Nb7VT3cXAnZcw8uD2eofz4qC0qN/Hfc2cYLqwXf/QdWX3ehJZO+D79QmExfp4VCU
# 28ou6pYcLd96pvuW90JOx2Cj8lNekoLDQEadRHmZunQzsCPkdHqeRgju3ATGscZj
# wKsBoVwwOPQ/6fHUgbpHhv9dlv5tHzuf27XGh7HVzUJxVpkanwiaPvXfAhtbn6NB
# eyKakoP3vtr0ysXBlNUGihtoQMO6sc2aazHjHVv6TB5yFIcWKkUReBPo0JWep2wQ
# GHiYM6jkZ3unTECuTWPDW9SyUJPF92f9l34ew2O0jCs1GPQajoBva+2DVGX0lfsf
# 5yE280AJS6T+j5waFzyzA52IU7PJK7BZc6fNXAqi4zZmuNPtVUBsKctWh3OAsk8a
# TMdVjTbJ8kMA9IeGiPJNkbB7FB1cItE9XBC72l6G3BrEXaf4010hFkNN/VINF5tI
# BzggCe8xMQ8Pv8Md+mmp1iZubUZI885WluxqQAUn4OR6N5msQuXd6TXIEXeLThht
# OCKiPW3RZARoHRJWR9wGYHEUD0mQ1kpADb8iX6VdHwb8WzO/Jjvl5sPt+VBE+l0o
# rSEWcl/uxqAJDdLloN4=
