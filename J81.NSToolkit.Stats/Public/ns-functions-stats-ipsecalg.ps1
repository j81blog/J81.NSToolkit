function Invoke-NSGetIpsecalgcountersStats {
    <#
    .SYNOPSIS
        Get IPSECALG statistics. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetIpsecalgcountersStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetIpsecalgcountersStats -GetAll 
        Get all ipsecalgcounters data.
    .EXAMPLE
        PS C:\>Invoke-NSGetIpsecalgcountersStats -name <string>
        Get ipsecalgcounters object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetIpsecalgcountersStats -Filter @{ 'name'='<value>' }
        Get ipsecalgcounters data with a filter.
    .NOTES
        File Name : Invoke-NSGetIpsecalgcountersStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/ipsecalg/ipsecalgcounters/
    ...
    begin {
        Write-Verbose "Invoke-NSGetIpsecalgcountersStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ipsecalgcounters -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ipsecalgcounters -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving ipsecalgcounters configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ipsecalgcounters -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving ipsecalgcounters configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ipsecalgcounters -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetIpsecalgcountersStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAbub5m1iBAxEhy
# YNHUdKDVNpUL8audFxjyp/oj9DPeRaCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgrhuCdoXIMAGboxkkj4hxjyKhmh9hCPza6YYjysf+w2gwDQYJ
# KoZIhvcNAQEBBQAEggEAoVHn1rpjckkwdLRpFGHoiFmE/47shjnnSYdQm/3QAg0j
# rdEvkEExt6I5vd8LR8MOz/2lyfzfnxbLgGX42sfbkcGdnc7VMQ+gcK2/wVZ9vaw6
# ECYffEQW7XGIyioOIE8lYUMNGa1l7h2qr6yeq/lzJBDmXlg/t/U/u8q+hfKwy2vZ
# Ib9U1zLmQFwBRxKh9B8PzggVV1kh6BCdw6xDWta8t6wKCWKIdqEPQe6j/AGOuYgv
# TO4cec+GZzIg075nV3sJ0cgjDfSADRAH4fynqfbH+IrWa0cGS8Jzrhl0E7QUafEG
# nquwfNroa1VQmV/weYRFjcZJSJ7zx8AlKsezi9XtD6GCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ1MzFaMD8GCSqG
# SIb3DQEJBDEyBDCMAJHi3RaIxrBLAO7NFnD/mZxOd1gbirURY05qhphl9TGhfNy6
# JFIVaKVxer5j/YIwDQYJKoZIhvcNAQEBBQAEggIAMBZNPWn5y+T2XzcGPUGEXamA
# HlEBT/vYdlmumsTlwCaEkkqBqp49n9Zzxm5DU/GUM9ldj7FN9Qmk9LQm0j27pkjr
# Qrh9HMUZYqaHl9aNEAjS8fodtSbXPj7zWb+ax/xuchPgJ0Y52Hugx+Q7pqXcmG/p
# kWr0bbnyCUHEKkkWkWLQmYgCCFFHZpq1S+6GG2gEq3inYY1zvOVjrcC9i41qGirr
# eU4G8udiUDW3vZxoT1Ldp9BuAAqWsRVYOq3FDsw8uCj/xa1DsdbOXhNQrMXgvmgT
# vdgsby+u0dnGIdQmMXgjJZYC0QYasYl1t6Hi4ztUMFar2+ggIJ/u3zhixS6UgV5s
# lVSvrYsO+C4HIIGDcDLWIeZMAKdlrNtFVb+wmKm3OF9+RvvY60opDQCuqqOFuJdJ
# SVq+wV7YcdLX8bXSWDa8DInKWx0zgCzslGCbeFPdwsp63xVR7NIozBVvGy4ROoQD
# eJ6eb5hCD/utpvIA5n1P2qZEzZSNQWw7DqGVo6vcqmUqnaMGqBvsI0JVXsqATeRW
# yFMZZ2KwPZCRog9EUwGN+uMFavIxa5DHdsHnagtt2x2ej/AwG3khrt39jwCM29uM
# yaAZZBx/clm6v9xgpw2X5OYnvM+jCs6c7PylEO3r4AJovoAk4DdLcBErD0Wzn4g9
# K3TFBVc9TKrinYDweU8=
