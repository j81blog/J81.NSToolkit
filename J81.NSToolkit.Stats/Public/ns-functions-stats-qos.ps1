function Invoke-NSGetQosStats {
    <#
    .SYNOPSIS
        Get QoS statistics. stats object(s).
    .DESCRIPTION
        Statistics for qos.
    .PARAMETER Name 
        . 
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetQosStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetQosStats -GetAll 
        Get all qos data.
    .EXAMPLE
        PS C:\>Invoke-NSGetQosStats -name <string>
        Get qos object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetQosStats -Filter @{ 'name'='<value>' }
        Get qos data with a filter.
    .NOTES
        File Name : Invoke-NSGetQosStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/qos/qos/
    ...
    begin {
        Write-Verbose "Invoke-NSGetQosStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type qos -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type qos -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving qos configuration for property ''"

            } else {
                Write-Verbose "Retrieving qos configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type qos -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetQosStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCUbhqeVN1K1YSw
# clqOHS8ZFa6oEmDQL3VyGXZPdij5caCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgW0xAerrbdcFCziNO/q26V/Ij7a25V29P3I2VZj1unV4wDQYJ
# KoZIhvcNAQEBBQAEggEADYQ5hmftagYZq4T2Nn3UuLdYIdABPNR9IPmkhRx7M9Rc
# E97gkipLLEG+Oaw6c4v1/YPxL6nhP7RkvbO2D9sqiW1CfBVv5M75Ke2bzpYNjsk7
# KaoCm6j7KbtZQCMWi0rcaqlhT5TuAelCc9TWJEbIRnhKVSRnPEtaGb8sdpnxzuU2
# /mXimQJLL6X1W7mDN0A9Ua0yZo3PG4Bf+mw0tuuoc6bqr00J7HVJ129Imz65c0SY
# g9vfrHcxAh+JbXvyFHupkVUZpRW6fFKS6bWCwYo//TqjPP955V//iv2fjDV6tB5b
# IyRQr+7pd66DWExB1e3XeFdWncgtOYjXhQBN26Z1IqGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ1NTVaMD8GCSqG
# SIb3DQEJBDEyBDBbJZfNv3HAuilPNCw2arW+lkF0YtYql7ehnyjQRIPKIhE044Wi
# D1qRE2FyfqJzQj4wDQYJKoZIhvcNAQEBBQAEggIAW3Brvv9wfNOt2dKCeoGbNAkQ
# 5m2zRHGnrMSWo9mE/ZpUa+6Ekrpz4SY6e16Inj0L5Vacf1/mtn1ykaajemG4WaVP
# SuBzyQaLxA3UsfkxU3L3n40c9qJ1uLnZCdv5QYZiNs9M5SfhHKSDSwTv4ErcQMpm
# TxEovLYOFFkvqaa9lir1HeCVCyaK5iBJ0oB0zLbfimjoI9ZxwR1y2IE06OlbVDiK
# ekj5wKTpOn61e6DOCPYEV/OalOvt/fVVzTKNOFUiLcbCXb99a0XkB6apGYgW3AOD
# PsVOSeLY8FjxFbRf1uoHnMSKoHIcI4sZtstDifc1iZ4hcrPpFxSVg6jQXyPxqbVV
# PT3/drDyfCXhwPYdhNKjTo3yeU9S/ky3HNo6pCwfe0F4Q5fX2ehbJNL7NEF5ibhe
# DvOVE0+A68JeW3tBEc6bYVyTgqf/j8UKrWBiWaF5FSOKYITWxbqRkGxACP/d4HnB
# Ya1d9xQEZviw11MmcZqgJzVqy+VnB/6+OV/jC+4VFdEVLPNzPrm2s3Y7ruiSlrAo
# AV0fRHrULp2a3KDLhFAH5hlTW3AgvBqL3zFPhFXcBgwYl3XfHaDI1qzxbvUziQ8Z
# YllKnmyG2ACxZyWDBDJCtzrk4eE4kVj/oZEbJqi4RYdKe6UWf7Ms43z55JTCFBBM
# kr805F68A6vcnQEViKI=
