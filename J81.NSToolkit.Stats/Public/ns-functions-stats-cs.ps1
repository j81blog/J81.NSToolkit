function Invoke-NSGetCsvserverStats {
    <#
    .SYNOPSIS
        Get Content Switching statistics. Content Switching feature that enables you to direct traffic to servers on the basis of content. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetCsvserverStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetCsvserverStats -GetAll 
        Get all csvserver data.
    .EXAMPLE
        PS C:\>Invoke-NSGetCsvserverStats -name <string>
        Get csvserver object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetCsvserverStats -Filter @{ 'name'='<value>' }
        Get csvserver data with a filter.
    .NOTES
        File Name : Invoke-NSGetCsvserverStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/cs/csvserver/
    ...
    begin {
        Write-Verbose "Invoke-NSGetCsvserverStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type csvserver -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type csvserver -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving csvserver configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type csvserver -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving csvserver configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type csvserver -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetCsvserverStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAfPBiFXb8eUfAw
# H189pOG3jBmYe8CI+xm7HOOK7NrCzKCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgpcJTuohnQFkOxDfFV3aiI7SnGf3MFl6UtQBlhDipFLAwDQYJ
# KoZIhvcNAQEBBQAEggEAVX8OERY9Ff2EQ5JMzY0lTQSgUv6zqSEur2XV8gg0AW7y
# 9vgUz8MVV2E+mnA4krRumaxC283OwU2f2uGYxEb0rMwcNG/W0D+kD8uch5454iqF
# fjHbUGeWvc5EHcPg4vH22U1QJYvh1MlbU6mQGZ+WwaWCAkSO5mWoUupejpAdd6SR
# AeI2Y4pASMRZGw4CRiUbVjVmGsxusFeFCsiwZN83STldOKdbxmuypS84x6jl+b1a
# 87TYafqLdObVeMufKsFVP23bCGICIPIa9uyuAHCHYUIHu0Q5E54ouDgZrSUFIzkH
# KNqpZA8s/2X/34BaeALUvmItBWWMHb1qT3RfTVTGi6GCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ1MTBaMD8GCSqG
# SIb3DQEJBDEyBDAd0eCTeatnLdkkZQyEYNTK5VLAxyxOdsb7wK9qCwAW+hvpAAqp
# XFmhjHhoNJIatXAwDQYJKoZIhvcNAQEBBQAEggIAlHhaaPXhx+LVYm8aD5XY9/YQ
# xawDfHtcC+rsZM1WmauAwtOUpah6pYfDA/wEk5YUu68RaYmhmMSw9TEVAi2eGF/k
# uuWiyWE5tfb2uyXBe3nDHGdRezbP4VTDkZljlOwksXgH1gPl3LCAcZYHo66jDNTF
# u50wsNBGXY/pp9/1QPD4zVO9TzKYB+zzI2867HEb2zFGdEsmSvsJsWfGqonyhFjO
# Wjvx47MnPaznfEopgEUtnECNUa5jI/A4K69vtsslGhwu1rq5q2SPwKEGFcJeKeJ0
# x27ttI6Zz7I+ENjFimC6k5P1468W7vUSqLubZIcXw3XmlJERkug4427z6bbg5+Cg
# pKbYeSJLiS8eKgXGgatYYIT6fSaKoJ82Ff61/pGAspSkYmUEo09xCwGfwQeTVPiE
# Nu0fqhy67O0fadU6QLFciITv031ModX6RkxFyHFPDJBIxr5DAxKTxvolvdHDisC4
# bnIFbx3pdLPdeqK7o2tU6X6GHvHUivla1UCGlAn1fYv3nsbFQZrxTwloBOoDagx1
# OXOSjDVizgcjxzOKupxI6OqdmAzLcXgZ+0sWBopRSL9JcfO7YkESAERHm2cN75DG
# we9+ZjmSzvPhcchhN8Cu+rMCJtbRVaIW/yE32ZX8ACDAV21v1yJWja89p8lkwuRY
# 6TXq+msQPrapHEphAw8=
