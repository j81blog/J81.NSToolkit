function Invoke-NSGetUservserverStats {
    <#
    .SYNOPSIS
        Get User protocol statistics. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetUservserverStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetUservserverStats -GetAll 
        Get all uservserver data.
    .EXAMPLE
        PS C:\>Invoke-NSGetUservserverStats -name <string>
        Get uservserver object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetUservserverStats -Filter @{ 'name'='<value>' }
        Get uservserver data with a filter.
    .NOTES
        File Name : Invoke-NSGetUservserverStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/user/uservserver/
    ...
    begin {
        Write-Verbose "Invoke-NSGetUservserverStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type uservserver -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type uservserver -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving uservserver configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type uservserver -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving uservserver configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type uservserver -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetUservserverStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBUafJoLNzQEFXi
# wzCjHlu1nBXTKoEsn9zK14GeAZcKDqCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQg1qR3adc+aNHAmR+3n6M3W41DnRdHgFOgTwngsBSZjyYwDQYJ
# KoZIhvcNAQEBBQAEggEAL6gRr9m1skrIi+UH7nGoQxzRXkeTs4+igf8OHu/lHstO
# lgPgdjHA7VRvcdVETmopRXpzMPd/ey2KVI67oyIsFyCii7lSOtgUaHOF39/4m+J8
# h84MlRGQ5CKQ+bo+a0lUSMQyBWDdULpXMrKtBcB+f7tIYC0bZ2WQHE7/c1WFOASx
# EnSSJ2vxvbzWwcGhGWQx8sDfQFTiSGOZ49en8jRf6xUFxzCDO0gAibuDKRFbtIrk
# nxCBIWTTh/yb0vWLTu6YeOcBKXUyN9fdd88jmKht8iKxEGjQyByrC2/moYfPYF5/
# Vo/TFGeDSzwC76kdFWC5V6PC59j2R3xYcDVAaLRxsaGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ2MjhaMD8GCSqG
# SIb3DQEJBDEyBDAb5pas5giDkC1TSBDUhgW4kIrRfQ0SJ9EZA4UFMxyei076UGuu
# +PZGTlQFGmSFZy8wDQYJKoZIhvcNAQEBBQAEggIAfj5EVyj08/yDyHnYGltt1JzN
# cDvzutHtB0wETaS0ZBXdhTvkgj0ItjHyNaTRiFKx1oeQM023n4Be85gdtOEcbNs5
# nuWdsBSnhyhRZmh1IH+uW8ApZMZaeAcMYehGOz8tog+aNCfwt1Q8fB5zwN+1sc5H
# M3nM5m63XXQK+hTn75F5uyc95RzsLZJf0Cpa25gnzXgj697HYB9VZMeb/YS+2SDv
# aYjMlk4opcCvcY5JAuUp3+Mdjs3keiW7MDyzMrPr8f4kuztXE5Z7Oj4H3ALDdA36
# rcnvXsctaWPUcm/ZMf9sPgDfX/HoCBWKI+KRui8XhwsDIlvulPTmGUyiOEQaANVx
# Jlz6HdsG9stm2V5Al6pwaqb/wkWIheHirqs3KElKQGx39b3HVtehoZVlSCmUzRql
# Nd5W67qW0vYgLXoDwhQ6obyHbThFnIKiOiK3dNe6MHOOEGhbQ07O7sSPuBzB+SkJ
# bwpBobbEYz+Jgy/hbDv9RPmmnjof2LNz1pZUYI6Mm8vZCKDJ2ddjJygL40p/cElM
# ySMWO2GEOdqlgPKPgJ2oYnPdS8QJZMEovEXsgu59ltqx4XUkDBPE4EQHyStMyXNB
# gcTbn/gSl2u/7xMND98V673FxExyzc/2uiA/SOftogawMRRW9Y4ktqLK1lWa2V7V
# B/v2lLMsidjX6J0Q5Gk=
