function Invoke-NSGetAaaStats {
    <#
    .SYNOPSIS
        Get Authentication, authorization, and accounting service statistics. stats object(s).
    .DESCRIPTION
        Statistics for aaa.
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetAaaStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetAaaStats -GetAll 
        Get all aaa data.
    .EXAMPLE
        PS C:\>Invoke-NSGetAaaStats -name <string>
        Get aaa object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetAaaStats -Filter @{ 'name'='<value>' }
        Get aaa data with a filter.
    .NOTES
        File Name : Invoke-NSGetAaaStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/aaa/aaa/
    ...
    begin {
        Write-Verbose "Invoke-NSGetAaaStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type aaa -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type aaa -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving aaa configuration for property ''"

            } else {
                Write-Verbose "Retrieving aaa configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type aaa -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetAaaStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCK1Nj9KS3zHeKt
# 97bMLDB4tQD6DXUE7btB6uf/jQR0AqCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgL6Fiq7B4RGw+tenzk8Vov3GN+b2ug73+MxDc0jfzSIcwDQYJ
# KoZIhvcNAQEBBQAEggEAj5PHpy/awL5+MKKRUqx2ptvVC64o9aHmWowtNVQqr+HB
# BVFfM7WbpY/HltP/Se8WGMMFzU47A1TW7FBkjU20xtdhb74lNtrWEPb7al8IRJiW
# 4CjaL4bGBk/x7siWzOYybZj+m3aPc0B8yvR1sD1P5i3gE1kVfscME4MK96cLeGAF
# ph5hp55YGBF+rtsOng8hdeWK01ELN07qBF7ybZDt44T2xkvctYqgspyTTczxQYiA
# aI8MfgHa+Zt/H/SHk9Fjl/wzvBpVq6SNVA5S5eeroewqfnKAcysoBoTzjiOu3Xxt
# NFYn0NCyHVFmDQCjQg9ExRUqYB7oiueGTM/MRYjKaqGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ0MjJaMD8GCSqG
# SIb3DQEJBDEyBDAXG8GAZ3OuVNcf/0c6HyYRPpHV8C2/nCCwL2HtRsY/+Fc10CWB
# ZogR9qQWQ7baUTowDQYJKoZIhvcNAQEBBQAEggIAH5JcdQ0UkAEz7GHq//ONnwxz
# BkFW47kbioWuQYoy8BpyAjijzvTpasB8YJu/UOxfzKbVzO47npy/KtZx714uZp4D
# kAxF31GwAMm8Wff+7f5MD+dk1LOVC7X6j+PXHImD4E+gxnti+RGbAP3aEGm668+/
# MgWEd7AkmO4v1AhOfbuiRoCZGGc5fc+6cB88bx4lTxof7NoANzgCkayFWMa5o8vk
# zBrY293wxHlj9UNbx5rgD25/qE/+8T0RKBRvW8DN2WkAO8iB1QoNSWBYf0C+jBFx
# 4jUybhxzi1ARO6i6vnIurHvhOmTEgl/7eEx+VjHtr6LbmWTPjAhwsn+82FKSh5T2
# pcSaiSOmEVh73SwtglgwpymrImMj1jEMz9UYgShvUdy83KWfKyIKBZVpkvstIquG
# sFhaHdG3LCYEEjrzG+Y4/rPRns7fb6tRMdGyyUwf3e0EnIeiY8nlqo9Lhx9a5jM9
# GegZOvd3wqv84wgbsAJabCy3g0T53Yxvoeb8cM0FGWsribKzgOAYea+DC5jG6wjy
# 2c/vJaT6rREmcWtt03T/fdX2lqeqxDOwiZDGCD9GIe+lxeUDi9lxqLJOQI7VZn1b
# ynu9aQ79ej0zjGpzAczgrpiFuRoDIFW7YSaAoPyEpprkj3RQBp4lRyd88xVpjVyn
# giWlJukUeJ2JjxUhwCU=
