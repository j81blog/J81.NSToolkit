function Invoke-NSGetSslStats {
    <#
    .SYNOPSIS
        Get SSL statistics stats object(s).
    .DESCRIPTION
        Statistics for ssl.
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetSslStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSslStats -GetAll 
        Get all ssl data.
    .EXAMPLE
        PS C:\>Invoke-NSGetSslStats -name <string>
        Get ssl object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSslStats -Filter @{ 'name'='<value>' }
        Get ssl data with a filter.
    .NOTES
        File Name : Invoke-NSGetSslStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/ssl/ssl/
    ...
    begin {
        Write-Verbose "Invoke-NSGetSslStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ssl -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ssl -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving ssl configuration for property ''"

            } else {
                Write-Verbose "Retrieving ssl configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type ssl -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetSslStats: Ended"
    }
}

function Invoke-NSGetSslvserverStats {
    <#
    .SYNOPSIS
        Get SSL statistics stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetSslvserverStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSslvserverStats -GetAll 
        Get all sslvserver data.
    .EXAMPLE
        PS C:\>Invoke-NSGetSslvserverStats -name <string>
        Get sslvserver object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSslvserverStats -Filter @{ 'name'='<value>' }
        Get sslvserver data with a filter.
    .NOTES
        File Name : Invoke-NSGetSslvserverStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/ssl/sslvserver/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetSslvserverStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type sslvserver -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type sslvserver -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving sslvserver configuration for property 'vservername'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type sslvserver -NitroPath nitro/v1/stat -Resource $vservername -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving sslvserver configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type sslvserver -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetSslvserverStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDHY+MN3rZKdJ6F
# HmTchml3DefyIohCx26p8VDAx/k4ZqCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgYqVHnfUIJUl5F6uy1jLZpSsU8Im5DVOuzM/iv6hF9kswDQYJ
# KoZIhvcNAQEBBQAEggEAPsW8qhX8gB8qwYFitoY4lc1hGWhXZjan4RgiJkKl4h2u
# H3UtDe8a7SROKtUa+eYtAWj8ZlmOS7DGu2CyTq7cchmGXjA915E44He1Qrtkwy7b
# W1coxYPr9N0U/Zvw+oMN4OlsxcsL/ghAeeYR8lrxPegGkzUBSSw0IONp97ZaYFcA
# D/sJ2cG6F4rBL9q53PWKkyOsFkkDsRLaLc3utSWGZXmCuLhu5yaQtbFjUfM7Cp2d
# GhQfLOiUCg5laPMPvSiZd1qcsQMU68S1oBPlAXsWodZBV4cnetEbo7myDXkVdskV
# oqgw794YhZ/EH6aeZJSlbK7sUhY5iYmh7UIV/wR5hqGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ2MTBaMD8GCSqG
# SIb3DQEJBDEyBDD4Ki5igmaghV8oQK55FXVcZAoJ/Qs/NBMpZz+QPVnM8dJBx6Nh
# n/E+k+V5bIP9J58wDQYJKoZIhvcNAQEBBQAEggIAHuteHaJsWyZoZKRRlYVPl4pT
# ENtChkdlpf1gAhvzWHTHOGrrjguU6rzpf732ysvwrjREAQVUfZ2gCDL820UZWsOe
# rEcAkqTDE0i6O42O85uo9JA+yDNPUcCuU5jATGxtJBrkJh9In2+u0xKZm9QItSH2
# WaM3yoRyriwFMOpq9MVwoQilqjugyu+TY7dA4qrfivgp9QWpKveUCLv7KzP7nrfO
# 85paPloMXMZHcvZ+3fW5SRWLNehnY64OPzO6MJXF5YMXWzzWdZ4g8SFtl9NJ7g67
# sw1p/ByT63Xswfj80ctJeamhezu6b/3HGqKNVt9SuWKSwCYzVGfSFpzgYwfJF3Wa
# +iCHv0y3B7G9atiPzkoLZX2JD2nvhBwcR8qqA3z7TYGfkSBE2AiaCqB2PvAgSHUh
# NZmSFn08n0kHPWDm1MfZ2SZyI2ONYO+/a8Y1DG/jLTzXjlNVF0JNphFhw6gGIGSr
# 7ycQfClPrKFyQVofeP+xDeqGOafv36EmKxcMjEUnqI6heX2OZ+V7km0tN2tLuD0U
# UEzLz79VGeeYWwQ9NBihyGRvoq7pL7bjtSG/KoW0hfnlm27BqSGMLT4KQLiJvPwf
# bx47dW9gfKAZ/NvEdKVxCycO8YOGp7p36iRnHTF9vNWsK3hzPZ2nluLXU4oR9OCX
# ees3dtW+6Dl/U9PbqsY=
