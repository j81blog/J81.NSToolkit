function Invoke-NSGetAppqoeStats {
    <#
    .SYNOPSIS
        Get Application Level Quality of Experience statistics stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetAppqoeStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetAppqoeStats -GetAll 
        Get all appqoe data.
    .EXAMPLE
        PS C:\>Invoke-NSGetAppqoeStats -name <string>
        Get appqoe object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetAppqoeStats -Filter @{ 'name'='<value>' }
        Get appqoe data with a filter.
    .NOTES
        File Name : Invoke-NSGetAppqoeStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/appqoe/appqoe/
    ...
    begin {
        Write-Verbose "Invoke-NSGetAppqoeStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type appqoe -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type appqoe -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving appqoe configuration for property ''"

            } else {
                Write-Verbose "Retrieving appqoe configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type appqoe -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetAppqoeStats: Ended"
    }
}

function Invoke-NSGetAppqoepolicyStats {
    <#
    .SYNOPSIS
        Get Application Level Quality of Experience statistics stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetAppqoepolicyStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetAppqoepolicyStats -GetAll 
        Get all appqoepolicy data.
    .EXAMPLE
        PS C:\>Invoke-NSGetAppqoepolicyStats -name <string>
        Get appqoepolicy object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetAppqoepolicyStats -Filter @{ 'name'='<value>' }
        Get appqoepolicy data with a filter.
    .NOTES
        File Name : Invoke-NSGetAppqoepolicyStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/appqoe/appqoepolicy/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetAppqoepolicyStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type appqoepolicy -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type appqoepolicy -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving appqoepolicy configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type appqoepolicy -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving appqoepolicy configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type appqoepolicy -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetAppqoepolicyStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDNFLL0BtgPeCND
# lLKmD6Dd3Zzsso9tyYGUb+T8cl0dFqCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgQprn484BxZc1RGJMmGhafMdjnMkHUNrhZ0KdGJKv+NwwDQYJ
# KoZIhvcNAQEBBQAEggEAJhC6VCNk1CkzESwYjUM0jU6DoKboY8LIu99aIQQzMBXP
# KV3U9Yj4xsb1UMIAVugQw3Um7jZS6XNqNU3xGTfww7y//oLFiy8FIPgroFQ1D5qr
# SOtLRLecnGO+nOwuVU2hzlit95YDPBqTw+Z+KEPCioSnwtH1wJlWyaz18FlClidw
# s5S0UhYYa2AcPbruJ+C5tfIN0TuDJTFqOY7mZDp/zz5CVQMATtKs0kOajS6vvkmg
# yfhWKXhWoPgQcW3a0fa5gAJZFWlpwBvzc3CPeisoMUrrzED1hJOv2I2CHx4u0Zrz
# b5GK2X9yioaShOn/43aiJtDCTKeFx1acd95saC7cNqGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ0MzFaMD8GCSqG
# SIb3DQEJBDEyBDCQDa8VL8AQrKt6hErsnStYtZdo6ok0wik9QxvTp2rDDiD1Adao
# djkOqx9wnu9UHh0wDQYJKoZIhvcNAQEBBQAEggIAUMju48D5GY3X8TTdmmErjUxf
# jPIsYMnciSpvKHH+Js6LnODyDLAoatkDDoasV8UA4IBMs76wd/SZ8nlhxWCcpZ6H
# IL3SmrXfX/v/o3ukyIAk5qDB0uR3KkvaECxUS5ocjkpVIPtv0cyzDaXjMTYLUzNI
# 23cdPBT6pq156dtyuFmakDfcIE2LBMVw3mYIggce/exvqD3AYVXlIG18T96RPNwW
# jpht7yxpbvhTZ1xQLQl5wPHfpNHpKgkn9HrG/ilVBtX7S+lQAlpVrEtf/bpxzuiX
# dJu/WBSkNYGBVKzx6xDgPotXrHQt14FCdF5MRWNU2P5s4f1RCLAagNmKXx9QIRH0
# Hp+bASvqMEhx6mvTTMqlwYNR0wIjKPI9xmx/ycE92CIMZ7eYwMgIILcKFVBPB8IE
# T6Ux3HoOyCSh3zqg/5tyQlQEyzGDKJvMfE4x6y8ff+KnlpdRsIJbWkm/kBAO/AOQ
# nkHzgKnvIJ4rU1fBKKtBzdp9mK95TmqMxYyZPxO5MjUzmiRe22dktuDenqgruG8L
# C2wwSbUusa+1S48rzzkhGG2uZEsfx2g5n9I8x2lw3Y1gtbRh8P0SLjtPb9pG1Bmq
# bu59I1WzR/+Sv4l+l0WON7Vo2LBQSmmJxSHg/N8rCvwmf9z6X+pzoH7ZKnWRfxLZ
# mANI/TBvOFLwUPFoM2U=
