function Invoke-NSGetAppflowStats {
    <#
    .SYNOPSIS
        Get AppFlow statistics. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetAppflowStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetAppflowStats -GetAll 
        Get all appflow data.
    .EXAMPLE
        PS C:\>Invoke-NSGetAppflowStats -name <string>
        Get appflow object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetAppflowStats -Filter @{ 'name'='<value>' }
        Get appflow data with a filter.
    .NOTES
        File Name : Invoke-NSGetAppflowStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/appflow/appflow/
    ...
    begin {
        Write-Verbose "Invoke-NSGetAppflowStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type appflow -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type appflow -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type appflow -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetAppflowStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAfRpSB07HqyblC
# JfZvF67XGZd+0HJNTZ3CMQS7eRek16CCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgUUY5P23Uf1yIKAyNUSKxT6ULmjZ2wx7uOxEk7JaKt3cwDQYJ
# KoZIhvcNAQEBBQAEggEAqKbfga3CohV0jo/yeOxjCi0vu4tvFW4J5rySvEG47JbT
# 5h1IWQHb9l3k2+A/2bEeVOfz1jMUzlqQRZswYIaJCSQLRwha33hl75NNTtZxwOFr
# UMZmlL/z2zazB7an96KGXLIwcDz2TjP94wVD+S9AUznVinzPCAR3GPZkeZpOCJh3
# 7ze4D3OE61kyLkIS8NGxr9zlhY1mYLdCIEWIq+laDKZg3WEeCxOIWfvT6CNFiA4A
# C6zPAVUM/CSy/Gc3TzGYrVNphoz30l1NUUMz0GGZXcHWJAkMWWYL7uIUjIBJ1M0E
# tux4cW3XnSbYOV4h2B1A7tbQzlf3BA8fBqvLPISmgqGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ0MjVaMD8GCSqG
# SIb3DQEJBDEyBDBDmk2gqOI1M8jCyk7CVeEMLM4miFHnsGziHn2tR/DOn1M07AZq
# 405IXhiAM0erxOcwDQYJKoZIhvcNAQEBBQAEggIAcp1G4MA4/NY/ycVc+Q2wVBtT
# kSe0ridYULxzIR37UhynaRrvIUWdG4gSOgbf1+nk9U+z5M5/qdUWvyC0C6cysCvP
# g4peKdEdzDEaR391+QSkJb6hJksoN+r2WiUAVx5nt2ssKmOblS9dYLvz77y/DB09
# NyYYpSeWPOiQsUqrHuAOpQ3vUpehKDb2QuT5NYHc0PxXwoCP/0IRVwHRMLmef0bX
# VZa/1U0RgUkCA9UxisMOqLa4HAZbHjHq/BuJuouGGsLIpZjFjUga1FEE6SgbVZTA
# axfiLT+xbMlsggBoelvUzjrDQg4Kawc1X1Yfo2k7yEwkAqME9c2X7ylIqz9bJWjS
# 6wqhC8R/NzpZRxQRzTR88yunCTgXhOQ3xUrqqaGUBDNd9DDBjHhoXt2KqhQnhgSW
# IDeOKiuvXEihEjiSBeMJvXdQp/pajDuuVJDyOHgnvZAxEBDM2zF6NoOgYsOrpxSA
# VwwyXjFmaGkLgzdUwwuJbCTZoonpQyFdpTRhECb5+0jmC0Xf+KIiatleTWJuNp20
# flkNN3LucPQB0SvCte8rf7iRwMC6EJ1W1DpyaP5JAakGmj+pEYzxEv+Et0itLbVu
# WN+Q0aQ4eHj3xHVdMY5nCL+znpn9D50FJuVEYDuDg0xuWeZ0lyvAXpYjp3frYHL6
# gmRY188bEA4asRk6DQQ=
