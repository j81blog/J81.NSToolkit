function Invoke-NSGetAutoscalepolicyStats {
    <#
    .SYNOPSIS
        Get AutoScale statistics. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetAutoscalepolicyStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetAutoscalepolicyStats -GetAll 
        Get all autoscalepolicy data.
    .EXAMPLE
        PS C:\>Invoke-NSGetAutoscalepolicyStats -name <string>
        Get autoscalepolicy object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetAutoscalepolicyStats -Filter @{ 'name'='<value>' }
        Get autoscalepolicy data with a filter.
    .NOTES
        File Name : Invoke-NSGetAutoscalepolicyStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/autoscale/autoscalepolicy/
    ...
    begin {
        Write-Verbose "Invoke-NSGetAutoscalepolicyStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type autoscalepolicy -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type autoscalepolicy -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving autoscalepolicy configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type autoscalepolicy -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving autoscalepolicy configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type autoscalepolicy -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetAutoscalepolicyStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAWKkOLK0bRYYW3
# mpbfqg/uiMcRnaee0WHBYmqEzy7yEaCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQg2gnW55C+Q2l27+WbdPgytJKbUkNwX6AyyIBA66yQtmMwDQYJ
# KoZIhvcNAQEBBQAEggEAGel6pS2XV3lNmxQHqYvkxAvo3sTQWxySz1eYZj53V9ym
# ALA9j2pNakBxAbklN0U2ZCB6mHkmURkkmHCtHbPoqr3wOUiO59PHWr1i9/8FhrF/
# hv9di6/S+j0JNRixznvBOPa3RdGEQrfw/SgRMJEJnn9/t2vJ9uP1HhrF4rcrjb7x
# n7b8hY8jc2NA/2wyNR5R/AZ7rjyYi5avfRpDGQtZJFXcySHupy5qVTeHl2xYSNK3
# PFFJNgNDdjScxLaSMLdlL7jGRUhalGXifhP2kG16aFy0nlXPmN2Wx01x7B3HQzvu
# KOnC4kUb4q5zkXZf482UA1dzMPWdH6DJL41IS9cZvKGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ0NDNaMD8GCSqG
# SIb3DQEJBDEyBDAnzlW16gbfgFLcDD3aPuIRyH+mskKZvrz9mg6B43PwOjgMVQag
# bwKJR1WkTamb0fEwDQYJKoZIhvcNAQEBBQAEggIABAx/YqNrTffdq9ojPmELigh4
# bwvkMwawMqrfgd2d7O0yMKJ2FtIzEXB/IMDmTmgqnUH5SqEI3loktyq499mHRsyK
# R+kWgBWpG1UXZondWW6TR4pc+StLbOeRAs6qprlBYbyzO3bR/ppPHmwUE6lliWJI
# wl7bh6knJemsBmIR61RrM7sgKDKodMMENzrQkKljE3auXLEDoa6zn2BKDBwCpm7E
# z4Tixk21IlSdm/aqoJXtmLNda5tC47xTRZ8RlWjDbxYPS+shqtBC9RT6htmoCkrP
# IJ45GDbehyziuZsZ4CvSFihq6bQHdV3RjOCUxdzVRPNFeXKmlB9L9Mb9EpeGuro7
# c8bt/ej5F3FcuDp8RURMwHbp37GWY2DAlB5l5s7QguvvdgD/IAmMC65l7SJnjuut
# CWvleGrJfOj3wx8BIWTCQ2KTtBe5RBHKGBiTe9Vz24wtTgMJnCm00lhvzhytNtbv
# JxC/aQjeq+dU/1W4LFowCqgcGY2Y13J3/78dQuyVdgwUr7whhgRETnctk0JNJ5EX
# aOjFiVuvia5AkKpfMiM2FHi9XEsE6sn5m5UTFp/N1L0qzuMoVUolEOx9PiL1R2+D
# Gfc86DbNfw+g033UiYPvuSOEK1nQ+0ABXH7Zn7zRfeSqvPaE5jElQlQeMmphxf8v
# xv5wJlfPW7BC80CYzwk=
