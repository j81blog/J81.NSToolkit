function Invoke-NSGetHanodeStats {
    <#
    .SYNOPSIS
        Get High-availability commands. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetHanodeStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetHanodeStats -GetAll 
        Get all hanode data.
    .EXAMPLE
        PS C:\>Invoke-NSGetHanodeStats -name <string>
        Get hanode object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetHanodeStats -Filter @{ 'name'='<value>' }
        Get hanode data with a filter.
    .NOTES
        File Name : Invoke-NSGetHanodeStats
        Version   : v2311.2021
    ...
    begin {
        Write-Verbose "Invoke-NSGetHanodeStats: Beginning"
    }
    process {
        try {
        ...
        Write-Verbose "Invoke-NSGetHanodeStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCqlkVzDter7q3V
# oBO8EjFbSOR2hyjI3EA4CxyRjZ739qCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgMzwGC0cllIWfapALAr1w0Vbx4048MFa47UYcLdyJTWEwDQYJ
# KoZIhvcNAQEBBQAEggEAkVZBev4IwEZnyLADtT1lGQRh45KoQ0NUCzoenowlUoNC
# WghbNYXCr2e3lSOcvHd7S0j4PiPQMiwVM3lfvWgxOU6I6FD8rq6sboe+zMUFPKqI
# cjZMSDxfuOL1i7X58RlWXNhXcZ/N9HI1GJnWMuore2y0wIxapkwGZcK5Gp5jA80R
# S8JF9SneblAs7gwMxobXWLmRa8guQUN/VVheAATFcYuk+Gc9U5RiGl3+BuHoHrSt
# Xw8COAKbRFB2I7iuxfvcXKaUET6JmkADhQbqyTdsK5KsQgNbaWaCVqad9vgFgOzN
# bS1bKPH1DmgS1J/Gmzz4Sxdfue0axao3dXj8pljVvaGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ1MjJaMD8GCSqG
# SIb3DQEJBDEyBDAvv31DeVmOwMsSyrk9N9jfan6FkWHFVOyxsZ7sIzFAnIvxD6O5
# s2gAMKDk02cmltkwDQYJKoZIhvcNAQEBBQAEggIAltqxdtQcgdK6b0wkHgLHb7mK
# oby4nhTcSPCKukDdsy5eb0eA/NgJMxw5ilHf/YynPxWfBD5dE1dyi1jTqDtAWXoE
# MMnXYPU1t34u/sijywPajsNFDKhlnTR8YbJeQ2yLy6wCHSOkM/j7Aiba/lMHNANM
# 9M3Wu3fK2ukUQK23B5F4M7tOciTRjXq1MStkWIXjtx5iR6CgEdxWdv/Q0QVZ10Xt
# pjofzZFUmNiTTWvWJvuVFynqybs2NOtPrMqNRc/EU6bGhNYxUh4SOZVgKIrZmQX0
# EzZvZA4/RCz2RqRnKJXth7Y42ZI8MSf5tbQzSDqvJXndujzoaPnYStfRbr9YPSgo
# y0lwp27CauXXL49sdnnXdBOCByFJtb63zpbUP1Q6Si9dVOYl2sbX3jwgfjLnJQRY
# f5dxxViFFFThJ2NGNQQGuiDTRscvmatseyKC5F903Oy/7EH/7Q0Jsp0qjhuGD3D0
# dyCll3/A/yAUsPjHV5moLJqO9zNg6fdeQ+Rdz6Q43/UtFhgC7AlFkqrsdbpHorpR
# Y84vda7d+h+tmMO7SnhUlRQIw+hqzNZ/2E+tyIIYD0v4PDqz2dlw5DqnSmCJ0a7E
# EVpGtc+eGkfl3PXaKcOS4jla9bFmym5I1d+8HPSpiwMIJTR3+n4ihvpsk11lvAJK
# BVInIVlsrG8dUDSNQjo=
