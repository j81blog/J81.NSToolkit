function Invoke-NSGetStreamidentifierStats {
    <#
    .SYNOPSIS
        Get Stream statistics. stats object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetStreamidentifierStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetStreamidentifierStats -GetAll 
        Get all streamidentifier data.
    .EXAMPLE
        PS C:\>Invoke-NSGetStreamidentifierStats -name <string>
        Get streamidentifier object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetStreamidentifierStats -Filter @{ 'name'='<value>' }
        Get streamidentifier data with a filter.
    .NOTES
        File Name : Invoke-NSGetStreamidentifierStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/stream/streamidentifier/
    ...
    begin {
        Write-Verbose "Invoke-NSGetStreamidentifierStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type streamidentifier -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type streamidentifier -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving streamidentifier configuration for property 'name'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type streamidentifier -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving streamidentifier configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type streamidentifier -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetStreamidentifierStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAZVeQJUStjEa3t
# mQQ+f78clQYlwKwz5937DeVQKh5KVqCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgmgi2UyBZ0yfUUuXb6VkFA3z8DWHD2kzec2aTzZzLOs8wDQYJ
# KoZIhvcNAQEBBQAEggEASPE9e3yUfjOhFuN/5XXD9YCmDopSfQ9JJNarhLRtWcMU
# diLvUrkOpkIW28FqhDg9UahaP5lx2lruubuUFCYvt8p4x+Zi52ZnFGM4wMdXt7cc
# RTlsH5WuZtNfnD7mlJSW3yDQxHwq+Fj3x/sJeClQ+ZaCN/s6hPzOdYxxETNoY64/
# /gJ28lwWoWqAp18Id3l1Gyj98Zgrlo5BafpRs+yZbh+2gV6vIDZZSNPV/Jb8+fKH
# ujWksgvHQFyDAh+eKCLzBBuDd0d2jY9B/G8RF15WZ3M4DH0NLod5L6IQq7HZtMuJ
# P7LJgoLBjpT7kTFHi+QD56G1bPqC7pL7y0EGBFy8KqGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ2MTNaMD8GCSqG
# SIb3DQEJBDEyBDAaXY5NCABtBDlR1FTfMxgFjEcG85o+KXfVbs+7oykGREFiDL7K
# WFOb5wVUvUs7/9swDQYJKoZIhvcNAQEBBQAEggIAL4WqQDkS7qzqRabgvlItnkvn
# 5mohvAIbCDxl4RQGbRC6p5PWQbojoUhXmGUFXXB4B1wE/pV6xI8mmek0cMiQ1jol
# 1FdjTGGeeZsktl2WOo8kI5VwTAnrpRBNjas+vA4wIzVQDaGioXS00cVaF8Dqc2Rq
# gZY71YEsg85m7Ax/5twiMdeICW1uqC2V3sgZAMk6Dpe61eCXELSGbKteY0AqiOk5
# yFBTzRtQv7o+f9eRpUoLYU+qUE+KxadV4obc4qaQYpkrNWuia1OXsiyKlcbxw56S
# 8h+dEEILp+edfzVKjiQiAM8LcK+3/vKxk0da1gniGu+d6enrGDg+pNyISh/Omfyt
# Tcbr2fBKdrAm/4CIhK576MiTl7L+S69qLru9ax5yDEkJagwyOgpCySEnRlCOP7jI
# QQYNhmjhKcpIPfQJFl+XIsTUGHdRuSlJdWtGoH+B0ZGSoNgw122EigEmIeBoosmM
# U3+/EQB/GXgAMydXIF7YqAcPjAaKi4Z3n0RQkSKTJHyVrXeolpqUWEdEHnOwdgQi
# XCotJD2NDIilm5EszDBmu1LOr+leBZh+kES0qNUw8wNHtvS8OCP4xapZkVzeqw2K
# N4j+yLvMQ6Nr2se19wGW7u5TjEWIYVAOKWIJjbOZTJXlZO3Xpnbwm8ZvMfcoTzmz
# QDsJ59gLr/QyhLQ0Oa8=
