function Invoke-NSGetSnmpStats {
    <#
    .SYNOPSIS
        Get SNMP(Simple Network Management Protocol) statistics. stats object(s).
    .DESCRIPTION
        Statistics for snmp.
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetSnmpStats -GetAll 
        Get all snmp data.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpStats -name <string>
        Get snmp object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetSnmpStats -Filter @{ 'name'='<value>' }
        Get snmp data with a filter.
    .NOTES
        File Name : Invoke-NSGetSnmpStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/snmp/snmp/
    ...
    begin {
        Write-Verbose "Invoke-NSGetSnmpStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmp -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmp -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving snmp configuration for property ''"

            } else {
                Write-Verbose "Retrieving snmp configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type snmp -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetSnmpStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBJlxuSTf6/Zx5o
# eRi/pbvl+x+TTdKNe/jGVsDt/jaCoKCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQgjQ5QQMAypw7cPGCp31uPkawleQhQw5LmA7d/L93rkqswDQYJ
# KoZIhvcNAQEBBQAEggEAXylC6vIvHvE6ZYZ07LYMi5Iizi/qRJN+9nxonxNTs5BD
# r8cBRJ+8guMwSqwzrfMmxJ/QJ8v1yGVQJrq/NCUwwdgT0SKK7GOybuml5LJGIZaP
# osV47iKpkmmAE75Lo0yQEdfI9I4vsejmsBCCfBVNr6uj3yBnwwbuanjAVU/EshjZ
# LIp7yHFo4UbamYUobcUQsO6WM10cW+uYW8J+11VJqSQm+b9m83GeqaVsF8MP/mcK
# A3Ok/B/ID3k6bU04WQmE4kg9TjDwCz5XCraZltntRhSj/d9MKAjOLDKiuKSjGyfk
# HS6vD81Kri5dWBzYMBR7ny/SmLEpJGfQtRrb4wRrmaGCA0swggNHBgkqhkiG9w0B
# CQYxggM4MIIDNAIBATCBkTB9MQswCQYDVQQGEwJHQjEbMBkGA1UECBMSR3JlYXRl
# ciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3JkMRgwFgYDVQQKEw9TZWN0aWdv
# IExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNBIFRpbWUgU3RhbXBpbmcgQ0EC
# EDlMJeF8oG0nqGXiO9kdItQwDQYJYIZIAWUDBAICBQCgeTAYBgkqhkiG9w0BCQMx
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzExMjAyMDQ2MDRaMD8GCSqG
# SIb3DQEJBDEyBDDENZS4dTyHkZhT+2v6xRqYU38+/NIqqs9vpfjeSJvmN7KpHbfn
# ypoB53rid6wXpV0wDQYJKoZIhvcNAQEBBQAEggIAhdnHd8abdI+iteYXFdoswc9b
# nZ+i1IUcoaqurA6Xv3KC5J/+glinQaUdA5SZEDRSBTrw2r27N8Kjy6Wldv2Y4r0y
# f6SgQTJoD7uuqycofHQl3hWD4fbt92OVRmdylgDtAWZibmrR0COLzoMNGJUpkT6f
# MDlMgsUivnF/6nelp4ytPaPTHU8kHwxfATB/Tt4+bj6JOM1fpLv4x0Xq97DRaDN4
# 4isQsqG454CN5Rv+PrmOnqDFXpmfa+L2YHKZo7tmWlj7Y47XbcXFqwYXfwOcq+ge
# 6fZW/ICulvFqcINTOUrGm9iPYgxMqr8mwaxjWtFpGM62WrkqFxwY9trHlBxR6M94
# 710IAwM9O3fRiy086BUUVQBqsXrsxVsAiEeFo9uP/kswi6odHClZOcU6nA0LQUjJ
# R6hgplW/mUMgWB5rvuc1ccEiWPHq136ZYXLN0Lskpn15bnEfhN7oKuxDJgqAugWq
# Wb+zwiXmbP3kWPXqYVby3SRrPcbUxpxfbVZPr4aQaCjR9b3ZOFio5q5xLm05esQp
# NDmlzUdMoFQIuNq2yRs3i1Cc/rRULD+9b3Bxmak3ag88zGi5GvPC9VkfcDWQNrW1
# IkajhTKIEbJrEPW5tVUoCpWObj0t/zSbVq2b3Ow+coW7OAVdwK9g0XUKwlcMIo1X
# GKbZbWpvf/cAbEjW7FY=
