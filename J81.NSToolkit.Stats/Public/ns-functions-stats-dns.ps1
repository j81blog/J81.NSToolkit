function Invoke-NSGetDnsStats {
    <#
    .SYNOPSIS
        Get Domain Name Service(DNS) statistics. stats object(s).
    .DESCRIPTION
        Statistics for dns.
    ...
    .EXAMPLE
        PS C:\>Invoke-NSGetDnsStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetDnsStats -GetAll 
        Get all dns data.
    .EXAMPLE
        PS C:\>Invoke-NSGetDnsStats -name <string>
        Get dns object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetDnsStats -Filter @{ 'name'='<value>' }
        Get dns data with a filter.
    .NOTES
        File Name : Invoke-NSGetDnsStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/dns/dns/
    ...
    begin {
        Write-Verbose "Invoke-NSGetDnsStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type dns -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type dns -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving dns configuration for property ''"

            } else {
                Write-Verbose "Retrieving dns configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type dns -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-NSGetDnsStats: Ended"
    }
}

function Invoke-NSGetDnspolicylabelStats {
    <#
    .SYNOPSIS
        Get Domain Name Service(DNS) statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetDnspolicylabelStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetDnspolicylabelStats -GetAll 
        Get all dnspolicylabel data.
    .EXAMPLE
        PS C:\>Invoke-NSGetDnspolicylabelStats -name <string>
        Get dnspolicylabel object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetDnspolicylabelStats -Filter @{ 'name'='<value>' }
        Get dnspolicylabel data with a filter.
    .NOTES
        File Name : Invoke-NSGetDnspolicylabelStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/dns/dnspolicylabel/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetDnspolicylabelStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type dnspolicylabel -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type dnspolicylabel -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving dnspolicylabel configuration for property 'labelname'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type dnspolicylabel -NitroPath nitro/v1/stat -Resource $labelname -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving dnspolicylabel configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type dnspolicylabel -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetDnspolicylabelStats: Ended"
    }
}

function Invoke-NSGetDnsrecordsStats {
    <#
    .SYNOPSIS
        Get Domain Name Service(DNS) statistics. stats object(s).
    .DESCRIPTION
    ...
    .PARAMETER ViewSummary
        When specified, only a summary of information is returned.
    .EXAMPLE
        PS C:\>Invoke-NSGetDnsrecordsStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-NSGetDnsrecordsStats -GetAll 
        Get all dnsrecords data.
    .EXAMPLE
        PS C:\>Invoke-NSGetDnsrecordsStats -name <string>
        Get dnsrecords object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-NSGetDnsrecordsStats -Filter @{ 'name'='<value>' }
        Get dnsrecords data with a filter.
    .NOTES
        File Name : Invoke-NSGetDnsrecordsStats
        Version   : v2311.2021
        Author    : John Billekens
        Reference : https://developer-docs.netscaler.com/en-us/adc-nitro-api/current-release/statistics/dns/dnsrecords/
        Requires  : PowerShell v5.1 and up
                    NS 13.x and up.
                    NS 12 and lower may work, not guaranteed (best effort).
    .LINK
    ...
    begin {
        Write-Verbose "Invoke-NSGetDnsrecordsStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type dnsrecords -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'Count' ) {
                if ( $PSBoundParameters.ContainsKey('Count') ) { $query = @{ 'count' = 'yes' } }
                ...
                $arguments = @{ } 
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type dnsrecords -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving dnsrecords configuration for property 'dnsrecordtype'"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type dnsrecords -NitroPath nitro/v1/stat -Resource $dnsrecordtype -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving dnsrecords configuration objects"
                $response = Invoke-NSNitroApi -NSSession $NSSession -Method GET -Type dnsrecords -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
            Write-Verbose "ERROR: $($_.Exception.Message)"
            $response = $null
        ...
        Write-Verbose "Invoke-NSGetDnsrecordsStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDVj2De3NZkClW1
# EIFYKwmc4OICK7GPK9/xYwvlcxwleKCCHl4wggTzMIID26ADAgECAhAsJ03zZBC0
...
# hkiG9w0BCQQxIgQ